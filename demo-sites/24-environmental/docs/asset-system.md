...
| --- | --- |
| Image style | Carbon dashboards, climate reports, data rooms |
| Photo style | Carbon dashboards, climate reports, data rooms |
| Illustration/icon style | local SVG mark and diagrams following Climate software with serious green, evidence dashboards, and enterprise clarity |
| Texture/background pattern | Climate software with serious green, evidence dashboards, and enterprise clarity |
| Diagram style | supports impact and methodology proof and Climate data operating system |
...
| Border/overlay treatment | Carbon evidence cards and Climate software with serious green, evidence dashboards, and enterprise clarity |
