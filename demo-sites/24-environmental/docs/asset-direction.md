...
| Photo personality | Carbon dashboards, climate reports, data rooms |
| Texture/material | Climate software with serious green, evidence dashboards, and enterprise clarity |
| Icon/illustration | local SVG and diagrams aligned to Climate software with serious green, evidence dashboards, and enterprise clarity |
| Hero assets | Emissions dashboard hero needs a first-screen image or visual system that does not copy references |
