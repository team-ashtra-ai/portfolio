...
| Signature behaviour | Impact metric filters, ESG report archive, audit route selector |
...
| Optional variation | audit roadmap cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Metric stack reveal must collapse cleanly under prefers-reduced-motion |
