...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Climate data operating system and Emissions dashboard hero |
| Interactive components | Impact metric filters, ESG report archive, audit route selector, Emissions dashboard hero, Primary-reference resource rhythm filters or archive interactions, audit roadmap cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Environmental, Sustainability & Climate Services content |
| Form behaviours | Audit advisory form with validation, status, honeypot, Formspree, and thanks route |
...
- Impact metric filters, ESG report archive, audit route selector
- Emissions dashboard hero
- Primary-reference resource rhythm filters or archive interactions
- audit roadmap cards comparison/toggle/calculator behaviour
