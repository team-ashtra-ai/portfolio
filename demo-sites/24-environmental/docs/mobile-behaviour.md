...
| Mobile hero | Emissions dashboard hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Carbon evidence cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Audit advisory form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Audit` appears after proof and remains reachable from contact/footer |
| Mobile footer | report archive footer stacks into sitemap, conversion, contact, legal, and trust areas |
