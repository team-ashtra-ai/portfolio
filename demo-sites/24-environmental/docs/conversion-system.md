...
| CTA hierarchy | Primary-reference CTA hierarchy using Book Audit |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to evidence-led climate responsibility |
| Form type | Audit advisory form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Audit links |
| Trust before form | impact and methodology proof |
...
| Conversion flow type | Emissions dashboard hero |
