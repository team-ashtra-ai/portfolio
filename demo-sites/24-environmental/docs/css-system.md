...
| Colour | #f4fbf7, #083d31, #00a878, #083d31, #244bff plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Climate data operating system with container-sm/md/lg/xl/fluid tokens |
| Surface | Climate software with serious green, evidence dashboards, and enterprise clarity with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Carbon evidence cards using radius, border, and shadow tokens |
| Motion | Metric stack reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-environmental`
- Mode class: `mode-technical`
- Layout signature: Climate data operating system
