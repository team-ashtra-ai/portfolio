...
| Photo style | Dark app screens, issue boards, roadmap panels |
| Illustration/icon style | local SVG mark and diagrams following Dark product system with glass UI, fine borders, gradient light, and app panels |
| Texture/background pattern | Dark product system with glass UI, fine borders, gradient light, and app panels |
| Diagram style | supports product usage and integrations proof and Dark product dashboard system |
...
| Border/overlay treatment | Fine-line app cards and Dark product system with glass UI, fine borders, gradient light, and app panels |
