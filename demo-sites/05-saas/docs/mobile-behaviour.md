...
| Mobile hero | App interface hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Fine-line app cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Demo request form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Schedule Demo` appears after proof and remains reachable from contact/footer |
| Mobile footer | resource hub footer stacks into sitemap, conversion, contact, legal, and trust areas |
