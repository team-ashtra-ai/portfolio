...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Linear (https://linear.app/) |
| Layout archetype | Dark product dashboard system |
| Header | Floating product header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | resource hub footer |
| Typography | Inter display with "Trebuchet MS" body and Verdana accent labels |
| Colour/surface | #08090d, #5e6ad2, #9b8cff, #f7f8ff, #37d67a; Dark product system with glass UI, fine borders, gradient light, and app panels |
| Hero | App interface hero |
| Section rhythm | medium density with varied composition and Subtle glow and panel reveal |
| Cards | Fine-line app cards |
| Forms | Demo request form |
| CTA flow | Primary-reference CTA hierarchy using Schedule Demo using `Schedule Demo` |
| Assets | Dark app screens, issue boards, roadmap panels |
| JS interactions | Pricing toggle, feature tabs, integration filter, product UI display |
| Motion | Subtle glow and panel reveal |
