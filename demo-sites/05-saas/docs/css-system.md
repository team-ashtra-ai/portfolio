...
| Colour | #08090d, #5e6ad2, #9b8cff, #f7f8ff, #37d67a plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Dark product dashboard system with container-sm/md/lg/xl/fluid tokens |
| Surface | Dark product system with glass UI, fine borders, gradient light, and app panels with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Fine-line app cards using radius, border, and shadow tokens |
| Motion | Subtle glow and panel reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-saas`
- Mode class: `mode-technical`
- Layout signature: Dark product dashboard system
