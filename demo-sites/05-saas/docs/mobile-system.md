...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Dark product dashboard system` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Dark product dashboard system with full container range |
...
| Mobile hero style | App interface hero simplified without losing proof or CTA |
| Mobile card stacking | Fine-line app cards stacks or scrolls only when intentional |
| Mobile form behaviour | Demo request form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Schedule Demo appears after proof and in contact routes |
| Mobile footer structure | resource hub footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Dark app screens, issue boards, roadmap panels |
