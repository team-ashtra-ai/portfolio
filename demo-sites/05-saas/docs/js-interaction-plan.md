...
| Signature behaviour | Pricing toggle, feature tabs, integration filter, product UI display |
...
| Optional variation | plan comparison toggle, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Subtle glow and panel reveal must collapse cleanly under prefers-reduced-motion |
