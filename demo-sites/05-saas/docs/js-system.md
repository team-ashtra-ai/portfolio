...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Dark product dashboard system and App interface hero |
| Interactive components | Pricing toggle, feature tabs, integration filter, product UI display, App interface hero, Primary-reference resource rhythm filters or archive interactions, plan comparison toggle comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Software, SaaS Platforms & Digital Products content |
| Form behaviours | Demo request form with validation, status, honeypot, Formspree, and thanks route |
...
- Pricing toggle, feature tabs, integration filter, product UI display
- App interface hero
- Primary-reference resource rhythm filters or archive interactions
- plan comparison toggle comparison/toggle/calculator behaviour
