...
NexusOps must feel like a standalone premium website for Technology, IT Services & Digital Infrastructure, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 11, 21, 37.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | operational |
| Visual mood | Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Industry tone | operational infrastructure confidence |
| Buyer psychology | uptime and operational control |
| Trust style | uptime and support proof |
| Conversion style | Primary-reference CTA hierarchy using Request IT Audit |
| Content density | dense |
| Image personality | Edge maps, server nodes, operational dashboards |
| Level of formality | technical |
| Level of emotion | controlled |
| Level of technical detail | high |
| Premium feeling | A network-first IT site with technical proof, orange action paths, product cards, and status-aware conversion |
| Commercial feeling | Primary-reference CTA hierarchy using Request IT Audit |
...
| Stats/quotes/eyebrows | accented through Network service tiles and Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #fff7ed, #f38020, #faae40, #18191f, #ffe4c2 |
| Surface style | Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Network service tiles with unique radius and border strength |
| Texture usage | Infrastructure marketing with orange CTAs, network diagrams, and dense product routes texture; no generic repeated decorative background |
...
- Premium direction: A network-first IT site with technical proof, orange action paths, product cards, and status-aware conversion
- Brand mood: operational
- Buyer psychology: uptime and operational control
- Layout archetype: Edge network product system
- Density: dense
- Shape language: Network service tiles
- Surface/material: Infrastructure marketing with orange CTAs, network diagrams, and dense product routes
- Image system: Edge maps, server nodes, operational dashboards
- Interaction model: Network diagram hero
- CTA style: Primary-reference CTA hierarchy using Request IT Audit
- Pricing style: support retainer matrix
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 11, 21, 37.
