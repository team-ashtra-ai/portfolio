...
| Photo personality | Edge maps, server nodes, operational dashboards |
| Texture/material | Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Icon/illustration | local SVG and diagrams aligned to Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Hero assets | Network diagram hero needs a first-screen image or visual system that does not copy references |
