...
| Signature behaviour | Support plan comparison, system status cards, ticket route selector |
...
| Optional variation | support retainer matrix, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Fast network sweep must collapse cleanly under prefers-reduced-motion |
