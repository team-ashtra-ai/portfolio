...
| Colour | #fff7ed, #f38020, #faae40, #18191f, #ffe4c2 plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Edge network product system with container-sm/md/lg/xl/fluid tokens |
| Surface | Infrastructure marketing with orange CTAs, network diagrams, and dense product routes with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Network service tiles using radius, border, and shadow tokens |
| Motion | Fast network sweep with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-technology`
- Mode class: `mode-technical`
- Layout signature: Edge network product system
