...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Cloudflare (https://www.cloudflare.com/) |
| Layout archetype | Edge network product system |
| Header | Orange product navigation |
| Mobile menu | Primary-reference mobile navigation |
| Footer | support desk footer |
| Typography | Inter display with Georgia body and Didot accent labels |
| Colour/surface | #fff7ed, #f38020, #faae40, #18191f, #ffe4c2; Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Hero | Network diagram hero |
| Section rhythm | dense density with varied composition and Fast network sweep |
| Cards | Network service tiles |
| Forms | IT audit route form |
| CTA flow | Primary-reference CTA hierarchy using Request IT Audit using `Request IT Audit` |
| Assets | Edge maps, server nodes, operational dashboards |
| JS interactions | Support plan comparison, system status cards, ticket route selector |
| Motion | Fast network sweep |
