...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Edge network product system and Network diagram hero |
| Interactive components | Support plan comparison, system status cards, ticket route selector, Network diagram hero, Primary-reference resource rhythm filters or archive interactions, support retainer matrix comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Technology, IT Services & Digital Infrastructure content |
| Form behaviours | IT audit route form with validation, status, honeypot, Formspree, and thanks route |
...
- Support plan comparison, system status cards, ticket route selector
- Network diagram hero
- Primary-reference resource rhythm filters or archive interactions
- support retainer matrix comparison/toggle/calculator behaviour
