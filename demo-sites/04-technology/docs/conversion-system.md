...
| Field | Decision |
| --- | --- |
| Primary CTA | Request IT Audit |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Request IT Audit |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to operational infrastructure confidence |
| Form type | IT audit route form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Request IT Audit links |
| Trust before form | uptime and support proof |
...
| Conversion flow type | Network diagram hero |
