...
| --- | --- |
| Image style | Edge maps, server nodes, operational dashboards |
| Photo style | Edge maps, server nodes, operational dashboards |
| Illustration/icon style | local SVG mark and diagrams following Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Texture/background pattern | Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
| Diagram style | supports uptime and support proof and Edge network product system |
...
| Border/overlay treatment | Network service tiles and Infrastructure marketing with orange CTAs, network diagrams, and dense product routes |
