...
| Mobile hero | Network diagram hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Network service tiles remains visually distinct in one-column or scroll treatment |
| Mobile forms | IT audit route form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request IT Audit` appears after proof and remains reachable from contact/footer |
| Mobile footer | support desk footer stacks into sitemap, conversion, contact, legal, and trust areas |
