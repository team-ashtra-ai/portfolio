...
| --- | --- |
| Image style | Film posters, stage stills, credits, audience moments |
| Photo style | Film posters, stage stills, credits, audience moments |
| Illustration/icon style | local SVG mark and diagrams following Entertainment with black cinema mood, poster grids, and understated weirdness |
| Texture/background pattern | Entertainment with black cinema mood, poster grids, and understated weirdness |
| Diagram style | supports event and access proof and Indie film poster system |
...
| Border/overlay treatment | Poster event cards and Entertainment with black cinema mood, poster grids, and understated weirdness |
