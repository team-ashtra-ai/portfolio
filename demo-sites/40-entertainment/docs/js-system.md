...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Indie film poster system and Dark poster hero |
| Interactive components | Event calendar, ticket selector, artist filter, Dark poster hero, Primary-reference resource rhythm filters or archive interactions, ticket tier cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Entertainment, Music & Performance content |
| Form behaviours | Ticket enquiry form with validation, status, honeypot, Formspree, and thanks route |
...
- Event calendar, ticket selector, artist filter
- Dark poster hero
- Primary-reference resource rhythm filters or archive interactions
- ticket tier cards comparison/toggle/calculator behaviour
