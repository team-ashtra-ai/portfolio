...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Indie film poster system` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Indie film poster system with full container range |
...
| Mobile hero style | Dark poster hero simplified without losing proof or CTA |
| Mobile card stacking | Poster event cards stacks or scrolls only when intentional |
| Mobile form behaviour | Ticket enquiry form keeps labels visible and submits to Formspree |
| Mobile CTA placement | View Tickets appears after proof and in contact routes |
| Mobile footer structure | venue footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Film posters, stage stills, credits, audience moments |
