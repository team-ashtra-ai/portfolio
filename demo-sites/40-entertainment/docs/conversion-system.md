...
| Field | Decision |
| --- | --- |
| Primary CTA | View Tickets |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using View Tickets |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to high-energy live culture |
| Form type | Ticket enquiry form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and View Tickets links |
| Trust before form | event and access proof |
...
| Conversion flow type | Dark poster hero |
