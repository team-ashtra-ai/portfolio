...
| Signature behaviour | Event calendar, ticket selector, artist filter |
...
| Optional variation | ticket tier cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Poster fade reveal must collapse cleanly under prefers-reduced-motion |
