...
| Photo personality | Film posters, stage stills, credits, audience moments |
| Texture/material | Entertainment with black cinema mood, poster grids, and understated weirdness |
| Icon/illustration | local SVG and diagrams aligned to Entertainment with black cinema mood, poster grids, and understated weirdness |
| Hero assets | Dark poster hero needs a first-screen image or visual system that does not copy references |
