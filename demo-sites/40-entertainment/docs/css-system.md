...
| Colour | #050505, #ffffff, #c69a55, #ffffff, #e24a2e plus semantic success/warning/error/link/CTA tokens |
| Spacing | theatrical density expressed through --space-* and --space-section |
| Grid/layout | Indie film poster system with container-sm/md/lg/xl/fluid tokens |
| Surface | Entertainment with black cinema mood, poster grids, and understated weirdness with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Poster event cards using radius, border, and shadow tokens |
| Motion | Poster fade reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-entertainment`
- Mode class: `mode-dark`
- Layout signature: Indie film poster system
- Header type: Film studio header
- Hero type: Dark poster hero
- Card style: Poster event cards
- Form style: Ticket enquiry form
