...
| Mobile hero | Dark poster hero simplified for first-screen clarity |
| Mobile section rhythm | theatrical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Poster event cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Ticket enquiry form keeps labels, consent, validation, and status visible |
| Mobile CTA | `View Tickets` appears after proof and remains reachable from contact/footer |
| Mobile footer | venue footer stacks into sitemap, conversion, contact, legal, and trust areas |
