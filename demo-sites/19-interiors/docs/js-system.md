...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Luxury material moodboard and Editorial room hero |
| Interactive components | Moodboard filter, room selector, material palette interaction, Editorial room hero, Primary-reference resource rhythm filters or archive interactions, styling package cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Interiors, Furniture & Home Design content |
| Form behaviours | Design brief form with validation, status, honeypot, Formspree, and thanks route |
...
- Moodboard filter, room selector, material palette interaction
- Editorial room hero
- Primary-reference resource rhythm filters or archive interactions
- styling package cards comparison/toggle/calculator behaviour
