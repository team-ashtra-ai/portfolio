...
| Mobile hero | Editorial room hero simplified for first-screen clarity |
| Mobile section rhythm | image-rich density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Material mood cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Design brief form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Start Design` appears after proof and remains reachable from contact/footer |
| Mobile footer | materials footer stacks into sitemap, conversion, contact, legal, and trust areas |
