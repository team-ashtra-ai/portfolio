...
RoomMuse must feel like a standalone premium website for Interiors, Furniture & Home Design, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 02, 26, 36.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | tactile refined |
| Visual mood | Interiors with tactile luxury, material contrast, and editorial commerce |
| Industry tone | material-led home warmth |
| Buyer psychology | taste and home confidence |
| Trust style | materials and project proof |
| Conversion style | Primary-reference CTA hierarchy using Start Design |
| Content density | image-rich |
| Image personality | Textures, sculptural furniture, styled rooms, swatches |
| Level of formality | commerce |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | A material-led interiors site with luxe moodboards, serif headlines, room selectors, and sourcing CTAs |
| Commercial feeling | Primary-reference CTA hierarchy using Start Design |
...
| Stats/quotes/eyebrows | accented through Material mood cards and Interiors with tactile luxury, material contrast, and editorial commerce |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #f6eee6, #4a2b2a, #c99a6b, #111111, #e7c9a9 |
...
| Border style | matched to Material mood cards with unique radius and border strength |
| Texture usage | Interiors with tactile luxury, material contrast, and editorial commerce texture; no generic repeated decorative background |
...
- Premium direction: A material-led interiors site with luxe moodboards, serif headlines, room selectors, and sourcing CTAs
- Brand mood: tactile refined
- Buyer psychology: taste and home confidence
- Layout archetype: Luxury material moodboard
- Density: image-rich
- Shape language: Material mood cards
- Surface/material: Interiors with tactile luxury, material contrast, and editorial commerce
- Image system: Textures, sculptural furniture, styled rooms, swatches
- Interaction model: Editorial room hero
- CTA style: Primary-reference CTA hierarchy using Start Design
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 02, 26, 36.
