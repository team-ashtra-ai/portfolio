...
| Colour | #f6eee6, #4a2b2a, #c99a6b, #111111, #e7c9a9 plus semantic success/warning/error/link/CTA tokens |
| Spacing | image-rich density expressed through --space-* and --space-section |
| Grid/layout | Luxury material moodboard with container-sm/md/lg/xl/fluid tokens |
| Surface | Interiors with tactile luxury, material contrast, and editorial commerce with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Material mood cards using radius, border, and shadow tokens |
| Motion | Material fade reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-interiors`
- Mode class: `mode-commerce`
- Layout signature: Luxury material moodboard
