...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Luxury material moodboard` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Luxury material moodboard with full container range |
...
| Mobile hero style | Editorial room hero simplified without losing proof or CTA |
| Mobile card stacking | Material mood cards stacks or scrolls only when intentional |
| Mobile form behaviour | Design brief form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Start Design appears after proof and in contact routes |
| Mobile footer structure | materials footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Textures, sculptural furniture, styled rooms, swatches |
