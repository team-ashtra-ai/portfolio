...
| Field | Decision |
| --- | --- |
| Primary CTA | Start Design |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Start Design |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to material-led home warmth |
| Form type | Design brief form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Start Design links |
| Trust before form | materials and project proof |
...
| Conversion flow type | Editorial room hero |
