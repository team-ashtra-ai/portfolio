...
| --- | --- |
| Image style | Textures, sculptural furniture, styled rooms, swatches |
| Photo style | Textures, sculptural furniture, styled rooms, swatches |
| Illustration/icon style | local SVG mark and diagrams following Interiors with tactile luxury, material contrast, and editorial commerce |
| Texture/background pattern | Interiors with tactile luxury, material contrast, and editorial commerce |
| Diagram style | supports materials and project proof and Luxury material moodboard |
...
| Border/overlay treatment | Material mood cards and Interiors with tactile luxury, material contrast, and editorial commerce |
