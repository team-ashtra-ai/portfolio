...
| Photo personality | Textures, sculptural furniture, styled rooms, swatches |
| Texture/material | Interiors with tactile luxury, material contrast, and editorial commerce |
| Icon/illustration | local SVG and diagrams aligned to Interiors with tactile luxury, material contrast, and editorial commerce |
| Hero assets | Editorial room hero needs a first-screen image or visual system that does not copy references |
