...
| Photo personality | Body-scan rooms, data visualisations, calm clinical detail |
| Texture/material | Clean health-tech with scan-first white space, black copy, and electric blue data accents |
| Icon/illustration | local SVG and diagrams aligned to Clean health-tech with scan-first white space, black copy, and electric blue data accents |
| Hero assets | Body scan split hero needs a first-screen image or visual system that does not copy references |
