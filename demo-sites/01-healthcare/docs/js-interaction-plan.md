...
| Signature behaviour | Appointment pathway, service filter, reassurance FAQ |
...
| Optional variation | consultation fees pathway, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Soft reveal with data-point counters must collapse cleanly under prefers-reduced-motion |
