...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Scan-first health check journey and Body scan split hero |
| Interactive components | Appointment pathway, service filter, reassurance FAQ, Body scan split hero, Primary-reference resource rhythm filters or archive interactions, consultation fees pathway comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Healthcare, Medical Services & Patient Care content |
| Form behaviours | Scan booking form with validation, status, honeypot, Formspree, and thanks route |
...
- Appointment pathway, service filter, reassurance FAQ
- Body scan split hero
- Primary-reference resource rhythm filters or archive interactions
- consultation fees pathway comparison/toggle/calculator behaviour
