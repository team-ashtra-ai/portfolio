...
| --- | --- |
| Image style | Body-scan rooms, data visualisations, calm clinical detail |
| Photo style | Body-scan rooms, data visualisations, calm clinical detail |
| Illustration/icon style | local SVG mark and diagrams following Clean health-tech with scan-first white space, black copy, and electric blue data accents |
| Texture/background pattern | Clean health-tech with scan-first white space, black copy, and electric blue data accents |
| Diagram style | supports standards and care notes and Scan-first health check journey |
...
| Border/overlay treatment | Rounded diagnostic data cards and Clean health-tech with scan-first white space, black copy, and electric blue data accents |
