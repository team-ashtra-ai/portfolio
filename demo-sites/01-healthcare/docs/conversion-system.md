...
| CTA hierarchy | Primary-reference CTA hierarchy using Book Appointment |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to calm clinical precision |
| Form type | Scan booking form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Appointment links |
| Trust before form | standards and care notes |
...
| Conversion flow type | Body scan split hero |
