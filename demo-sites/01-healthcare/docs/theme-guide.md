...
AsterCare must feel like a standalone premium website for Healthcare, Medical Services & Patient Care, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 08, 18, 34.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | calm clinical |
| Visual mood | Clean health-tech with scan-first white space, black copy, and electric blue data accents |
| Industry tone | calm clinical precision |
| Buyer psychology | fear reduction and care confidence |
| Trust style | standards and care notes |
| Conversion style | Primary-reference CTA hierarchy using Book Appointment |
| Content density | spacious |
| Image personality | Body-scan rooms, data visualisations, calm clinical detail |
| Level of formality | care |
| Level of emotion | high |
| Level of technical detail | moderate |
| Premium feeling | A scan-first care journey with minimalist copy, body-data panels, instant-results proof, and a direct appointment CTA |
| Commercial feeling | Primary-reference CTA hierarchy using Book Appointment |
...
| Stats/quotes/eyebrows | accented through Rounded diagnostic data cards and Clean health-tech with scan-first white space, black copy, and electric blue data accents |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #f7fbff, #101820, #20b8d8, #07141e, #d7f7ff |
| Surface style | Clean health-tech with scan-first white space, black copy, and electric blue data accents |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Rounded diagnostic data cards with unique radius and border strength |
| Texture usage | Clean health-tech with scan-first white space, black copy, and electric blue data accents texture; no generic repeated decorative background |
...
- Premium direction: A scan-first care journey with minimalist copy, body-data panels, instant-results proof, and a direct appointment CTA
- Brand mood: calm clinical
- Buyer psychology: fear reduction and care confidence
- Layout archetype: Scan-first health check journey
- Density: spacious
- Shape language: Rounded diagnostic data cards
- Surface/material: Clean health-tech with scan-first white space, black copy, and electric blue data accents
- Image system: Body-scan rooms, data visualisations, calm clinical detail
- Interaction model: Body scan split hero
- CTA style: Primary-reference CTA hierarchy using Book Appointment
- Pricing style: consultation fees pathway
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 08, 18, 34.
