...
| Theme fit | Assets follow Clean health-tech with scan-first white space, black copy, and electric blue data accents and Body-scan rooms, data visualisations, calm clinical detail. |
