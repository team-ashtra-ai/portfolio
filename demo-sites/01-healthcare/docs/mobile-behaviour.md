...
| Mobile hero | Body scan split hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Rounded diagnostic data cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Scan booking form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Appointment` appears after proof and remains reachable from contact/footer |
| Mobile footer | care route sitemap stacks into sitemap, conversion, contact, legal, and trust areas |
