...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Lemonade (https://www.lemonade.com/) |
| Layout archetype | Pink quote journey |
| Header | Simple insurance header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | policy support footer |
| Typography | Georgia display with "Segoe UI" body and "Palatino Linotype" accent labels |
| Colour/surface | #fff2f7, #ff0083, #ffb3d9, #251024, #ffffff; Insurance quote flow with hot pink, friendly copy, and simple white cards |
| Hero | Friendly quote hero |
| Section rhythm | practical density with varied composition and Friendly step reveal |
| Cards | Rounded policy cards |
| Forms | Quote route form |
| CTA flow | Primary-reference CTA hierarchy using Request Quote using `Request Quote` |
| Assets | Quote flows, policy cards, soft character-free illustrations |
| JS interactions | Cover comparison, claims stepper, quote form logic |
| Motion | Friendly step reveal |
