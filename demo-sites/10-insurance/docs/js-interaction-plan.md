...
| Signature behaviour | Cover comparison, claims stepper, quote form logic |
...
| Optional variation | premium factors cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Friendly step reveal must collapse cleanly under prefers-reduced-motion |
