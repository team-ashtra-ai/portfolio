...
| Mobile hero | Friendly quote hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Rounded policy cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Quote route form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Quote` appears after proof and remains reachable from contact/footer |
| Mobile footer | policy support footer stacks into sitemap, conversion, contact, legal, and trust areas |
