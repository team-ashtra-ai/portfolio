...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Pink quote journey` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Pink quote journey with full container range |
...
| Mobile hero style | Friendly quote hero simplified without losing proof or CTA |
| Mobile card stacking | Rounded policy cards stacks or scrolls only when intentional |
| Mobile form behaviour | Quote route form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Request Quote appears after proof and in contact routes |
| Mobile footer structure | policy support footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Quote flows, policy cards, soft character-free illustrations |
