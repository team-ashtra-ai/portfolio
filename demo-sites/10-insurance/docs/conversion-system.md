...
| CTA wording | industry-specific and matched to protective advisory trust |
| Form type | Quote route form |
...
| Trust before form | limits, exclusions, and support proof |
...
| Conversion flow type | Friendly quote hero |
