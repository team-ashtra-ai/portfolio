...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Pink quote journey and Friendly quote hero |
| Interactive components | Cover comparison, claims stepper, quote form logic, Friendly quote hero, Primary-reference resource rhythm filters or archive interactions, premium factors cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Insurance, Protection & Risk Cover content |
| Form behaviours | Quote route form with validation, status, honeypot, Formspree, and thanks route |
...
- Cover comparison, claims stepper, quote form logic
- Friendly quote hero
- Primary-reference resource rhythm filters or archive interactions
- premium factors cards comparison/toggle/calculator behaviour
