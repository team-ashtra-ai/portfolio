...
| Photo personality | Quote flows, policy cards, soft character-free illustrations |
| Texture/material | Insurance quote flow with hot pink, friendly copy, and simple white cards |
| Icon/illustration | local SVG and diagrams aligned to Insurance quote flow with hot pink, friendly copy, and simple white cards |
| Hero assets | Friendly quote hero needs a first-screen image or visual system that does not copy references |
