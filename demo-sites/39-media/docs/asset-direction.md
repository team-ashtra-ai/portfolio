...
| Photo personality | News cards, studio images, episode panels, neon lines |
| Texture/material | Media system with black surfaces, neon accents, angular modules, and dense story grids |
| Icon/illustration | local SVG and diagrams aligned to Media system with black surfaces, neon accents, angular modules, and dense story grids |
| Hero assets | Angular media hero needs a first-screen image or visual system that does not copy references |
