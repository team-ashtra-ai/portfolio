...
| --- | --- |
| Image style | News cards, studio images, episode panels, neon lines |
| Photo style | News cards, studio images, episode panels, neon lines |
| Illustration/icon style | local SVG mark and diagrams following Media system with black surfaces, neon accents, angular modules, and dense story grids |
| Texture/background pattern | Media system with black surfaces, neon accents, angular modules, and dense story grids |
| Diagram style | supports reach and standards proof and Neon editorial news grid |
...
| Border/overlay treatment | Angled story cards and Media system with black surfaces, neon accents, angular modules, and dense story grids |
