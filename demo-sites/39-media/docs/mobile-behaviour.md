...
| Mobile hero | Angular media hero simplified for first-screen clarity |
| Mobile section rhythm | compact density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Angled story cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Advertise kit form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Advertise With Us` appears after proof and remains reachable from contact/footer |
| Mobile footer | audience footer stacks into sitemap, conversion, contact, legal, and trust areas |
