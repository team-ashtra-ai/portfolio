...
| Colour | #0b0b13, #e2127a, #fff200, #ffffff, #00d4ff plus semantic success/warning/error/link/CTA tokens |
| Spacing | compact density expressed through --space-* and --space-section |
| Grid/layout | Neon editorial news grid with container-sm/md/lg/xl/fluid tokens |
| Surface | Media system with black surfaces, neon accents, angular modules, and dense story grids with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Angled story cards using radius, border, and shadow tokens |
| Motion | Ticker and story reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-media`
- Mode class: `mode-professional`
- Layout signature: Neon editorial news grid
