...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Neon editorial news grid` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Neon editorial news grid with full container range |
...
| Mobile hero style | Angular media hero simplified without losing proof or CTA |
| Mobile card stacking | Angled story cards stacks or scrolls only when intentional |
| Mobile form behaviour | Advertise kit form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Advertise With Us appears after proof and in contact routes |
| Mobile footer structure | audience footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | News cards, studio images, episode panels, neon lines |
