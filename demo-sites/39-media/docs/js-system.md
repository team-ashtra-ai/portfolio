...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Neon editorial news grid and Angular media hero |
| Interactive components | Show schedule filter, episode cards, advertise kit download, Angular media hero, Primary-reference resource rhythm filters or archive interactions, sponsorship cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Media, Broadcasting & Digital Content content |
| Form behaviours | Advertise kit form with validation, status, honeypot, Formspree, and thanks route |
...
- Show schedule filter, episode cards, advertise kit download
- Angular media hero
- Primary-reference resource rhythm filters or archive interactions
- sponsorship cards comparison/toggle/calculator behaviour
