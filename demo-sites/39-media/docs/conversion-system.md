...
| Field | Decision |
| --- | --- |
| Primary CTA | Advertise With Us |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Advertise With Us |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to audience-first media programming |
| Form type | Advertise kit form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Advertise With Us links |
| Trust before form | reach and standards proof |
...
| Conversion flow type | Angular media hero |
