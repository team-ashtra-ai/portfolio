...
| --- | --- |
| Layout archetype | Extract industry-specific media, broadcasting & digital content credibility; translate into Neon editorial news grid rather than copying The Verge. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Neon media header. |
...
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
| Typography mood | Study the mood, then express it through Verdana display with "Segoe UI" body and Inter accent labels. |
| Colour palette | Translate reference contrast into the original palette #0b0b13, #e2127a, #fff200, #ffffff, #00d4ff. |
| Surface system | Use surface hierarchy ideas only; final surfaces are Media system with black surfaces, neon accents, angular modules, and dense story grids. |
| Hero type | Use the reference to pressure-test the first screen, then build an original Angular media hero. |
| Section rhythm | Extract pacing lessons and apply varied fixed-section composition, not a copied sequence. |
| Card design | Convert card intent into Angled story cards with unique spacing, shape, and state rules. |
| Form pattern | Use friction and reassurance cues to refine the original Advertise kit form. |
| CTA flow | Map intent to Primary-reference CTA hierarchy using Advertise With Us and primary CTA `Advertise With Us`. |
| Asset direction | Translate asset principles into News cards, studio images, episode panels, neon lines and local ASH-TRA assets. |
| Image treatment | Use crop/contrast lessons without using the reference images, crops, or art direction directly. |
| Icon/illustration style | Extract clarity and hierarchy only; final icon language stays local to WaveCast. |
| JS interaction ideas | Use as inspiration for Show schedule filter, episode cards, advertise kit download while preserving readable static content. |
| Motion style | Reduce or reshape motion into Ticker and story reveal with reduced-motion support. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific media, broadcasting & digital content credibility; translate into Neon editorial news grid rather than copying Bloomberg. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific media, broadcasting & digital content credibility; translate into Neon editorial news grid rather than copying Vox. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for audience reach and timing; translate into Neon editorial news grid rather than copying BBC. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
| Typography mood | Study the mood, then express it through Verdana display with "Segoe UI" body and Inter accent labels. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for audience reach and timing; translate into Neon editorial news grid rather than copying NPR. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic professional design; translate into Neon editorial news grid rather than copying Netflix. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
| Typography mood | Study the mood, then express it through Verdana display with "Segoe UI" body and Inter accent labels. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic professional design; translate into Neon editorial news grid rather than copying Spotify. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
...
## 8. Mobbin schedule filter patterns (interaction)

URL: https://mobbin.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract interaction reference for Show schedule filter, episode cards, advertise kit download; translate into Neon editorial news grid rather than copying Mobbin schedule filter patterns. |
| Header structure | Borrow the decision logic of a interaction reference, then rebuild as Neon media header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to compact. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as audience footer. |
| Typography mood | Study the mood, then express it through Verdana display with "Segoe UI" body and Inter accent labels. |
