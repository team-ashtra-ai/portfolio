(() => {
  const signature = {"site": "media", "interaction": "Show schedule filter, episode cards, advertise kit download", "mode": "professional"};
