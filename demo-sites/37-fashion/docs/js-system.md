...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Sunlit campaign lookbook and Oversized campaign hero |
| Interactive components | Lookbook slider, size guide, collection filter, Oversized campaign hero, Primary-reference resource rhythm filters or archive interactions, collection drop cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Fashion, Apparel & Accessories content |
| Form behaviours | Styling enquiry form with validation, status, honeypot, Formspree, and thanks route |
...
- Lookbook slider, size guide, collection filter
- Oversized campaign hero
- Primary-reference resource rhythm filters or archive interactions
- collection drop cards comparison/toggle/calculator behaviour
