...
| Photo personality | Campaign imagery, fabric closeups, product scale, runway detail |
| Texture/material | Fashion with sunny surrealism, oversized imagery, and campaign-led commerce |
| Icon/illustration | local SVG and diagrams aligned to Fashion with sunny surrealism, oversized imagery, and campaign-led commerce |
| Hero assets | Oversized campaign hero needs a first-screen image or visual system that does not copy references |
