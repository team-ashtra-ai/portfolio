...
| Colour | #fff2b8, #111111, #ffde00, #111111, #d97b4f plus semantic success/warning/error/link/CTA tokens |
| Spacing | theatrical density expressed through --space-* and --space-section |
| Grid/layout | Sunlit campaign lookbook with container-sm/md/lg/xl/fluid tokens |
| Surface | Fashion with sunny surrealism, oversized imagery, and campaign-led commerce with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Sunny lookbook cards using radius, border, and shadow tokens |
| Motion | Playful campaign reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-fashion`
- Mode class: `mode-editorial`
- Layout signature: Sunlit campaign lookbook
