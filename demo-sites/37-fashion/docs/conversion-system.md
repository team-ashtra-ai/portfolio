...
| CTA hierarchy | Primary-reference CTA hierarchy using Shop Collection |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to editorial fashion restraint |
| Form type | Styling enquiry form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Shop Collection links |
| Trust before form | craft and collection proof |
...
| Conversion flow type | Oversized campaign hero |
