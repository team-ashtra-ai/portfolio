...
| --- | --- |
| Image style | Campaign imagery, fabric closeups, product scale, runway detail |
| Photo style | Campaign imagery, fabric closeups, product scale, runway detail |
| Illustration/icon style | local SVG mark and diagrams following Fashion with sunny surrealism, oversized imagery, and campaign-led commerce |
| Texture/background pattern | Fashion with sunny surrealism, oversized imagery, and campaign-led commerce |
| Diagram style | supports craft and collection proof and Sunlit campaign lookbook |
...
| Border/overlay treatment | Sunny lookbook cards and Fashion with sunny surrealism, oversized imagery, and campaign-led commerce |
