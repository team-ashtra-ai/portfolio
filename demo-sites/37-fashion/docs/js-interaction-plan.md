...
| Signature behaviour | Lookbook slider, size guide, collection filter |
...
| Optional variation | collection drop cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Playful campaign reveal must collapse cleanly under prefers-reduced-motion |
