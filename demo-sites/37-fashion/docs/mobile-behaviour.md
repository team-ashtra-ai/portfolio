...
| Mobile hero | Oversized campaign hero simplified for first-screen clarity |
| Mobile section rhythm | theatrical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Sunny lookbook cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Styling enquiry form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Shop Collection` appears after proof and remains reachable from contact/footer |
