...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Jacquemus (https://www.jacquemus.com/) |
| Layout archetype | Sunlit campaign lookbook |
| Header | Fashion campaign header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | stockist footer |
| Typography | Verdana display with Inter body and Georgia accent labels |
| Colour/surface | #fff2b8, #111111, #ffde00, #111111, #d97b4f; Fashion with sunny surrealism, oversized imagery, and campaign-led commerce |
| Hero | Oversized campaign hero |
| Section rhythm | theatrical density with varied composition and Playful campaign reveal |
| Cards | Sunny lookbook cards |
| Forms | Styling enquiry form |
| CTA flow | Primary-reference CTA hierarchy using Shop Collection using `Shop Collection` |
| Assets | Campaign imagery, fabric closeups, product scale, runway detail |
| JS interactions | Lookbook slider, size guide, collection filter |
| Motion | Playful campaign reveal |
