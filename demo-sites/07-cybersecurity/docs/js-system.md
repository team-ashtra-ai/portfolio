...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Cloud security command centre and Purple cloud-risk hero |
| Interactive components | Risk matrix, compliance checklist, incident response stepper, Purple cloud-risk hero, Primary-reference resource rhythm filters or archive interactions, audit and retainer cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Cybersecurity, Privacy & Risk Protection content |
| Form behaviours | Audit request form with validation, status, honeypot, Formspree, and thanks route |
...
- Risk matrix, compliance checklist, incident response stepper
- Purple cloud-risk hero
- Primary-reference resource rhythm filters or archive interactions
- audit and retainer cards comparison/toggle/calculator behaviour
