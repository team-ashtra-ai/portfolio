...
| Colour | #11092a, #7b2cff, #19c6ff, #f8f6ff, #ff6bd6 plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Cloud security command centre with container-sm/md/lg/xl/fluid tokens |
| Surface | Cloud-security energy with purple depth, blue diagrams, and bold risk visuals with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Rounded cloud-risk cards using radius, border, and shadow tokens |
| Motion | Glowing topology reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-cybersecurity`
- Mode class: `mode-dark`
- Layout signature: Cloud security command centre
