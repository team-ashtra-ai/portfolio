...
| Mobile hero | Purple cloud-risk hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Rounded cloud-risk cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Audit request form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Audit` appears after proof and remains reachable from contact/footer |
| Mobile footer | security evidence footer stacks into sitemap, conversion, contact, legal, and trust areas |
