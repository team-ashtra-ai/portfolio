...
| --- | --- |
| Image style | Cloud graphs, risk paths, security dashboards |
| Photo style | Cloud graphs, risk paths, security dashboards |
| Illustration/icon style | local SVG mark and diagrams following Cloud-security energy with purple depth, blue diagrams, and bold risk visuals |
| Texture/background pattern | Cloud-security energy with purple depth, blue diagrams, and bold risk visuals |
| Diagram style | supports compliance and response proof and Cloud security command centre |
...
| Border/overlay treatment | Rounded cloud-risk cards and Cloud-security energy with purple depth, blue diagrams, and bold risk visuals |
