...
| Field | Decision |
| --- | --- |
| Primary CTA | Request Audit |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Request Audit |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to risk-control security discipline |
| Form type | Audit request form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Request Audit links |
| Trust before form | compliance and response proof |
...
| Conversion flow type | Purple cloud-risk hero |
