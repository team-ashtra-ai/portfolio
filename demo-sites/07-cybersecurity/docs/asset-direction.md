...
| Photo personality | Cloud graphs, risk paths, security dashboards |
| Texture/material | Cloud-security energy with purple depth, blue diagrams, and bold risk visuals |
| Icon/illustration | local SVG and diagrams aligned to Cloud-security energy with purple depth, blue diagrams, and bold risk visuals |
| Hero assets | Purple cloud-risk hero needs a first-screen image or visual system that does not copy references |
