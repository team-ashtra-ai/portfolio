...
| Signature behaviour | Risk matrix, compliance checklist, incident response stepper |
...
| Optional variation | audit and retainer cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Glowing topology reveal must collapse cleanly under prefers-reduced-motion |
