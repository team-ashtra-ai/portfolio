...
| Signature behaviour | Catalogue filter, seller/customer support routing |
...
| Optional variation | seller/customer route cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Grid snap reveal must collapse cleanly under prefers-reduced-motion |
