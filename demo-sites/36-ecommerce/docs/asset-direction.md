...
| Photo personality | Product grids, editorial crops, order panels, marketplace lists |
| Texture/material | E-commerce with monochrome grid discipline, compact type, and catalogue authority |
| Icon/illustration | local SVG and diagrams aligned to E-commerce with monochrome grid discipline, compact type, and catalogue authority |
| Hero assets | Fashion-commerce grid hero needs a first-screen image or visual system that does not copy references |
