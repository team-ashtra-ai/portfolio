...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Monochrome catalogue system and Fashion-commerce grid hero |
| Interactive components | Catalogue filter, seller/customer support routing, Fashion-commerce grid hero, Primary-reference resource rhythm filters or archive interactions, seller/customer route cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core E-commerce, Marketplaces & Digital Commerce content |
| Form behaviours | Support routing form with validation, status, honeypot, Formspree, and thanks route |
...
- Catalogue filter, seller/customer support routing
- Fashion-commerce grid hero
- Primary-reference resource rhythm filters or archive interactions
- seller/customer route cards comparison/toggle/calculator behaviour
