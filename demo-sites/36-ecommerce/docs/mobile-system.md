...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Monochrome catalogue system` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Monochrome catalogue system with full container range |
...
| Mobile hero style | Fashion-commerce grid hero simplified without losing proof or CTA |
| Mobile card stacking | Monochrome product cards stacks or scrolls only when intentional |
| Mobile form behaviour | Support routing form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Browse Market appears after proof and in contact routes |
| Mobile footer structure | seller support footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Product grids, editorial crops, order panels, marketplace lists |
