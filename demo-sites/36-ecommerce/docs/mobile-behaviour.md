...
| Mobile hero | Fashion-commerce grid hero simplified for first-screen clarity |
| Mobile section rhythm | compact density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Monochrome product cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Support routing form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Browse Market` appears after proof and remains reachable from contact/footer |
| Mobile footer | seller support footer stacks into sitemap, conversion, contact, legal, and trust areas |
