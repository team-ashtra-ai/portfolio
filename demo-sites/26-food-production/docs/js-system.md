...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Playful product manifesto and Packaging shelf hero |
| Interactive components | Product/allergen filter, stockist finder, recipe tabs, Packaging shelf hero, Primary-reference resource rhythm filters or archive interactions, trade pack cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Food Production, Packaged Goods & Consumer Foods content |
| Form behaviours | Trade enquiry form with validation, status, honeypot, Formspree, and thanks route |
...
- Product/allergen filter, stockist finder, recipe tabs
- Packaging shelf hero
- Primary-reference resource rhythm filters or archive interactions
- trade pack cards comparison/toggle/calculator behaviour
