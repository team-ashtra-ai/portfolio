...
| Mobile hero | Packaging shelf hero simplified for first-screen clarity |
| Mobile section rhythm | image-rich density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Chunky ingredient cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Trade enquiry form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Trade Info` appears after proof and remains reachable from contact/footer |
| Mobile footer | stockist footer stacks into sitemap, conversion, contact, legal, and trust areas |
