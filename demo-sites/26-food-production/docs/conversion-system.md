...
| Field | Decision |
| --- | --- |
| Primary CTA | Request Trade Info |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Request Trade Info |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to quality-led food craft |
| Form type | Trade enquiry form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Request Trade Info links |
| Trust before form | quality and allergen proof |
...
| Conversion flow type | Packaging shelf hero |
