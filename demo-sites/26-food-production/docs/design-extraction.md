...
| --- | --- |
| Layout archetype | Extract industry-specific food production, packaged goods & consumer foods credibility; translate into Playful product manifesto rather than copying Oatly. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Food brand header. |
...
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
| Typography mood | Study the mood, then express it through "Palatino Linotype" display with Georgia body and "Trebuchet MS" accent labels. |
| Colour palette | Translate reference contrast into the original palette #f5ead2, #004b8d, #f26b3a, #111111, #ffdf3d. |
| Surface system | Use surface hierarchy ideas only; final surfaces are Food brand with playful packaging, chunky copy blocks, and offbeat product shelves. |
| Hero type | Use the reference to pressure-test the first screen, then build an original Packaging shelf hero. |
| Section rhythm | Extract pacing lessons and apply varied fixed-section composition, not a copied sequence. |
| Card design | Convert card intent into Chunky ingredient cards with unique spacing, shape, and state rules. |
| Form pattern | Use friction and reassurance cues to refine the original Trade enquiry form. |
| CTA flow | Map intent to Primary-reference CTA hierarchy using Request Trade Info and primary CTA `Request Trade Info`. |
| Asset direction | Translate asset principles into Cartons, ingredients, recipe panels, hand-made notes and local ASH-TRA assets. |
| Image treatment | Use crop/contrast lessons without using the reference images, crops, or art direction directly. |
| Icon/illustration style | Extract clarity and hierarchy only; final icon language stays local to HarvestPack. |
| JS interaction ideas | Use as inspiration for Product/allergen filter, stockist finder, recipe tabs while preserving readable static content. |
| Motion style | Reduce or reshape motion into Poster-style reveal with reduced-motion support. |
...
## 2. Innocent Drinks (direct)

URL: https://www.innocentdrinks.co.uk

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific food production, packaged goods & consumer foods credibility; translate into Playful product manifesto rather than copying Innocent Drinks. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
...
## 3. Tonys Chocolonely (direct)

URL: https://tonyschocolonely.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific food production, packaged goods & consumer foods credibility; translate into Playful product manifesto rather than copying Tonys Chocolonely. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
...
## 4. Impossible Foods (adjacent)

URL: https://impossiblefoods.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for quality, safety and taste; translate into Playful product manifesto rather than copying Impossible Foods. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
| Typography mood | Study the mood, then express it through "Palatino Linotype" display with Georgia body and "Trebuchet MS" accent labels. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for quality, safety and taste; translate into Playful product manifesto rather than copying Chobani. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic commerce design; translate into Playful product manifesto rather than copying Aesop. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
| Typography mood | Study the mood, then express it through "Palatino Linotype" display with Georgia body and "Trebuchet MS" accent labels. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic commerce design; translate into Playful product manifesto rather than copying Dishoom. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
...
## 8. Mobbin allergen filter patterns (interaction)

URL: https://mobbin.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract interaction reference for Product/allergen filter, stockist finder, recipe tabs; translate into Playful product manifesto rather than copying Mobbin allergen filter patterns. |
| Header structure | Borrow the decision logic of a interaction reference, then rebuild as Food brand header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to image-rich. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as stockist footer. |
| Typography mood | Study the mood, then express it through "Palatino Linotype" display with Georgia body and "Trebuchet MS" accent labels. |
