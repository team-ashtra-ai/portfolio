...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Playful product manifesto` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Playful product manifesto with full container range |
...
| Mobile hero style | Packaging shelf hero simplified without losing proof or CTA |
| Mobile card stacking | Chunky ingredient cards stacks or scrolls only when intentional |
| Mobile form behaviour | Trade enquiry form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Request Trade Info appears after proof and in contact routes |
| Mobile footer structure | stockist footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Cartons, ingredients, recipe panels, hand-made notes |
