...
HarvestPack must feel like a standalone premium website for Food Production, Packaged Goods & Consumer Foods, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 09, 33, 43.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | ingredient-led |
| Visual mood | Food brand with playful packaging, chunky copy blocks, and offbeat product shelves |
| Industry tone | quality-led food craft |
| Buyer psychology | quality, safety and taste |
| Trust style | quality and allergen proof |
| Conversion style | Primary-reference CTA hierarchy using Request Trade Info |
| Content density | image-rich |
| Image personality | Cartons, ingredients, recipe panels, hand-made notes |
| Level of formality | commerce |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | A packaged food site with bold copy, illustrated product cards, allergen filters, and stockist routes |
| Commercial feeling | Primary-reference CTA hierarchy using Request Trade Info |
...
| Stats/quotes/eyebrows | accented through Chunky ingredient cards and Food brand with playful packaging, chunky copy blocks, and offbeat product shelves |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #f5ead2, #004b8d, #f26b3a, #111111, #ffdf3d |
| Surface style | Food brand with playful packaging, chunky copy blocks, and offbeat product shelves |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Chunky ingredient cards with unique radius and border strength |
| Texture usage | Food brand with playful packaging, chunky copy blocks, and offbeat product shelves texture; no generic repeated decorative background |
...
- Premium direction: A packaged food site with bold copy, illustrated product cards, allergen filters, and stockist routes
- Brand mood: ingredient-led
- Buyer psychology: quality, safety and taste
- Layout archetype: Playful product manifesto
- Density: image-rich
- Shape language: Chunky ingredient cards
- Surface/material: Food brand with playful packaging, chunky copy blocks, and offbeat product shelves
- Image system: Cartons, ingredients, recipe panels, hand-made notes
- Interaction model: Packaging shelf hero
- CTA style: Primary-reference CTA hierarchy using Request Trade Info
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 09, 33, 43.
