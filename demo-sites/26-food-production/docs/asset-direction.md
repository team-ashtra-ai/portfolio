...
| Photo personality | Cartons, ingredients, recipe panels, hand-made notes |
| Texture/material | Food brand with playful packaging, chunky copy blocks, and offbeat product shelves |
| Icon/illustration | local SVG and diagrams aligned to Food brand with playful packaging, chunky copy blocks, and offbeat product shelves |
| Hero assets | Packaging shelf hero needs a first-screen image or visual system that does not copy references |
