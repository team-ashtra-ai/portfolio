...
| Signature behaviour | Product/allergen filter, stockist finder, recipe tabs |
...
| Optional variation | trade pack cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Poster-style reveal must collapse cleanly under prefers-reduced-motion |
