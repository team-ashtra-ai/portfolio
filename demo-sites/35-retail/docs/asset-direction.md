...
| Photo personality | Product tiles, store spaces, service cards, device-like panels |
| Texture/material | Retail minimalism with soft grey surfaces, product tiles, and clear shopping paths |
| Icon/illustration | local SVG and diagrams aligned to Retail minimalism with soft grey surfaces, product tiles, and clear shopping paths |
| Hero assets | Soft product shelf hero needs a first-screen image or visual system that does not copy references |
