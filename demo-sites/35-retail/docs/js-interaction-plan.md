...
| Signature behaviour | Product/category filter, loyalty signup, store finder |
...
| Optional variation | offer bundle cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Polished product reveal must collapse cleanly under prefers-reduced-motion |
