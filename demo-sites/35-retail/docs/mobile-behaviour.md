...
| Mobile hero | Soft product shelf hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Rounded product tiles remains visually distinct in one-column or scroll treatment |
| Mobile forms | Store finder form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Visit Shop` appears after proof and remains reachable from contact/footer |
| Mobile footer | store finder footer stacks into sitemap, conversion, contact, legal, and trust areas |
