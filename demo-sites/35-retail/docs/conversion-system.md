...
| Field | Decision |
| --- | --- |
| Primary CTA | Visit Shop |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Visit Shop |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to friendly retail polish |
| Form type | Store finder form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Visit Shop links |
| Trust before form | store and loyalty proof |
...
| Conversion flow type | Soft product shelf hero |
