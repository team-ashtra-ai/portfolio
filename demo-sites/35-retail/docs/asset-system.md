...
| --- | --- |
| Image style | Product tiles, store spaces, service cards, device-like panels |
| Photo style | Product tiles, store spaces, service cards, device-like panels |
| Illustration/icon style | local SVG mark and diagrams following Retail minimalism with soft grey surfaces, product tiles, and clear shopping paths |
| Texture/background pattern | Retail minimalism with soft grey surfaces, product tiles, and clear shopping paths |
| Diagram style | supports store and loyalty proof and Minimal product store |
...
| Border/overlay treatment | Rounded product tiles and Retail minimalism with soft grey surfaces, product tiles, and clear shopping paths |
