...
| Colour | #f5f5f7, #1d1d1f, #0071e3, #1d1d1f, #a1a1a6 plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Minimal product store with container-sm/md/lg/xl/fluid tokens |
| Surface | Retail minimalism with soft grey surfaces, product tiles, and clear shopping paths with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Rounded product tiles using radius, border, and shadow tokens |
| Motion | Polished product reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-retail`
- Mode class: `mode-commerce`
- Layout signature: Minimal product store
