...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Engineering project journal and Red-rule technical hero |
| Interactive components | System diagram tabs, compliance checklist, project filter, Red-rule technical hero, Primary-reference resource rhythm filters or archive interactions, scope estimate cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Engineering, Technical Systems & Specialist Services content |
| Form behaviours | Engineer enquiry form with validation, status, honeypot, Formspree, and thanks route |
...
- System diagram tabs, compliance checklist, project filter
- Red-rule technical hero
- Primary-reference resource rhythm filters or archive interactions
- scope estimate cards comparison/toggle/calculator behaviour
