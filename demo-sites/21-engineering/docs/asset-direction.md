...
| Photo personality | Infrastructure projects, diagrams, field engineering |
| Texture/material | Engineering editorial with red accents, project journalism, and technical depth |
| Icon/illustration | local SVG and diagrams aligned to Engineering editorial with red accents, project journalism, and technical depth |
| Hero assets | Red-rule technical hero needs a first-screen image or visual system that does not copy references |
