...
| --- | --- | --- | --- | --- | --- | --- |
| header | Consulting project header | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| desktop navigation | Consulting project header | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| mobile menu | Primary-reference mobile navigation | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| footer | technical document footer | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| hero | Red-rule technical hero | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| CTA | Primary-reference CTA hierarchy using Ask Engineer | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| form | Engineer enquiry form | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| cards | Engineering proof cards | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| resources | Primary-reference resource rhythm | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| pricing | scope estimate cards | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| FAQ | technical FAQ with section-specific proof notes | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| cookie banner | Primary-reference compact consent | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-back-to-top | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| legal layout | Primary-reference plain legal notes | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| 404 page | brand-consistent recovery page with sitemap and home routes | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Ask Engineer follow-up | dense spacing with Engineering proof cards | classes use theme-engineering modifiers plus component-specific classes | data-track/data-component | assets follow Infrastructure projects, diagrams, field engineering | must not resemble partials in sites 04, 28, 38 |
...
| Logo position | matched to Consulting project header |
| Nav layout | Consulting project header with desktop density chosen for dense |
| CTA position | Ask Engineer positioned as the primary route without crowding utility links |
...
- CTA placement: Ask Engineer remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Engineering editorial with red accents, project journalism, and technical depth

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | technical document footer |
| Footer density | dense |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Ask Engineer |
| Trust/disclaimer area | standards and validation proof |
