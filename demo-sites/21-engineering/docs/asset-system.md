...
| --- | --- |
| Image style | Infrastructure projects, diagrams, field engineering |
| Photo style | Infrastructure projects, diagrams, field engineering |
| Illustration/icon style | local SVG mark and diagrams following Engineering editorial with red accents, project journalism, and technical depth |
| Texture/background pattern | Engineering editorial with red accents, project journalism, and technical depth |
| Diagram style | supports standards and validation proof and Engineering project journal |
...
| Border/overlay treatment | Engineering proof cards and Engineering editorial with red accents, project journalism, and technical depth |
