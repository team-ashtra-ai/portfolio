...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Engineering project journal` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Engineering project journal with full container range |
...
| Mobile hero style | Red-rule technical hero simplified without losing proof or CTA |
| Mobile card stacking | Engineering proof cards stacks or scrolls only when intentional |
| Mobile form behaviour | Engineer enquiry form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Ask Engineer appears after proof and in contact routes |
| Mobile footer structure | technical document footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Infrastructure projects, diagrams, field engineering |
