...
| Mobile hero | Red-rule technical hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Engineering proof cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Engineer enquiry form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Ask Engineer` appears after proof and remains reachable from contact/footer |
| Mobile footer | technical document footer stacks into sitemap, conversion, contact, legal, and trust areas |
