...
CoreSystems must feel like a standalone premium website for Engineering, Technical Systems & Specialist Services, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 04, 28, 38.
...
| Visual mood | Engineering editorial with red accents, project journalism, and technical depth |
| Industry tone | technical engineering reliability |
| Buyer psychology | reliability and standards |
| Trust style | standards and validation proof |
| Conversion style | Primary-reference CTA hierarchy using Ask Engineer |
| Content density | dense |
| Image personality | Infrastructure projects, diagrams, field engineering |
| Level of formality | technical |
| Level of emotion | controlled |
| Level of technical detail | high |
| Premium feeling | An engineering authority site with editorial project blocks, red rules, technical proof, and expert enquiry |
| Commercial feeling | Primary-reference CTA hierarchy using Ask Engineer |
...
| Stats/quotes/eyebrows | accented through Engineering proof cards and Engineering editorial with red accents, project journalism, and technical depth |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #ffffff, #e21b2d, #111111, #111111, #7f8c8d |
...
| Border style | matched to Engineering proof cards with unique radius and border strength |
| Texture usage | Engineering editorial with red accents, project journalism, and technical depth texture; no generic repeated decorative background |
...
- Premium direction: An engineering authority site with editorial project blocks, red rules, technical proof, and expert enquiry
- Brand mood: validated
- Buyer psychology: reliability and standards
- Layout archetype: Engineering project journal
- Density: dense
- Shape language: Engineering proof cards
- Surface/material: Engineering editorial with red accents, project journalism, and technical depth
- Image system: Infrastructure projects, diagrams, field engineering
- Interaction model: Red-rule technical hero
- CTA style: Primary-reference CTA hierarchy using Ask Engineer
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 04, 28, 38.
