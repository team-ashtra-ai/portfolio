...
| Field | Decision |
| --- | --- |
| Primary CTA | Ask Engineer |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Ask Engineer |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to technical engineering reliability |
| Form type | Engineer enquiry form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Ask Engineer links |
| Trust before form | standards and validation proof |
...
| Conversion flow type | Red-rule technical hero |
