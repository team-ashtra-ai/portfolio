...
| Colour | #ffffff, #e21b2d, #111111, #111111, #7f8c8d plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Engineering project journal with container-sm/md/lg/xl/fluid tokens |
| Surface | Engineering editorial with red accents, project journalism, and technical depth with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Engineering proof cards using radius, border, and shadow tokens |
| Motion | Diagram reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-engineering`
- Mode class: `mode-technical`
- Layout signature: Engineering project journal
