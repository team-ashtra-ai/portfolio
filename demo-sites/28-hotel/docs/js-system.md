...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Quiet retreat booking flow and Serene full-bleed stay hero |
| Interactive components | Room filter, booking panel, offer selector, amenities tabs, Serene full-bleed stay hero, Primary-reference resource rhythm filters or archive interactions, room rate cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Hospitality, Hotels & Guest Accommodation content |
| Form behaviours | Availability form with validation, status, honeypot, Formspree, and thanks route |
...
- Room filter, booking panel, offer selector, amenities tabs
- Serene full-bleed stay hero
- Primary-reference resource rhythm filters or archive interactions
- room rate cards comparison/toggle/calculator behaviour
