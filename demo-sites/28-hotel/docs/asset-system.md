...
| Photo style | Villas, landscapes, spa spaces, calm interiors |
| Illustration/icon style | local SVG mark and diagrams following Hospitality with quiet luxury, large tranquil imagery, and restrained booking paths |
| Texture/background pattern | Hospitality with quiet luxury, large tranquil imagery, and restrained booking paths |
| Diagram style | supports availability and policy proof and Quiet retreat booking flow |
...
| Border/overlay treatment | Retreat room cards and Hospitality with quiet luxury, large tranquil imagery, and restrained booking paths |
