...
| Signature behaviour | Room filter, booking panel, offer selector, amenities tabs |
...
| Optional variation | room rate cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Slow luxury fade must collapse cleanly under prefers-reduced-motion |
