...
| Colour | #f3efe7, #2f2a24, #b89b72, #2f2a24, #6c756b plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Quiet retreat booking flow with container-sm/md/lg/xl/fluid tokens |
| Surface | Hospitality with quiet luxury, large tranquil imagery, and restrained booking paths with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Retreat room cards using radius, border, and shadow tokens |
| Motion | Slow luxury fade with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-hotel`
- Mode class: `mode-hospitality`
- Layout signature: Quiet retreat booking flow
- Header type: Discreet hotel header
- Hero type: Serene full-bleed stay hero
- Card style: Retreat room cards
- Form style: Availability form
