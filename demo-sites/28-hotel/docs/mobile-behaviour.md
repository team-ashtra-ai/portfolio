...
| Mobile hero | Serene full-bleed stay hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Retreat room cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Availability form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Check Availability` appears after proof and remains reachable from contact/footer |
| Mobile footer | stay support footer stacks into sitemap, conversion, contact, legal, and trust areas |
