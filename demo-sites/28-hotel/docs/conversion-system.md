...
| CTA hierarchy | Primary-reference CTA hierarchy using Check Availability |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to restful guest confidence |
| Form type | Availability form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Check Availability links |
| Trust before form | availability and policy proof |
...
| Conversion flow type | Serene full-bleed stay hero |
