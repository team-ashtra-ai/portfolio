...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Aman (https://www.aman.com/) |
| Layout archetype | Quiet retreat booking flow |
| Header | Discreet hotel header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | stay support footer |
| Typography | "Palatino Linotype" display with Aptos body and Didot accent labels |
| Colour/surface | #f3efe7, #2f2a24, #b89b72, #2f2a24, #6c756b; Hospitality with quiet luxury, large tranquil imagery, and restrained booking paths |
| Hero | Serene full-bleed stay hero |
| Section rhythm | spacious density with varied composition and Slow luxury fade |
| Cards | Retreat room cards |
| Forms | Availability form |
| CTA flow | Primary-reference CTA hierarchy using Check Availability using `Check Availability` |
| Assets | Villas, landscapes, spa spaces, calm interiors |
| JS interactions | Room filter, booking panel, offer selector, amenities tabs |
| Motion | Slow luxury fade |
