...
| Photo personality | Bottles, textures, counters, botanical ingredient details |
| Texture/material | Beauty retail with muted apothecary surfaces, serif detail, and calm product education |
| Icon/illustration | local SVG and diagrams aligned to Beauty retail with muted apothecary surfaces, serif detail, and calm product education |
| Hero assets | Muted product education hero needs a first-screen image or visual system that does not copy references |
