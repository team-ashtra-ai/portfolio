...
| --- | --- | --- | --- | --- | --- | --- | --- |
| hero component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | Bottles, textures, counters, botanical ingredient details | hover/focus-visible/active/disabled states from css/styles.css | Routine finder, ingredient glossary, product filter | single-column or horizontal scroll only when explicitly designed |
| section intro component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| service card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| feature card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| profile card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| proof card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| metric card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| pricing card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | Routine finder, ingredient glossary, product filter | single-column or horizontal scroll only when explicitly designed |
| resource card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| article card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| download card | Ingredient education cards | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| FAQ component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| form component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| CTA component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| gallery component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | Bottles, textures, counters, botanical ingredient details | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| testimonial/review component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| process/timeline component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| comparison component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| table component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| badge/tag component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| breadcrumb component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| legal content component | Apothecary routine journal | relaxed | Beauty retail with muted apothecary surfaces, serif detail, and calm product education | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |

## Explicit Reuse Prevention

- No same cards everywhere: Ingredient education cards controls card construction for this site only.
- No same FAQ everywhere: FAQ styling follows commerce mode and Primary-reference plain legal notes proof tone.
- No same pricing table everywhere: pricing follows routine bundle cards.
- No same form everywhere: forms follow Routine advice form with industry-specific fields.
- No same testimonial/resource block everywhere: proof follows ingredient and results proof and resources follow Primary-reference resource rhythm.
