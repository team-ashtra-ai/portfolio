...
| Colour | #f3eadc, #35291f, #8c6a4f, #35291f, #c9b28c plus semantic success/warning/error/link/CTA tokens |
| Spacing | relaxed density expressed through --space-* and --space-section |
| Grid/layout | Apothecary routine journal with container-sm/md/lg/xl/fluid tokens |
| Surface | Beauty retail with muted apothecary surfaces, serif detail, and calm product education with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Ingredient education cards using radius, border, and shadow tokens |
| Motion | Quiet product reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-beauty`
- Mode class: `mode-commerce`
- Layout signature: Apothecary routine journal
