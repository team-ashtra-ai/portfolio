...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Aesop (https://www.aesop.com/) |
| Layout archetype | Apothecary routine journal |
| Header | Apothecary shop header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | ingredient footer |
| Typography | Verdana display with Arial body and "Courier New" accent labels |
| Colour/surface | #f3eadc, #35291f, #8c6a4f, #35291f, #c9b28c; Beauty retail with muted apothecary surfaces, serif detail, and calm product education |
| Hero | Muted product education hero |
| Section rhythm | relaxed density with varied composition and Quiet product reveal |
| Cards | Ingredient education cards |
| Forms | Routine advice form |
| CTA flow | Primary-reference CTA hierarchy using Build Routine using `Build Routine` |
| Assets | Bottles, textures, counters, botanical ingredient details |
| JS interactions | Routine finder, ingredient glossary, product filter |
| Motion | Quiet product reveal |
