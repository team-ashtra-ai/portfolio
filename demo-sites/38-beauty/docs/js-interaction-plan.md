...
| Signature behaviour | Routine finder, ingredient glossary, product filter |
...
| Optional variation | routine bundle cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Quiet product reveal must collapse cleanly under prefers-reduced-motion |
