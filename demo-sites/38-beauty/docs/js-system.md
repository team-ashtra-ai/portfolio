...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Apothecary routine journal and Muted product education hero |
| Interactive components | Routine finder, ingredient glossary, product filter, Muted product education hero, Primary-reference resource rhythm filters or archive interactions, routine bundle cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Beauty, Cosmetics & Aesthetic Products content |
| Form behaviours | Routine advice form with validation, status, honeypot, Formspree, and thanks route |
...
- Routine finder, ingredient glossary, product filter
- Muted product education hero
- Primary-reference resource rhythm filters or archive interactions
- routine bundle cards comparison/toggle/calculator behaviour
