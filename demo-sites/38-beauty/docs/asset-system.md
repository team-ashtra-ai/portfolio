...
| --- | --- |
| Image style | Bottles, textures, counters, botanical ingredient details |
| Photo style | Bottles, textures, counters, botanical ingredient details |
| Illustration/icon style | local SVG mark and diagrams following Beauty retail with muted apothecary surfaces, serif detail, and calm product education |
| Texture/background pattern | Beauty retail with muted apothecary surfaces, serif detail, and calm product education |
| Diagram style | supports ingredient and results proof and Apothecary routine journal |
...
| Border/overlay treatment | Ingredient education cards and Beauty retail with muted apothecary surfaces, serif detail, and calm product education |
