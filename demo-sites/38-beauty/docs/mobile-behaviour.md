...
| Mobile hero | Muted product education hero simplified for first-screen clarity |
| Mobile section rhythm | relaxed density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Ingredient education cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Routine advice form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Build Routine` appears after proof and remains reachable from contact/footer |
| Mobile footer | ingredient footer stacks into sitemap, conversion, contact, legal, and trust areas |
