...
| Colour | #0b0b0b, #ffffff, #b4874a, #f1eee8, #8bb8e8 plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Dark destination magazine with container-sm/md/lg/xl/fluid tokens |
| Surface | Travel editorial with black contrast, immersive destinations, and itinerary storytelling with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Journey story cards using radius, border, and shadow tokens |
| Motion | Map and story reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-travel`
- Mode class: `mode-editorial`
- Layout signature: Dark destination magazine
- Header type: Travel editorial header
- Hero type: Immersive trip hero
- Card style: Journey story cards
- Form style: Trip planner form
