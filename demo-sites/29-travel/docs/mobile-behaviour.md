...
| Mobile hero | Immersive trip hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Journey story cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Trip planner form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Plan Trip` appears after proof and remains reachable from contact/footer |
| Mobile footer | destination footer stacks into sitemap, conversion, contact, legal, and trust areas |
