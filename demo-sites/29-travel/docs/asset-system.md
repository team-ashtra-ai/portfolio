...
| --- | --- |
| Image style | Remote places, maps, itinerary details, travel photography |
| Photo style | Remote places, maps, itinerary details, travel photography |
| Illustration/icon style | local SVG mark and diagrams following Travel editorial with black contrast, immersive destinations, and itinerary storytelling |
| Texture/background pattern | Travel editorial with black contrast, immersive destinations, and itinerary storytelling |
| Diagram style | supports itinerary and safety proof and Dark destination magazine |
...
| Border/overlay treatment | Journey story cards and Travel editorial with black contrast, immersive destinations, and itinerary storytelling |
