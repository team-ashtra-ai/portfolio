...
| CTA hierarchy | Primary-reference CTA hierarchy using Plan Trip |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to curated destination expertise |
| Form type | Trip planner form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Plan Trip links |
| Trust before form | itinerary and safety proof |
...
| Conversion flow type | Immersive trip hero |
