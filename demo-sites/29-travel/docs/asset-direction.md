...
| Photo personality | Remote places, maps, itinerary details, travel photography |
| Texture/material | Travel editorial with black contrast, immersive destinations, and itinerary storytelling |
| Icon/illustration | local SVG and diagrams aligned to Travel editorial with black contrast, immersive destinations, and itinerary storytelling |
| Hero assets | Immersive trip hero needs a first-screen image or visual system that does not copy references |
