...
| Signature behaviour | Trip finder, destination filter, itinerary accordion |
...
| Optional variation | trip package cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Map and story reveal must collapse cleanly under prefers-reduced-motion |
