...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Dark destination magazine and Immersive trip hero |
| Interactive components | Trip finder, destination filter, itinerary accordion, Immersive trip hero, Primary-reference resource rhythm filters or archive interactions, trip package cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Travel, Tourism & Destination Experiences content |
| Form behaviours | Trip planner form with validation, status, honeypot, Formspree, and thanks route |
...
- Trip finder, destination filter, itinerary accordion
- Immersive trip hero
- Primary-reference resource rhythm filters or archive interactions
- trip package cards comparison/toggle/calculator behaviour
