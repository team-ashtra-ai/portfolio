...
| Signature behaviour | Dashboard tabs, KPI filters, tool stack selector |
...
| Optional variation | reporting packages, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Dashboard stack reveal must collapse cleanly under prefers-reduced-motion |
