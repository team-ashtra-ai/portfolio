...
| --- | --- | --- | --- | --- | --- | --- |
| header | Data product header | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| desktop navigation | Data product header | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| mobile menu | Primary-reference mobile navigation | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| footer | data library footer | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| hero | Metadata dashboard hero | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| CTA | Primary-reference CTA hierarchy using Plan Dashboard | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| form | Dashboard planning form | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| cards | Collaborative data cards | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| resources | Primary-reference resource rhythm | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| pricing | reporting packages | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| FAQ | technical FAQ with section-specific proof notes | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| cookie banner | Primary-reference compact consent | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-back-to-top | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| legal layout | Primary-reference plain legal notes | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| 404 page | brand-consistent recovery page with sitemap and home routes | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Plan Dashboard follow-up | dense spacing with Collaborative data cards | classes use theme-data-analytics modifiers plus component-specific classes | data-track/data-component | assets follow Data catalogues, lineage graphs, metadata workspaces | must not resemble partials in sites 15, 25, 41 |
...
| Logo position | matched to Data product header |
| Nav layout | Data product header with desktop density chosen for dense |
| CTA position | Plan Dashboard positioned as the primary route without crowding utility links |
...
- CTA placement: Plan Dashboard remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | data library footer |
| Footer density | dense |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Plan Dashboard |
| Trust/disclaimer area | visibility and decision proof |
