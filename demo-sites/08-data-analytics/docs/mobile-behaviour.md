...
| Mobile hero | Metadata dashboard hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Collaborative data cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Dashboard planning form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Plan Dashboard` appears after proof and remains reachable from contact/footer |
| Mobile footer | data library footer stacks into sitemap, conversion, contact, legal, and trust areas |
