...
| Field | Decision |
| --- | --- |
| Primary CTA | Plan Dashboard |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Plan Dashboard |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to analytical decision clarity |
| Form type | Dashboard planning form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Plan Dashboard links |
| Trust before form | visibility and decision proof |
...
| Conversion flow type | Metadata dashboard hero |
