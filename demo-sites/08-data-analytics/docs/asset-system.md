...
| --- | --- |
| Image style | Data catalogues, lineage graphs, metadata workspaces |
| Photo style | Data catalogues, lineage graphs, metadata workspaces |
| Illustration/icon style | local SVG mark and diagrams following Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards |
| Texture/background pattern | Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards |
| Diagram style | supports visibility and decision proof and Context layer data workspace |
...
| Border/overlay treatment | Collaborative data cards and Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards |
