...
| Colour | #f7f1e7, #2357ff, #25d0a3, #151a2d, #ffb84d plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Context layer data workspace with container-sm/md/lg/xl/fluid tokens |
| Surface | Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Collaborative data cards using radius, border, and shadow tokens |
| Motion | Dashboard stack reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-data-analytics`
- Mode class: `mode-technical`
- Layout signature: Context layer data workspace
