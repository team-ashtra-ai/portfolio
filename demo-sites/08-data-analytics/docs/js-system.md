...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Context layer data workspace and Metadata dashboard hero |
| Interactive components | Dashboard tabs, KPI filters, tool stack selector, Metadata dashboard hero, Primary-reference resource rhythm filters or archive interactions, reporting packages comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Data, Analytics & Business Intelligence content |
| Form behaviours | Dashboard planning form with validation, status, honeypot, Formspree, and thanks route |
...
- Dashboard tabs, KPI filters, tool stack selector
- Metadata dashboard hero
- Primary-reference resource rhythm filters or archive interactions
- reporting packages comparison/toggle/calculator behaviour
