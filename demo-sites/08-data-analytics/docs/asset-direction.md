...
| Photo personality | Data catalogues, lineage graphs, metadata workspaces |
| Texture/material | Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards |
| Icon/illustration | local SVG and diagrams aligned to Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards |
| Hero assets | Metadata dashboard hero needs a first-screen image or visual system that does not copy references |
