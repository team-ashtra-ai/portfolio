...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Atlan (https://atlan.com/) |
| Layout archetype | Context layer data workspace |
| Header | Data product header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | data library footer |
| Typography | Georgia display with Inter body and "Segoe UI" accent labels |
| Colour/surface | #f7f1e7, #2357ff, #25d0a3, #151a2d, #ffb84d; Context-layer data site with warm surfaces, blue product depth, and collaborative metadata cards |
| Hero | Metadata dashboard hero |
| Section rhythm | dense density with varied composition and Dashboard stack reveal |
| Cards | Collaborative data cards |
| Forms | Dashboard planning form |
| CTA flow | Primary-reference CTA hierarchy using Plan Dashboard using `Plan Dashboard` |
| Assets | Data catalogues, lineage graphs, metadata workspaces |
| JS interactions | Dashboard tabs, KPI filters, tool stack selector |
| Motion | Dashboard stack reveal |
