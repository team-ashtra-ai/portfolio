...
| Photo personality | Ships, containers, ports, route maps, logistics docs |
| Texture/material | Maritime corporate clarity with pale blue, logistics forms, and route tracking |
| Icon/illustration | local SVG and diagrams aligned to Maritime corporate clarity with pale blue, logistics forms, and route tracking |
| Hero assets | Shipping route hero needs a first-screen image or visual system that does not copy references |
