...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Blue ocean logistics portal and Shipping route hero |
| Interactive components | Vessel filter, port schedule, cargo quote form, Shipping route hero, Primary-reference resource rhythm filters or archive interactions, cargo quote cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Maritime, Shipping & Marine Services content |
| Form behaviours | Shipping quote form with validation, status, honeypot, Formspree, and thanks route |
...
- Vessel filter, port schedule, cargo quote form
- Shipping route hero
- Primary-reference resource rhythm filters or archive interactions
- cargo quote cards comparison/toggle/calculator behaviour
