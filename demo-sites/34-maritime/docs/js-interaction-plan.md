...
| Signature behaviour | Vessel filter, port schedule, cargo quote form |
...
| Optional variation | cargo quote cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Route schedule reveal must collapse cleanly under prefers-reduced-motion |
