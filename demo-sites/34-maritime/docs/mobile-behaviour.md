...
| Mobile hero | Shipping route hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Cargo service cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Shipping quote form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Shipping` appears after proof and remains reachable from contact/footer |
| Mobile footer | port support footer stacks into sitemap, conversion, contact, legal, and trust areas |
