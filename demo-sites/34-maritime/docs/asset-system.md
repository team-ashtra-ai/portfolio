...
| --- | --- |
| Image style | Ships, containers, ports, route maps, logistics docs |
| Photo style | Ships, containers, ports, route maps, logistics docs |
| Illustration/icon style | local SVG mark and diagrams following Maritime corporate clarity with pale blue, logistics forms, and route tracking |
| Texture/background pattern | Maritime corporate clarity with pale blue, logistics forms, and route tracking |
| Diagram style | supports capacity and tracking proof and Blue ocean logistics portal |
...
| Border/overlay treatment | Cargo service cards and Maritime corporate clarity with pale blue, logistics forms, and route tracking |
