...
| Field | Decision |
| --- | --- |
| Primary CTA | Request Shipping |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Request Shipping |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to maritime operational assurance |
| Form type | Shipping quote form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Request Shipping links |
| Trust before form | capacity and tracking proof |
...
| Conversion flow type | Shipping route hero |
