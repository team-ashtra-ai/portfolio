...
CommonGood must feel like a standalone premium website for Nonprofit, Charity & Social Impact, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 04, 14, 30.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | urgent transparent |
| Visual mood | Nonprofit with yellow urgency, human impact proof, and donation clarity |
| Industry tone | transparent impact urgency |
| Buyer psychology | trust and contribution |
| Trust style | donation and report proof |
| Conversion style | Primary-reference CTA hierarchy using Donate Today |
| Content density | medium |
| Image personality | Community photos, water projects, donor reports, maps |
| Level of formality | formal |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | A donor site with bold yellow impact modules, transparent metrics, story cards, and donation selector |
| Commercial feeling | Primary-reference CTA hierarchy using Donate Today |
...
| Stats/quotes/eyebrows | accented through Impact story cards and Nonprofit with yellow urgency, human impact proof, and donation clarity |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #ffffff, #ffc907, #2b6cb0, #111111, #ffc907 |
...
| Border style | matched to Impact story cards with unique radius and border strength |
| Texture usage | Nonprofit with yellow urgency, human impact proof, and donation clarity texture; no generic repeated decorative background |
...
- Premium direction: A donor site with bold yellow impact modules, transparent metrics, story cards, and donation selector
- Brand mood: urgent transparent
- Buyer psychology: trust and contribution
- Layout archetype: Transparent donation impact flow
- Density: medium
- Shape language: Impact story cards
- Surface/material: Nonprofit with yellow urgency, human impact proof, and donation clarity
- Image system: Community photos, water projects, donor reports, maps
- Interaction model: Yellow impact hero
- CTA style: Primary-reference CTA hierarchy using Donate Today
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 04, 14, 30.
