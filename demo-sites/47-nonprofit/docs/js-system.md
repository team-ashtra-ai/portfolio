...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Transparent donation impact flow and Yellow impact hero |
| Interactive components | Donation selector, impact calculator, volunteer role filter, Yellow impact hero, Primary-reference resource rhythm filters or archive interactions, donation impact cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Nonprofit, Charity & Social Impact content |
| Form behaviours | Donation form with validation, status, honeypot, Formspree, and thanks route |
...
- Donation selector, impact calculator, volunteer role filter
- Yellow impact hero
- Primary-reference resource rhythm filters or archive interactions
- donation impact cards comparison/toggle/calculator behaviour
