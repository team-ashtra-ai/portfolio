...
| Signature behaviour | Donation selector, impact calculator, volunteer role filter |
...
| Optional variation | donation impact cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Impact counter reveal must collapse cleanly under prefers-reduced-motion |
