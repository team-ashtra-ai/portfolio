...
| Mobile hero | Yellow impact hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Impact story cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Donation form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Donate Today` appears after proof and remains reachable from contact/footer |
| Mobile footer | impact footer stacks into sitemap, conversion, contact, legal, and trust areas |
