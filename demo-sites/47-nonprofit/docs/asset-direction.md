...
| Photo personality | Community photos, water projects, donor reports, maps |
| Texture/material | Nonprofit with yellow urgency, human impact proof, and donation clarity |
| Icon/illustration | local SVG and diagrams aligned to Nonprofit with yellow urgency, human impact proof, and donation clarity |
| Hero assets | Yellow impact hero needs a first-screen image or visual system that does not copy references |
