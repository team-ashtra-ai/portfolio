...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Transparent donation impact flow` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Transparent donation impact flow with full container range |
...
| Mobile hero style | Yellow impact hero simplified without losing proof or CTA |
| Mobile card stacking | Impact story cards stacks or scrolls only when intentional |
| Mobile form behaviour | Donation form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Donate Today appears after proof and in contact routes |
| Mobile footer structure | impact footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Community photos, water projects, donor reports, maps |
