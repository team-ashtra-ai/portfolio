...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | charity: water (https://www.charitywater.org/) |
| Layout archetype | Transparent donation impact flow |
| Header | Donation campaign header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | impact footer |
| Typography | "Arial Narrow" display with Verdana body and Inter accent labels |
| Colour/surface | #ffffff, #ffc907, #2b6cb0, #111111, #ffc907; Nonprofit with yellow urgency, human impact proof, and donation clarity |
| Hero | Yellow impact hero |
| Section rhythm | medium density with varied composition and Impact counter reveal |
| Cards | Impact story cards |
| Forms | Donation form |
| CTA flow | Primary-reference CTA hierarchy using Donate Today using `Donate Today` |
| Assets | Community photos, water projects, donor reports, maps |
| JS interactions | Donation selector, impact calculator, volunteer role filter |
| Motion | Impact counter reveal |
