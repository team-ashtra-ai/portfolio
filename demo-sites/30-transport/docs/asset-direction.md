...
| Photo personality | Transit maps, route lines, vehicles, city movement |
| Texture/material | Transit utility with bright green, map-first decisions, and route cards |
| Icon/illustration | local SVG and diagrams aligned to Transit utility with bright green, map-first decisions, and route cards |
| Hero assets | Green transit planner hero needs a first-screen image or visual system that does not copy references |
