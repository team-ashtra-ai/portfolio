...
| Colour | #eaff57, #133a1b, #00a66a, #133a1b, #ffffff plus semantic success/warning/error/link/CTA tokens |
| Spacing | practical density expressed through --space-* and --space-section |
| Grid/layout | Map-first route planner with container-sm/md/lg/xl/fluid tokens |
| Surface | Transit utility with bright green, map-first decisions, and route cards with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Transit route cards using radius, border, and shadow tokens |
| Motion | Route line reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-transport`
- Mode class: `mode-professional`
- Layout signature: Map-first route planner
