...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Citymapper (https://citymapper.com/) |
| Layout archetype | Map-first route planner |
| Header | Route utility header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | fleet support footer |
| Typography | Aptos display with Inter body and Constantia accent labels |
| Colour/surface | #eaff57, #133a1b, #00a66a, #133a1b, #ffffff; Transit utility with bright green, map-first decisions, and route cards |
| Hero | Green transit planner hero |
| Section rhythm | practical density with varied composition and Route line reveal |
| Cards | Transit route cards |
| Forms | Fare estimate form |
| CTA flow | Primary-reference CTA hierarchy using Book Ride using `Book Ride` |
| Assets | Transit maps, route lines, vehicles, city movement |
| JS interactions | Route selector, fare estimate, fleet filter |
| Motion | Route line reveal |
