...
| Mobile hero | Green transit planner hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Transit route cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Fare estimate form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Ride` appears after proof and remains reachable from contact/footer |
| Mobile footer | fleet support footer stacks into sitemap, conversion, contact, legal, and trust areas |
