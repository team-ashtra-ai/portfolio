...
| Signature behaviour | Route selector, fare estimate, fleet filter |
...
| Optional variation | fare route cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Route line reveal must collapse cleanly under prefers-reduced-motion |
