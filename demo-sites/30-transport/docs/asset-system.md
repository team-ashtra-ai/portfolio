...
| --- | --- |
| Image style | Transit maps, route lines, vehicles, city movement |
| Photo style | Transit maps, route lines, vehicles, city movement |
| Illustration/icon style | local SVG mark and diagrams following Transit utility with bright green, map-first decisions, and route cards |
| Texture/background pattern | Transit utility with bright green, map-first decisions, and route cards |
| Diagram style | supports safety and reliability proof and Map-first route planner |
...
| Border/overlay treatment | Transit route cards and Transit utility with bright green, map-first decisions, and route cards |
