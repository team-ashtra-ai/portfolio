...
| CTA hierarchy | Primary-reference CTA hierarchy using Book Ride |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to safe passenger coordination |
| Form type | Fare estimate form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Ride links |
| Trust before form | safety and reliability proof |
...
| Conversion flow type | Green transit planner hero |
