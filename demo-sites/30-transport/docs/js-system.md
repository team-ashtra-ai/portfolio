...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Map-first route planner and Green transit planner hero |
| Interactive components | Route selector, fare estimate, fleet filter, Green transit planner hero, Primary-reference resource rhythm filters or archive interactions, fare route cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Transport, Mobility & Passenger Services content |
| Form behaviours | Fare estimate form with validation, status, honeypot, Formspree, and thanks route |
...
- Route selector, fare estimate, fleet filter
- Green transit planner hero
- Primary-reference resource rhythm filters or archive interactions
- fare route cards comparison/toggle/calculator behaviour
