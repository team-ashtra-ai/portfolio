...
RideSure must feel like a standalone premium website for Transport, Mobility & Passenger Services, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 13, 37, 47.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | route-led |
| Visual mood | Transit utility with bright green, map-first decisions, and route cards |
| Industry tone | safe passenger coordination |
| Buyer psychology | safe reliable movement |
| Trust style | safety and reliability proof |
| Conversion style | Primary-reference CTA hierarchy using Book Ride |
| Content density | practical |
| Image personality | Transit maps, route lines, vehicles, city movement |
| Level of formality | formal |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | A passenger mobility site with green route planning, fare estimate cards, map surfaces, and fast booking |
| Commercial feeling | Primary-reference CTA hierarchy using Book Ride |
...
| Stats/quotes/eyebrows | accented through Transit route cards and Transit utility with bright green, map-first decisions, and route cards |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #eaff57, #133a1b, #00a66a, #133a1b, #ffffff |
...
| Border style | matched to Transit route cards with unique radius and border strength |
| Texture usage | Transit utility with bright green, map-first decisions, and route cards texture; no generic repeated decorative background |
...
- Premium direction: A passenger mobility site with green route planning, fare estimate cards, map surfaces, and fast booking
- Brand mood: route-led
- Buyer psychology: safe reliable movement
- Layout archetype: Map-first route planner
- Density: practical
- Shape language: Transit route cards
- Surface/material: Transit utility with bright green, map-first decisions, and route cards
- Image system: Transit maps, route lines, vehicles, city movement
- Interaction model: Green transit planner hero
- CTA style: Primary-reference CTA hierarchy using Book Ride
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 13, 37, 47.
