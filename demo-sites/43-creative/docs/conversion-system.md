...
| CTA hierarchy | Primary-reference CTA hierarchy using Start Project |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to visual production taste |
| Form type | Creative brief form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Start Project links |
| Trust before form | portfolio and usage proof |
...
| Conversion flow type | Typographic work hero |
