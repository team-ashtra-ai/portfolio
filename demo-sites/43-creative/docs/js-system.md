...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Graphic design portfolio grid and Typographic work hero |
| Interactive components | Portfolio filter, project lightbox, file/brief upload, Typographic work hero, Primary-reference resource rhythm filters or archive interactions, production package cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Creative, Design & Visual Production content |
| Form behaviours | Creative brief form with validation, status, honeypot, Formspree, and thanks route |
...
- Portfolio filter, project lightbox, file/brief upload
- Typographic work hero
- Primary-reference resource rhythm filters or archive interactions
- production package cards comparison/toggle/calculator behaviour
