...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Graphic design portfolio grid` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Graphic design portfolio grid with full container range |
...
| Mobile hero style | Typographic work hero simplified without losing proof or CTA |
| Mobile card stacking | Identity project cards stacks or scrolls only when intentional |
| Mobile form behaviour | Creative brief form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Start Project appears after proof and in contact routes |
| Mobile footer structure | project footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Brand systems, posters, design boards, case images |
