...
| --- | --- |
| Image style | Brand systems, posters, design boards, case images |
| Photo style | Brand systems, posters, design boards, case images |
| Illustration/icon style | local SVG mark and diagrams following Design portfolio with stark white, red accents, huge typography, and rigorous grids |
| Texture/background pattern | Design portfolio with stark white, red accents, huge typography, and rigorous grids |
| Diagram style | supports portfolio and usage proof and Graphic design portfolio grid |
...
| Border/overlay treatment | Identity project cards and Design portfolio with stark white, red accents, huge typography, and rigorous grids |
