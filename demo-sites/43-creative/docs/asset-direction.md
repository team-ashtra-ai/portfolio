...
| Photo personality | Brand systems, posters, design boards, case images |
| Texture/material | Design portfolio with stark white, red accents, huge typography, and rigorous grids |
| Icon/illustration | local SVG and diagrams aligned to Design portfolio with stark white, red accents, huge typography, and rigorous grids |
| Hero assets | Typographic work hero needs a first-screen image or visual system that does not copy references |
