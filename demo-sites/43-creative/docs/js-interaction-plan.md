...
| Signature behaviour | Portfolio filter, project lightbox, file/brief upload |
...
| Optional variation | production package cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Grid reveal must collapse cleanly under prefers-reduced-motion |
