...
| Colour | #ffffff, #111111, #e30613, #111111, #0057ff plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Graphic design portfolio grid with container-sm/md/lg/xl/fluid tokens |
| Surface | Design portfolio with stark white, red accents, huge typography, and rigorous grids with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Identity project cards using radius, border, and shadow tokens |
| Motion | Grid reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-creative`
- Mode class: `mode-editorial`
- Layout signature: Graphic design portfolio grid
