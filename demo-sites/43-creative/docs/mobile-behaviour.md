...
| Mobile hero | Typographic work hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Identity project cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Creative brief form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Start Project` appears after proof and remains reachable from contact/footer |
| Mobile footer | project footer stacks into sitemap, conversion, contact, legal, and trust areas |
