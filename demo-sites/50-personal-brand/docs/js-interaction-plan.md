...
| Signature behaviour | Media filter, speaking topic selector, press kit download |
...
| Optional variation | speaking rate cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Newsletter reveal must collapse cleanly under prefers-reduced-motion |
