...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Author essay and media system and Editorial author hero |
| Interactive components | Media filter, speaking topic selector, press kit download, Editorial author hero, Primary-reference resource rhythm filters or archive interactions, speaking rate cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Personal Brands, Creators & Public Figures content |
| Form behaviours | Booking form with validation, status, honeypot, Formspree, and thanks route |
...
- Media filter, speaking topic selector, press kit download
- Editorial author hero
- Primary-reference resource rhythm filters or archive interactions
- speaking rate cards comparison/toggle/calculator behaviour
