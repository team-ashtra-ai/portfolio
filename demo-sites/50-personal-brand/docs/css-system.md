...
| Colour | #fffdf8, #17233c, #c09a4a, #17233c, #3f6f6b plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Author essay and media system with container-sm/md/lg/xl/fluid tokens |
| Surface | Personal brand with clean essays, author authority, newsletter focus, and simple navigation with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Essay media cards using radius, border, and shadow tokens |
| Motion | Newsletter reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-personal-brand`
- Mode class: `mode-editorial`
- Layout signature: Author essay and media system
- Header type: Simple author header
- Hero type: Editorial author hero
- Card style: Essay media cards
- Form style: Booking form
