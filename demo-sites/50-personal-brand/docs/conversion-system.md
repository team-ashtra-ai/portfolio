...
| Field | Decision |
| --- | --- |
| Primary CTA | Book Appearance |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Book Appearance |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to public authority and personal voice |
| Form type | Booking form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Appearance links |
| Trust before form | authority and media proof |
...
| Conversion flow type | Editorial author hero |
