...
| Photo personality | Author portraits, books, essays, podcast and speaking panels |
| Texture/material | Personal brand with clean essays, author authority, newsletter focus, and simple navigation |
| Icon/illustration | local SVG and diagrams aligned to Personal brand with clean essays, author authority, newsletter focus, and simple navigation |
| Hero assets | Editorial author hero needs a first-screen image or visual system that does not copy references |
