...
## 1. James Clear (direct)

URL: https://jamesclear.com/

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific personal brands, creators & public figures credibility; translate into Author essay and media system rather than copying James Clear. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Simple author header. |
...
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
| Typography mood | Study the mood, then express it through "Arial Narrow" display with Aptos body and "Trebuchet MS" accent labels. |
| Colour palette | Translate reference contrast into the original palette #fffdf8, #17233c, #c09a4a, #17233c, #3f6f6b. |
| Surface system | Use surface hierarchy ideas only; final surfaces are Personal brand with clean essays, author authority, newsletter focus, and simple navigation. |
| Hero type | Use the reference to pressure-test the first screen, then build an original Editorial author hero. |
| Section rhythm | Extract pacing lessons and apply varied fixed-section composition, not a copied sequence. |
| Card design | Convert card intent into Essay media cards with unique spacing, shape, and state rules. |
| Form pattern | Use friction and reassurance cues to refine the original Booking form. |
| CTA flow | Map intent to Primary-reference CTA hierarchy using Book Appearance and primary CTA `Book Appearance`. |
| Asset direction | Translate asset principles into Author portraits, books, essays, podcast and speaking panels and local ASH-TRA assets. |
| Image treatment | Use crop/contrast lessons without using the reference images, crops, or art direction directly. |
| Icon/illustration style | Extract clarity and hierarchy only; final icon language stays local to Nameplate. |
| JS interaction ideas | Use as inspiration for Media filter, speaking topic selector, press kit download while preserving readable static content. |
| Motion style | Reduce or reshape motion into Newsletter reveal with reduced-motion support. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific personal brands, creators & public figures credibility; translate into Author essay and media system rather than copying Seth Godin. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
...
## 3. Tim Ferriss (direct)

URL: https://tim.blog

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific personal brands, creators & public figures credibility; translate into Author essay and media system rather than copying Tim Ferriss. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
...
## 4. Marie Forleo (adjacent)

URL: https://www.marieforleo.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for authority and booking confidence; translate into Author essay and media system rather than copying Marie Forleo. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
| Typography mood | Study the mood, then express it through "Arial Narrow" display with Aptos body and "Trebuchet MS" accent labels. |
...
## 5. Simon Sinek (adjacent)

URL: https://simonsinek.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for authority and booking confidence; translate into Author essay and media system rather than copying Simon Sinek. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic editorial design; translate into Author essay and media system rather than copying Monocle. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
| Typography mood | Study the mood, then express it through "Arial Narrow" display with Aptos body and "Trebuchet MS" accent labels. |
...
## 7. The New Yorker (contrast)

URL: https://www.newyorker.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic editorial design; translate into Author essay and media system rather than copying The New Yorker. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
...
## 8. Mobbin media kit and newsletter patterns (interaction)

URL: https://mobbin.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract interaction reference for Media filter, speaking topic selector, press kit download; translate into Author essay and media system rather than copying Mobbin media kit and newsletter patterns. |
| Header structure | Borrow the decision logic of a interaction reference, then rebuild as Simple author header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to spacious. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as press kit footer. |
| Typography mood | Study the mood, then express it through "Arial Narrow" display with Aptos body and "Trebuchet MS" accent labels. |
