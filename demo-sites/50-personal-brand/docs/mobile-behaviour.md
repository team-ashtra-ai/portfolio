...
| Mobile hero | Editorial author hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Essay media cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Booking form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Appearance` appears after proof and remains reachable from contact/footer |
| Mobile footer | press kit footer stacks into sitemap, conversion, contact, legal, and trust areas |
