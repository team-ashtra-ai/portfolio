...
| Photo personality | Forms, service lists, notices, public task flows |
| Texture/material | Public service with plain language, blue actions, and high-contrast forms |
| Icon/illustration | local SVG and diagrams aligned to Public service with plain language, blue actions, and high-contrast forms |
| Hero assets | Plain service hero needs a first-screen image or visual system that does not copy references |
