...
| --- | --- | --- | --- | --- | --- | --- |
| header | GOV-style service header | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| desktop navigation | GOV-style service header | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| mobile menu | Primary-reference mobile navigation | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| footer | service directory footer | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| hero | Plain service hero | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| CTA | Primary-reference CTA hierarchy using Start Request | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| form | Public request form | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| cards | Square service boxes | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| resources | Primary-reference resource rhythm | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| pricing | service eligibility cards | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| FAQ | civic FAQ with section-specific proof notes | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| cookie banner | Primary-reference compact consent | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-back-to-top | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| legal layout | Primary-reference plain legal notes | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| 404 page | brand-consistent recovery page with sitemap and home routes | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Start Request follow-up | practical spacing with Square service boxes | classes use theme-government modifiers plus component-specific classes | data-track/data-component | assets follow Forms, service lists, notices, public task flows | must not resemble partials in sites 03, 13, 29 |
...
| Logo position | matched to GOV-style service header |
| Nav layout | GOV-style service header with desktop density chosen for practical |
| CTA position | Start Request positioned as the primary route without crowding utility links |
...
- CTA placement: Start Request remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Public service with plain language, blue actions, and high-contrast forms

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | service directory footer |
| Footer density | practical |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Start Request |
| Trust/disclaimer area | transparency and eligibility proof |
