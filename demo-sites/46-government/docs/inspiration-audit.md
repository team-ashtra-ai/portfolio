...
The strongest visual translation target for this site is GOV.UK Design System: https://design-system.service.gov.uk/.
...
| Type | Reference | URL |
| --- | --- | --- |
| direct | GOV.UK Design System | https://design-system.service.gov.uk/ |
| direct | GOV.UK | https://www.gov.uk |
| direct | USWDS | https://designsystem.digital.gov |
| adjacent | NYC.gov | https://www.nyc.gov |
| adjacent | Data.gov | https://data.gov |
| contrast | Citymapper | https://citymapper.com |
| contrast | Octopus Energy | https://octopus.energy |
| interaction | USWDS service form patterns | https://designsystem.digital.gov |
