...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Public service task flow and Plain service hero |
| Interactive components | Service search, form finder, document filter, alert controls, Plain service hero, Primary-reference resource rhythm filters or archive interactions, service eligibility cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Government, Public Sector & Civic Services content |
| Form behaviours | Public request form with validation, status, honeypot, Formspree, and thanks route |
...
- Service search, form finder, document filter, alert controls
- Plain service hero
- Primary-reference resource rhythm filters or archive interactions
- service eligibility cards comparison/toggle/calculator behaviour
