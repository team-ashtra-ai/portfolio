...
| Signature behaviour | Service search, form finder, document filter, alert controls |
...
| Optional variation | service eligibility cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Minimal state reveal must collapse cleanly under prefers-reduced-motion |
