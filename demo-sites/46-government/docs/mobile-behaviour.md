...
| Mobile hero | Plain service hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Square service boxes remains visually distinct in one-column or scroll treatment |
| Mobile forms | Public request form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Start Request` appears after proof and remains reachable from contact/footer |
| Mobile footer | service directory footer stacks into sitemap, conversion, contact, legal, and trust areas |
