...
| Colour | #ffffff, #1d70b8, #ffdd00, #0b0c0c, #ffdd00 plus semantic success/warning/error/link/CTA tokens |
| Spacing | practical density expressed through --space-* and --space-section |
| Grid/layout | Public service task flow with container-sm/md/lg/xl/fluid tokens |
| Surface | Public service with plain language, blue actions, and high-contrast forms with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Square service boxes using radius, border, and shadow tokens |
| Motion | Minimal state reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-government`
- Mode class: `mode-civic`
- Layout signature: Public service task flow
