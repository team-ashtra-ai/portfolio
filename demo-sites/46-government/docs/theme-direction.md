...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | GOV.UK Design System (https://design-system.service.gov.uk/) |
| Layout archetype | Public service task flow |
| Header | GOV-style service header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | service directory footer |
| Typography | "Arial Narrow" display with "Segoe UI" body and "Lucida Sans" accent labels |
| Colour/surface | #ffffff, #1d70b8, #ffdd00, #0b0c0c, #ffdd00; Public service with plain language, blue actions, and high-contrast forms |
| Hero | Plain service hero |
| Section rhythm | practical density with varied composition and Minimal state reveal |
| Cards | Square service boxes |
| Forms | Public request form |
| CTA flow | Primary-reference CTA hierarchy using Start Request using `Start Request` |
| Assets | Forms, service lists, notices, public task flows |
| JS interactions | Service search, form finder, document filter, alert controls |
| Motion | Minimal state reveal |
