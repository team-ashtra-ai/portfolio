...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Boom Supersonic (https://boomsupersonic.com/) |
| Layout archetype | Supersonic operations deck |
| Header | Aviation product header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | compliance footer |
| Typography | Aptos display with Verdana body and "Lucida Sans" accent labels |
| Colour/surface | #050b18, #ff6f2c, #4cc9f0, #ffffff, #223456; Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence |
| Hero | Aerospace velocity hero |
| Section rhythm | spacious density with varied composition and Velocity line reveal |
| Cards | Fleet specification cards |
| Forms | Charter route form |
| CTA flow | Primary-reference CTA hierarchy using Request Charter using `Request Charter` |
| Assets | Aircraft, runways, hangars, flight paths |
| JS interactions | Fleet specs tabs, safety checklist, charter route form |
| Motion | Velocity line reveal |
