...
| --- | --- |
| Image style | Aircraft, runways, hangars, flight paths |
| Photo style | Aircraft, runways, hangars, flight paths |
| Illustration/icon style | local SVG mark and diagrams following Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence |
| Texture/background pattern | Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence |
| Diagram style | supports safety and compliance proof and Supersonic operations deck |
...
| Border/overlay treatment | Fleet specification cards and Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence |
