...
| Photo personality | Aircraft, runways, hangars, flight paths |
| Texture/material | Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence |
| Icon/illustration | local SVG and diagrams aligned to Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence |
| Hero assets | Aerospace velocity hero needs a first-screen image or visual system that does not copy references |
