...
| Mobile hero | Aerospace velocity hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Fleet specification cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Charter route form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Charter` appears after proof and remains reachable from contact/footer |
| Mobile footer | compliance footer stacks into sitemap, conversion, contact, legal, and trust areas |
