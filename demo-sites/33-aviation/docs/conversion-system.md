...
| Field | Decision |
| --- | --- |
| Primary CTA | Request Charter |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Request Charter |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to aviation safety professionalism |
| Form type | Charter route form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Request Charter links |
| Trust before form | safety and compliance proof |
...
| Conversion flow type | Aerospace velocity hero |
