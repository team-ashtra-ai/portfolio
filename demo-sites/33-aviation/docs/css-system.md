...
| Colour | #050b18, #ff6f2c, #4cc9f0, #ffffff, #223456 plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Supersonic operations deck with container-sm/md/lg/xl/fluid tokens |
| Surface | Aviation future with dark aerospace surfaces, orange velocity, and fleet-spec confidence with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Fleet specification cards using radius, border, and shadow tokens |
| Motion | Velocity line reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-aviation`
- Mode class: `mode-dark`
- Layout signature: Supersonic operations deck
