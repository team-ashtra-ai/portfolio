...
| Signature behaviour | Fleet specs tabs, safety checklist, charter route form |
...
| Optional variation | charter route cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Velocity line reveal must collapse cleanly under prefers-reduced-motion |
