...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Supersonic operations deck and Aerospace velocity hero |
| Interactive components | Fleet specs tabs, safety checklist, charter route form, Aerospace velocity hero, Primary-reference resource rhythm filters or archive interactions, charter route cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Aviation, Aerospace & Air Services content |
| Form behaviours | Charter route form with validation, status, honeypot, Formspree, and thanks route |
...
- Fleet specs tabs, safety checklist, charter route form
- Aerospace velocity hero
- Primary-reference resource rhythm filters or archive interactions
- charter route cards comparison/toggle/calculator behaviour
