...
| Photo personality | 3D printers, material samples, production benches |
| Texture/material | Manufacturing product clarity with precise specs, orange highlights, and printer-like panels |
| Icon/illustration | local SVG and diagrams aligned to Manufacturing product clarity with precise specs, orange highlights, and printer-like panels |
| Hero assets | Precision product hero needs a first-screen image or visual system that does not copy references |
