...
| Signature behaviour | Capability filter, spec table toggle, facility gallery |
...
| Optional variation | volume/spec quote table, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Spec table reveal must collapse cleanly under prefers-reduced-motion |
