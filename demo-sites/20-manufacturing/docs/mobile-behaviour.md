...
| Mobile hero | Precision product hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Specification cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | RFQ spec form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Send RFQ` appears after proof and remains reachable from contact/footer |
| Mobile footer | capability footer stacks into sitemap, conversion, contact, legal, and trust areas |
