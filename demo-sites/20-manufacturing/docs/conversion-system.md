...
| Field | Decision |
| --- | --- |
| Primary CTA | Send RFQ |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Send RFQ |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to industrial production discipline |
| Form type | RFQ spec form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Send RFQ links |
| Trust before form | quality and capacity proof |
...
| Conversion flow type | Precision product hero |
