...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Formlabs (https://formlabs.com/) |
| Layout archetype | Industrial product specification |
| Header | Manufacturing product header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | capability footer |
| Typography | "Trebuchet MS" display with Aptos body and Didot accent labels |
| Colour/surface | #f8f8f8, #111111, #ff5f1f, #111111, #6b7280; Manufacturing product clarity with precise specs, orange highlights, and printer-like panels |
| Hero | Precision product hero |
| Section rhythm | dense density with varied composition and Spec table reveal |
| Cards | Specification cards |
| Forms | RFQ spec form |
| CTA flow | Primary-reference CTA hierarchy using Send RFQ using `Send RFQ` |
| Assets | 3D printers, material samples, production benches |
| JS interactions | Capability filter, spec table toggle, facility gallery |
| Motion | Spec table reveal |
