...
| Colour | #f8f8f8, #111111, #ff5f1f, #111111, #6b7280 plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Industrial product specification with container-sm/md/lg/xl/fluid tokens |
| Surface | Manufacturing product clarity with precise specs, orange highlights, and printer-like panels with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Specification cards using radius, border, and shadow tokens |
| Motion | Spec table reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-manufacturing`
- Mode class: `mode-technical`
- Layout signature: Industrial product specification
