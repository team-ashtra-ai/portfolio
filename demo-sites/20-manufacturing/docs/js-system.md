...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Industrial product specification and Precision product hero |
| Interactive components | Capability filter, spec table toggle, facility gallery, Precision product hero, Primary-reference resource rhythm filters or archive interactions, volume/spec quote table comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Manufacturing, Production & Industrial Operations content |
| Form behaviours | RFQ spec form with validation, status, honeypot, Formspree, and thanks route |
...
- Capability filter, spec table toggle, facility gallery
- Precision product hero
- Primary-reference resource rhythm filters or archive interactions
- volume/spec quote table comparison/toggle/calculator behaviour
