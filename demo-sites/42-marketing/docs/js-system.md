...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Dark agency case system and Immersive case-study hero |
| Interactive components | Case study filter, campaign result tabs, brief form, Immersive case-study hero, Primary-reference resource rhythm filters or archive interactions, campaign package cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Marketing, Advertising & Communications content |
| Form behaviours | Brief form with validation, status, honeypot, Formspree, and thanks route |
...
- Case study filter, campaign result tabs, brief form
- Immersive case-study hero
- Primary-reference resource rhythm filters or archive interactions
- campaign package cards comparison/toggle/calculator behaviour
