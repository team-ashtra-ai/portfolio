...
| Colour | #050505, #ffffff, #6bdcff, #ffffff, #9bff6d plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Dark agency case system with container-sm/md/lg/xl/fluid tokens |
| Surface | Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Dark campaign cards using radius, border, and shadow tokens |
| Motion | Case panel reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-marketing`
- Mode class: `mode-professional`
- Layout signature: Dark agency case system
