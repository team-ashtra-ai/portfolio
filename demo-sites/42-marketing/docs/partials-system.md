...
| --- | --- | --- | --- | --- | --- | --- |
| header | Minimal agency header | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| desktop navigation | Minimal agency header | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| mobile menu | Primary-reference mobile navigation | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| footer | case study footer | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| hero | Immersive case-study hero | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| CTA | Primary-reference CTA hierarchy using Send Campaign Brief | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| form | Brief form | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| cards | Dark campaign cards | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| resources | Primary-reference resource rhythm | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| pricing | campaign package cards | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| FAQ | professional FAQ with section-specific proof notes | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| cookie banner | Primary-reference compact consent | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-back-to-top | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| legal layout | Primary-reference plain legal notes | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| 404 page | brand-consistent recovery page with sitemap and home routes | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Send Campaign Brief follow-up | medium spacing with Dark campaign cards | classes use theme-marketing modifiers plus component-specific classes | data-track/data-component | assets follow Campaign visuals, digital products, studio screens, metrics | must not resemble partials in sites 09, 25, 49 |
...
| Logo position | matched to Minimal agency header |
| Nav layout | Minimal agency header with desktop density chosen for medium |
| CTA position | Send Campaign Brief positioned as the primary route without crowding utility links |
...
- CTA placement: Send Campaign Brief remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | case study footer |
| Footer density | medium |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Send Campaign Brief |
| Trust/disclaimer area | work and result proof |
