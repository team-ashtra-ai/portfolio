...
| Photo personality | Campaign visuals, digital products, studio screens, metrics |
| Texture/material | Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity |
| Icon/illustration | local SVG and diagrams aligned to Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity |
| Hero assets | Immersive case-study hero needs a first-screen image or visual system that does not copy references |
