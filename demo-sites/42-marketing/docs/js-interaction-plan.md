...
| Signature behaviour | Case study filter, campaign result tabs, brief form |
...
| Optional variation | campaign package cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Case panel reveal must collapse cleanly under prefers-reduced-motion |
