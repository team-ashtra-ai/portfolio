...
| --- | --- |
| Image style | Campaign visuals, digital products, studio screens, metrics |
| Photo style | Campaign visuals, digital products, studio screens, metrics |
| Illustration/icon style | local SVG mark and diagrams following Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity |
| Texture/background pattern | Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity |
| Diagram style | supports work and result proof and Dark agency case system |
...
| Border/overlay treatment | Dark campaign cards and Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity |
