...
| --- | --- |
| Layout archetype | Extract industry-specific marketing, advertising & communications credibility; translate into Dark agency case system rather than copying AKQA. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Minimal agency header. |
...
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
| Typography mood | Study the mood, then express it through Verdana display with Aptos body and "Courier New" accent labels. |
| Colour palette | Translate reference contrast into the original palette #050505, #ffffff, #6bdcff, #ffffff, #9bff6d. |
| Surface system | Use surface hierarchy ideas only; final surfaces are Agency minimalism with dark futurist surfaces, crisp white type, and case-study gravity. |
| Hero type | Use the reference to pressure-test the first screen, then build an original Immersive case-study hero. |
| Section rhythm | Extract pacing lessons and apply varied fixed-section composition, not a copied sequence. |
| Card design | Convert card intent into Dark campaign cards with unique spacing, shape, and state rules. |
| Form pattern | Use friction and reassurance cues to refine the original Brief form. |
| CTA flow | Map intent to Primary-reference CTA hierarchy using Send Campaign Brief and primary CTA `Send Campaign Brief`. |
| Asset direction | Translate asset principles into Campaign visuals, digital products, studio screens, metrics and local ASH-TRA assets. |
| Image treatment | Use crop/contrast lessons without using the reference images, crops, or art direction directly. |
| Icon/illustration style | Extract clarity and hierarchy only; final icon language stays local to SignalCraft. |
| JS interaction ideas | Use as inspiration for Case study filter, campaign result tabs, brief form while preserving readable static content. |
| Motion style | Reduce or reshape motion into Case panel reveal with reduced-motion support. |
...
## 2. Wieden Kennedy (direct)

URL: https://www.wk.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific marketing, advertising & communications credibility; translate into Dark agency case system rather than copying Wieden Kennedy. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific marketing, advertising & communications credibility; translate into Dark agency case system rather than copying Ogilvy. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for results and creative confidence; translate into Dark agency case system rather than copying RGA. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
| Typography mood | Study the mood, then express it through Verdana display with Aptos body and "Courier New" accent labels. |
...
## 5. Media.Monks (adjacent)

URL: https://media.monks.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for results and creative confidence; translate into Dark agency case system rather than copying Media.Monks. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
...
## 6. Pentagram (contrast)

URL: https://www.pentagram.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic professional design; translate into Dark agency case system rather than copying Pentagram. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
| Typography mood | Study the mood, then express it through Verdana display with Aptos body and "Courier New" accent labels. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic professional design; translate into Dark agency case system rather than copying Stripe. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
...
## 8. Mobbin case study filter patterns (interaction)

URL: https://mobbin.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract interaction reference for Case study filter, campaign result tabs, brief form; translate into Dark agency case system rather than copying Mobbin case study filter patterns. |
| Header structure | Borrow the decision logic of a interaction reference, then rebuild as Minimal agency header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to medium. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as case study footer. |
| Typography mood | Study the mood, then express it through Verdana display with Aptos body and "Courier New" accent labels. |
