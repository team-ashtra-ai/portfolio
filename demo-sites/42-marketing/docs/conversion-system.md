...
| Field | Decision |
| --- | --- |
| Primary CTA | Send Campaign Brief |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Send Campaign Brief |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to campaign performance discipline |
| Form type | Brief form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Send Campaign Brief links |
| Trust before form | work and result proof |
...
| Conversion flow type | Immersive case-study hero |
