...
| Photo personality | Ports, shipment dashboards, containers, trade lanes |
| Texture/material | Logistics platform with blue enterprise polish, orange action, and shipment dashboards |
| Icon/illustration | local SVG and diagrams aligned to Logistics platform with blue enterprise polish, orange action, and shipment dashboards |
| Hero assets | Shipment dashboard hero needs a first-screen image or visual system that does not copy references |
