...
| --- | --- |
| Image style | Ports, shipment dashboards, containers, trade lanes |
| Photo style | Ports, shipment dashboards, containers, trade lanes |
| Illustration/icon style | local SVG mark and diagrams following Logistics platform with blue enterprise polish, orange action, and shipment dashboards |
| Texture/background pattern | Logistics platform with blue enterprise polish, orange action, and shipment dashboards |
| Diagram style | supports tracking and network proof and Global freight command |
...
| Border/overlay treatment | Tracking dashboard cards and Logistics platform with blue enterprise polish, orange action, and shipment dashboards |
