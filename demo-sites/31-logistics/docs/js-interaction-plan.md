...
| Signature behaviour | Tracking mockup, quote calculator, network map filter |
...
| Optional variation | shipment quote calculator, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Status map reveal must collapse cleanly under prefers-reduced-motion |
