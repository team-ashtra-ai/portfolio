...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Flexport (https://www.flexport.com/) |
| Layout archetype | Global freight command |
| Header | Logistics platform header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | network footer |
| Typography | Aptos display with Arial body and "Arial Narrow" accent labels |
| Colour/surface | #f4f8ff, #2563eb, #ff7a1a, #0f172a, #a7c7ff; Logistics platform with blue enterprise polish, orange action, and shipment dashboards |
| Hero | Shipment dashboard hero |
| Section rhythm | dense density with varied composition and Status map reveal |
| Cards | Tracking dashboard cards |
| Forms | Freight quote form |
| CTA flow | Primary-reference CTA hierarchy using Request Quote using `Request Quote` |
| Assets | Ports, shipment dashboards, containers, trade lanes |
| JS interactions | Tracking mockup, quote calculator, network map filter |
| Motion | Status map reveal |
