...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Global freight command and Shipment dashboard hero |
| Interactive components | Tracking mockup, quote calculator, network map filter, Shipment dashboard hero, Primary-reference resource rhythm filters or archive interactions, shipment quote calculator comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Logistics, Delivery & Supply Chain content |
| Form behaviours | Freight quote form with validation, status, honeypot, Formspree, and thanks route |
...
- Tracking mockup, quote calculator, network map filter
- Shipment dashboard hero
- Primary-reference resource rhythm filters or archive interactions
- shipment quote calculator comparison/toggle/calculator behaviour
