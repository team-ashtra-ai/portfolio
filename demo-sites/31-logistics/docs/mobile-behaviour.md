...
| Mobile hero | Shipment dashboard hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Tracking dashboard cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Freight quote form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Quote` appears after proof and remains reachable from contact/footer |
| Mobile footer | network footer stacks into sitemap, conversion, contact, legal, and trust areas |
