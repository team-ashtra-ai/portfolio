...
| --- | --- |
| Layout archetype | Extract industry-specific logistics, delivery & supply chain credibility; translate into Global freight command rather than copying Flexport. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Logistics platform header. |
...
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
| Typography mood | Study the mood, then express it through Aptos display with Arial body and "Arial Narrow" accent labels. |
| Colour palette | Translate reference contrast into the original palette #f4f8ff, #2563eb, #ff7a1a, #0f172a, #a7c7ff. |
| Surface system | Use surface hierarchy ideas only; final surfaces are Logistics platform with blue enterprise polish, orange action, and shipment dashboards. |
| Hero type | Use the reference to pressure-test the first screen, then build an original Shipment dashboard hero. |
| Section rhythm | Extract pacing lessons and apply varied fixed-section composition, not a copied sequence. |
| Card design | Convert card intent into Tracking dashboard cards with unique spacing, shape, and state rules. |
| Form pattern | Use friction and reassurance cues to refine the original Freight quote form. |
| CTA flow | Map intent to Primary-reference CTA hierarchy using Request Quote and primary CTA `Request Quote`. |
| Asset direction | Translate asset principles into Ports, shipment dashboards, containers, trade lanes and local ASH-TRA assets. |
| Image treatment | Use crop/contrast lessons without using the reference images, crops, or art direction directly. |
| Icon/illustration style | Extract clarity and hierarchy only; final icon language stays local to ChainPilot. |
| JS interaction ideas | Use as inspiration for Tracking mockup, quote calculator, network map filter while preserving readable static content. |
| Motion style | Reduce or reshape motion into Status map reveal with reduced-motion support. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific logistics, delivery & supply chain credibility; translate into Global freight command rather than copying DHL. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract industry-specific logistics, delivery & supply chain credibility; translate into Global freight command rather than copying Maersk. |
| Header structure | Borrow the decision logic of a direct reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for visibility and delivery control; translate into Global freight command rather than copying UPS. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
| Typography mood | Study the mood, then express it through Aptos display with Arial body and "Arial Narrow" accent labels. |
...
## 5. project44 (adjacent)

URL: https://www.project44.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract adjacent-category translation for visibility and delivery control; translate into Global freight command rather than copying project44. |
| Header structure | Borrow the decision logic of a adjacent reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
...
## 6. Databricks (contrast)

URL: https://www.databricks.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic technical design; translate into Global freight command rather than copying Databricks. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
| Typography mood | Study the mood, then express it through Aptos display with Arial body and "Arial Narrow" accent labels. |
...
| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract contrast-world inspiration to avoid generic technical design; translate into Global freight command rather than copying Bloomberg. |
| Header structure | Borrow the decision logic of a contrast reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
...
## 8. Mobbin tracking dashboard patterns (interaction)

URL: https://mobbin.com

| Extraction Field | Principle For This ASH-TRA Site |
| --- | --- |
| Layout archetype | Extract interaction reference for Tracking mockup, quote calculator, network map filter; translate into Global freight command rather than copying Mobbin tracking dashboard patterns. |
| Header structure | Borrow the decision logic of a interaction reference, then rebuild as Logistics platform header. |
| Desktop navigation style | Use clear route grouping for fixed ASH-TRA pages with density tuned to dense. |
| Mobile menu behaviour | Adapt mobile cues into Primary-reference mobile navigation with static-content fallback. |
| Footer structure | Use sitemap completeness and trust routing, rebuilt as network footer. |
| Typography mood | Study the mood, then express it through Aptos display with Arial body and "Arial Narrow" accent labels. |
