...
| Colour | #f4f8ff, #2563eb, #ff7a1a, #0f172a, #a7c7ff plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Global freight command with container-sm/md/lg/xl/fluid tokens |
| Surface | Logistics platform with blue enterprise polish, orange action, and shipment dashboards with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Tracking dashboard cards using radius, border, and shadow tokens |
| Motion | Status map reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-logistics`
- Mode class: `mode-technical`
- Layout signature: Global freight command
- Header type: Logistics platform header
- Hero type: Shipment dashboard hero
- Card style: Tracking dashboard cards
- Form style: Freight quote form
