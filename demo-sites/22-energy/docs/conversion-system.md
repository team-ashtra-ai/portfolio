...
| Field | Decision |
| --- | --- |
| Primary CTA | Calculate Savings |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Calculate Savings |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to renewable value clarity |
| Form type | Savings calculator form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Calculate Savings links |
| Trust before form | savings and assumptions proof |
...
| Conversion flow type | Centered product hero |
