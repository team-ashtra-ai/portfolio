...
| Colour | #f7f7f7, #111111, #e82127, #111111, #bfc7d5 plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Minimal energy product landing with container-sm/md/lg/xl/fluid tokens |
| Surface | Minimal product marketing with stark surfaces, centered copy, and energy-product proof with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Product output cards using radius, border, and shadow tokens |
| Motion | Clean product reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-energy`
- Mode class: `mode-technical`
- Layout signature: Minimal energy product landing
- Header type: Minimal energy header
- Hero type: Centered product hero
- Card style: Product output cards
- Form style: Savings calculator form
