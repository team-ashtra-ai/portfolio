...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Minimal energy product landing and Centered product hero |
| Interactive components | Savings estimator, battery/solar toggle, project output counters, Centered product hero, Primary-reference resource rhythm filters or archive interactions, project output calculator comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Energy, Power & Renewable Solutions content |
| Form behaviours | Savings calculator form with validation, status, honeypot, Formspree, and thanks route |
...
- Savings estimator, battery/solar toggle, project output counters
- Centered product hero
- Primary-reference resource rhythm filters or archive interactions
- project output calculator comparison/toggle/calculator behaviour
