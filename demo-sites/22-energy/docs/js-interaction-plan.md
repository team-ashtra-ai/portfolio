...
| Signature behaviour | Savings estimator, battery/solar toggle, project output counters |
...
| Optional variation | project output calculator, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Clean product reveal must collapse cleanly under prefers-reduced-motion |
