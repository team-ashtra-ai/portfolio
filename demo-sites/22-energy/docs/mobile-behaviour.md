...
| Mobile hero | Centered product hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Product output cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Savings calculator form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Calculate Savings` appears after proof and remains reachable from contact/footer |
| Mobile footer | project output footer stacks into sitemap, conversion, contact, legal, and trust areas |
