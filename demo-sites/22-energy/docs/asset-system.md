...
| --- | --- |
| Image style | Solar roofs, batteries, energy app panels |
| Photo style | Solar roofs, batteries, energy app panels |
| Illustration/icon style | local SVG mark and diagrams following Minimal product marketing with stark surfaces, centered copy, and energy-product proof |
| Texture/background pattern | Minimal product marketing with stark surfaces, centered copy, and energy-product proof |
| Diagram style | supports savings and assumptions proof and Minimal energy product landing |
...
| Border/overlay treatment | Product output cards and Minimal product marketing with stark surfaces, centered copy, and energy-product proof |
