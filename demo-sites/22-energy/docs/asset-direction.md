...
| Photo personality | Solar roofs, batteries, energy app panels |
| Texture/material | Minimal product marketing with stark surfaces, centered copy, and energy-product proof |
| Icon/illustration | local SVG and diagrams aligned to Minimal product marketing with stark surfaces, centered copy, and energy-product proof |
| Hero assets | Centered product hero needs a first-screen image or visual system that does not copy references |
