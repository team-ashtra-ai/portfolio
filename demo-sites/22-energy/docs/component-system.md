...
| --- | --- | --- | --- | --- | --- | --- | --- |
| hero component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | Solar roofs, batteries, energy app panels | hover/focus-visible/active/disabled states from css/styles.css | Savings estimator, battery/solar toggle, project output counters | single-column or horizontal scroll only when explicitly designed |
| section intro component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| service card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| feature card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| profile card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| proof card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| metric card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| pricing card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | Savings estimator, battery/solar toggle, project output counters | single-column or horizontal scroll only when explicitly designed |
| resource card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| article card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| download card | Product output cards | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| FAQ component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| form component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| CTA component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| gallery component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | Solar roofs, batteries, energy app panels | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| testimonial/review component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| process/timeline component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| comparison component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| table component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| badge/tag component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| breadcrumb component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| legal content component | Minimal energy product landing | medium | Minimal product marketing with stark surfaces, centered copy, and energy-product proof | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |

## Explicit Reuse Prevention

- No same cards everywhere: Product output cards controls card construction for this site only.
- No same FAQ everywhere: FAQ styling follows technical mode and Primary-reference plain legal notes proof tone.
- No same pricing table everywhere: pricing follows project output calculator.
- No same form everywhere: forms follow Savings calculator form with industry-specific fields.
- No same testimonial/resource block everywhere: proof follows savings and assumptions proof and resources follow Primary-reference resource rhythm.
