...
| Mobile hero | Pastel dining-room hero simplified for first-screen clarity |
| Mobile section rhythm | image-rich density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Ornate menu cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Reservation form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Reserve Table` appears after proof and remains reachable from contact/footer |
| Mobile footer | location and hours footer stacks into sitemap, conversion, contact, legal, and trust areas |
