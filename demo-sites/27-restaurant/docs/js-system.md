...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Surreal reservation stage and Pastel dining-room hero |
| Interactive components | Menu filter, allergen toggle, reservation widget, gallery, Pastel dining-room hero, Primary-reference resource rhythm filters or archive interactions, menu/package cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Restaurants, Cafes & Food Service content |
| Form behaviours | Reservation form with validation, status, honeypot, Formspree, and thanks route |
...
- Menu filter, allergen toggle, reservation widget, gallery
- Pastel dining-room hero
- Primary-reference resource rhythm filters or archive interactions
- menu/package cards comparison/toggle/calculator behaviour
