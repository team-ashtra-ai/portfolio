...
TableFlame must feel like a standalone premium website for Restaurants, Cafes & Food Service, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 10, 34, 44.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | sensory warm |
| Visual mood | Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus |
| Industry tone | warm sensory hospitality |
| Buyer psychology | desire and social confidence |
| Trust style | menu and booking proof |
| Conversion style | Primary-reference CTA hierarchy using Reserve Table |
| Content density | image-rich |
| Image personality | Dining rooms, plates, cocktails, theatrical interiors |
| Level of formality | hospitality |
| Level of emotion | high |
| Level of technical detail | moderate |
| Premium feeling | A sensory restaurant site with pastel stage surfaces, menu cards, room-gallery rhythm, and booking CTAs |
| Commercial feeling | Primary-reference CTA hierarchy using Reserve Table |
...
| Stats/quotes/eyebrows | accented through Ornate menu cards and Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #f8d7e8, #1b1b1b, #f2c94c, #7b406c, #ffffff |
| Surface style | Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Ornate menu cards with unique radius and border strength |
| Texture usage | Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus texture; no generic repeated decorative background |
...
- Premium direction: A sensory restaurant site with pastel stage surfaces, menu cards, room-gallery rhythm, and booking CTAs
- Brand mood: sensory warm
- Buyer psychology: desire and social confidence
- Layout archetype: Surreal reservation stage
- Density: image-rich
- Shape language: Ornate menu cards
- Surface/material: Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus
- Image system: Dining rooms, plates, cocktails, theatrical interiors
- Interaction model: Pastel dining-room hero
- CTA style: Primary-reference CTA hierarchy using Reserve Table
- Pricing style: menu/package cards
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 10, 34, 44.
