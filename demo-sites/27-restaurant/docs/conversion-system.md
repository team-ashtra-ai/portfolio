...
| CTA hierarchy | Primary-reference CTA hierarchy using Reserve Table |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to warm sensory hospitality |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Reserve Table links |
| Trust before form | menu and booking proof |
...
| Conversion flow type | Pastel dining-room hero |
