...
| Signature behaviour | Menu filter, allergen toggle, reservation widget, gallery |
...
| Optional variation | menu/package cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Room-scene reveal must collapse cleanly under prefers-reduced-motion |
