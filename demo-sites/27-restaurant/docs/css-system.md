...
| Colour | #f8d7e8, #1b1b1b, #f2c94c, #7b406c, #ffffff plus semantic success/warning/error/link/CTA tokens |
| Spacing | image-rich density expressed through --space-* and --space-section |
| Grid/layout | Surreal reservation stage with container-sm/md/lg/xl/fluid tokens |
| Surface | Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Ornate menu cards using radius, border, and shadow tokens |
| Motion | Room-scene reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-restaurant`
- Mode class: `mode-hospitality`
- Layout signature: Surreal reservation stage
