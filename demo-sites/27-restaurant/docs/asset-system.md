...
| --- | --- |
| Image style | Dining rooms, plates, cocktails, theatrical interiors |
| Photo style | Dining rooms, plates, cocktails, theatrical interiors |
| Illustration/icon style | local SVG mark and diagrams following Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus |
| Texture/background pattern | Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus |
| Diagram style | supports menu and booking proof and Surreal reservation stage |
...
| Border/overlay treatment | Ornate menu cards and Restaurant experience with surreal pastel rooms, dramatic menus, and reservation focus |
