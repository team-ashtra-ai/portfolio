...
| CTA hierarchy | Primary-reference CTA hierarchy using Request Service |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to public utility resilience |
| Form type | Service request form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Request Service links |
| Trust before form | service and report proof |
...
| Conversion flow type | Purple service hero |
