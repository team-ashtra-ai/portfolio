...
| Photo personality | Energy accounts, meters, tariff calculators, service notices |
| Texture/material | Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Icon/illustration | local SVG and diagrams aligned to Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Hero assets | Purple service hero needs a first-screen image or visual system that does not copy references |
