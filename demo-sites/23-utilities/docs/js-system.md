...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Playful utility account flow and Purple service hero |
| Interactive components | Service request finder, alert banner, report filter, Purple service hero, Primary-reference resource rhythm filters or archive interactions, service route cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Utilities, Water & Essential Infrastructure content |
| Form behaviours | Service request form with validation, status, honeypot, Formspree, and thanks route |
...
- Service request finder, alert banner, report filter
- Purple service hero
- Primary-reference resource rhythm filters or archive interactions
- service route cards comparison/toggle/calculator behaviour
