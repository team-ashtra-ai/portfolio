...
| Colour | #140021, #7f3cff, #ff4fd8, #f6f1ff, #00d1ff plus semantic success/warning/error/link/CTA tokens |
| Spacing | practical density expressed through --space-* and --space-section |
| Grid/layout | Playful utility account flow with container-sm/md/lg/xl/fluid tokens |
| Surface | Utilities with playful purple energy, rounded service blocks, and transparent tariff flow with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Rounded tariff cards using radius, border, and shadow tokens |
| Motion | Playful account reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-utilities`
- Mode class: `mode-civic`
- Layout signature: Playful utility account flow
