...
| --- | --- |
| Image style | Energy accounts, meters, tariff calculators, service notices |
| Photo style | Energy accounts, meters, tariff calculators, service notices |
| Illustration/icon style | local SVG mark and diagrams following Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Texture/background pattern | Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Diagram style | supports service and report proof and Playful utility account flow |
...
| Border/overlay treatment | Rounded tariff cards and Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
