...
ClearGrid must feel like a standalone premium website for Utilities, Water & Essential Infrastructure, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 06, 30, 40.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | civic essential |
| Visual mood | Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Industry tone | public utility resilience |
| Buyer psychology | public service access |
| Trust style | service and report proof |
| Conversion style | Primary-reference CTA hierarchy using Request Service |
| Content density | practical |
| Image personality | Energy accounts, meters, tariff calculators, service notices |
| Level of formality | civic |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | A utility service site with bright service cards, friendly calculator modules, alert strips, and help routing |
| Commercial feeling | Primary-reference CTA hierarchy using Request Service |
...
| Stats/quotes/eyebrows | accented through Rounded tariff cards and Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #140021, #7f3cff, #ff4fd8, #f6f1ff, #00d1ff |
| Surface style | Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Rounded tariff cards with unique radius and border strength |
| Texture usage | Utilities with playful purple energy, rounded service blocks, and transparent tariff flow texture; no generic repeated decorative background |
...
- Premium direction: A utility service site with bright service cards, friendly calculator modules, alert strips, and help routing
- Brand mood: civic essential
- Buyer psychology: public service access
- Layout archetype: Playful utility account flow
- Density: practical
- Shape language: Rounded tariff cards
- Surface/material: Utilities with playful purple energy, rounded service blocks, and transparent tariff flow
- Image system: Energy accounts, meters, tariff calculators, service notices
- Interaction model: Purple service hero
- CTA style: Primary-reference CTA hierarchy using Request Service
- Pricing style: service route cards
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 06, 30, 40.
