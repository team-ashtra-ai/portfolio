...
| Mobile hero | Purple service hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Rounded tariff cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Service request form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Service` appears after proof and remains reachable from contact/footer |
| Mobile footer | public service footer stacks into sitemap, conversion, contact, legal, and trust areas |
