...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Octopus Energy (https://octopus.energy/) |
| Layout archetype | Playful utility account flow |
| Header | Friendly utility header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | public service footer |
| Typography | "Palatino Linotype" display with Arial body and Constantia accent labels |
| Colour/surface | #140021, #7f3cff, #ff4fd8, #f6f1ff, #00d1ff; Utilities with playful purple energy, rounded service blocks, and transparent tariff flow |
| Hero | Purple service hero |
| Section rhythm | practical density with varied composition and Playful account reveal |
| Cards | Rounded tariff cards |
| Forms | Service request form |
| CTA flow | Primary-reference CTA hierarchy using Request Service using `Request Service` |
| Assets | Energy accounts, meters, tariff calculators, service notices |
| JS interactions | Service request finder, alert banner, report filter |
| Motion | Playful account reveal |
