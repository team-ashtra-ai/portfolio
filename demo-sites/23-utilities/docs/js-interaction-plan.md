...
| Signature behaviour | Service request finder, alert banner, report filter |
...
| Optional variation | service route cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Playful account reveal must collapse cleanly under prefers-reduced-motion |
