...
| Mobile hero | Editorial masthead hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Column article cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Newsletter form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Subscribe` appears after proof and remains reachable from contact/footer |
| Mobile footer | archive footer stacks into sitemap, conversion, contact, legal, and trust areas |
