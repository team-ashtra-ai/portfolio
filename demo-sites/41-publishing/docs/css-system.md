...
| Colour | #f7efd2, #111111, #f6c400, #111111, #8c1d18 plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Print magazine archive with container-sm/md/lg/xl/fluid tokens |
| Surface | Publishing with print cadence, yellow accents, compact columns, and editorial authority with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Column article cards using radius, border, and shadow tokens |
| Motion | Print-column reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-publishing`
- Mode class: `mode-editorial`
- Layout signature: Print magazine archive
- Header type: Print index header
- Hero type: Editorial masthead hero
- Card style: Column article cards
