...
| --- | --- |
| Image style | Magazine spreads, desks, books, archive covers |
| Photo style | Magazine spreads, desks, books, archive covers |
| Illustration/icon style | local SVG mark and diagrams following Publishing with print cadence, yellow accents, compact columns, and editorial authority |
| Texture/background pattern | Publishing with print cadence, yellow accents, compact columns, and editorial authority |
| Diagram style | supports sources and editorial proof and Print magazine archive |
...
| Border/overlay treatment | Column article cards and Publishing with print cadence, yellow accents, compact columns, and editorial authority |
