...
| CTA hierarchy | Primary-reference CTA hierarchy using Subscribe |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to editorial knowledge authority |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Subscribe links |
| Trust before form | sources and editorial proof |
...
| Conversion flow type | Editorial masthead hero |
