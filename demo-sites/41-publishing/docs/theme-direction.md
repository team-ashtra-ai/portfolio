...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Monocle (https://www.monocle.com/) |
| Layout archetype | Print magazine archive |
| Header | Print index header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | archive footer |
| Typography | Verdana display with "Trebuchet MS" body and Inter accent labels |
| Colour/surface | #f7efd2, #111111, #f6c400, #111111, #8c1d18; Publishing with print cadence, yellow accents, compact columns, and editorial authority |
| Hero | Editorial masthead hero |
| Section rhythm | medium density with varied composition and Print-column reveal |
| Cards | Column article cards |
| Forms | Newsletter form |
| CTA flow | Primary-reference CTA hierarchy using Subscribe using `Subscribe` |
| Assets | Magazine spreads, desks, books, archive covers |
| JS interactions | Library search, author filter, newsletter modal |
| Motion | Print-column reveal |
