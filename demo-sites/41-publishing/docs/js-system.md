...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Print magazine archive and Editorial masthead hero |
| Interactive components | Library search, author filter, newsletter modal, Editorial masthead hero, Primary-reference resource rhythm filters or archive interactions, subscription cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Publishing, Information & Knowledge Platforms content |
| Form behaviours | Newsletter form with validation, status, honeypot, Formspree, and thanks route |
...
- Library search, author filter, newsletter modal
- Editorial masthead hero
- Primary-reference resource rhythm filters or archive interactions
- subscription cards comparison/toggle/calculator behaviour
