...
| Photo personality | Magazine spreads, desks, books, archive covers |
| Texture/material | Publishing with print cadence, yellow accents, compact columns, and editorial authority |
| Icon/illustration | local SVG and diagrams aligned to Publishing with print cadence, yellow accents, compact columns, and editorial authority |
| Hero assets | Editorial masthead hero needs a first-screen image or visual system that does not copy references |
