...
| Signature behaviour | Library search, author filter, newsletter modal |
...
| Optional variation | subscription cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Print-column reveal must collapse cleanly under prefers-reduced-motion |
