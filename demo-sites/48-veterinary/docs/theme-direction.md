...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Modern Animal (https://www.modernanimal.com/) |
| Layout archetype | Modern clinic care flow |
| Header | Friendly clinic header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | care guide footer |
| Typography | "Arial Narrow" display with Georgia body and "Courier New" accent labels |
| Colour/surface | #fff7ef, #256a5e, #ffb199, #256a5e, #21413a; Veterinary care with warm clinic colours, rounded forms, and friendly triage |
| Hero | Warm appointment hero |
| Section rhythm | practical density with varied composition and Triage card reveal |
| Cards | Rounded care cards |
| Forms | Appointment form |
| CTA flow | Primary-reference CTA hierarchy using Book Visit using `Book Visit` |
| Assets | Clinic rooms, pets, care teams, appointment panels |
| JS interactions | Emergency symptom helper, appointment form, care guide filter |
| Motion | Triage card reveal |
