...
| Mobile hero | Warm appointment hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Rounded care cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Appointment form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Visit` appears after proof and remains reachable from contact/footer |
| Mobile footer | care guide footer stacks into sitemap, conversion, contact, legal, and trust areas |
