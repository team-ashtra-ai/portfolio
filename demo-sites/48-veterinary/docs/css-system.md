...
| Colour | #fff7ef, #256a5e, #ffb199, #256a5e, #21413a plus semantic success/warning/error/link/CTA tokens |
| Spacing | practical density expressed through --space-* and --space-section |
| Grid/layout | Modern clinic care flow with container-sm/md/lg/xl/fluid tokens |
| Surface | Veterinary care with warm clinic colours, rounded forms, and friendly triage with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Rounded care cards using radius, border, and shadow tokens |
| Motion | Triage card reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-veterinary`
- Mode class: `mode-care`
- Layout signature: Modern clinic care flow
