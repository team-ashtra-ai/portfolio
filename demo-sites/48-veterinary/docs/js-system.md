...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Modern clinic care flow and Warm appointment hero |
| Interactive components | Emergency symptom helper, appointment form, care guide filter, Warm appointment hero, Primary-reference resource rhythm filters or archive interactions, care plan cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Pets, Animals & Veterinary Services content |
| Form behaviours | Appointment form with validation, status, honeypot, Formspree, and thanks route |
...
- Emergency symptom helper, appointment form, care guide filter
- Warm appointment hero
- Primary-reference resource rhythm filters or archive interactions
- care plan cards comparison/toggle/calculator behaviour
