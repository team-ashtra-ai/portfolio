...
| CTA hierarchy | Primary-reference CTA hierarchy using Book Visit |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to compassionate veterinary care |
| Form type | Appointment form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Visit links |
| Trust before form | safety and care proof |
...
| Conversion flow type | Warm appointment hero |
