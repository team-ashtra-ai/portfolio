...
| Photo personality | Clinic rooms, pets, care teams, appointment panels |
| Texture/material | Veterinary care with warm clinic colours, rounded forms, and friendly triage |
| Icon/illustration | local SVG and diagrams aligned to Veterinary care with warm clinic colours, rounded forms, and friendly triage |
| Hero assets | Warm appointment hero needs a first-screen image or visual system that does not copy references |
