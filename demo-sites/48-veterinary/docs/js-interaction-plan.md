...
| Signature behaviour | Emergency symptom helper, appointment form, care guide filter |
...
| Optional variation | care plan cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Triage card reveal must collapse cleanly under prefers-reduced-motion |
