...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Clean event calendar system and Event card hero |
| Interactive components | Event type selector, venue filter, package calculator, Event card hero, Primary-reference resource rhythm filters or archive interactions, package calculator cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Events, Weddings & Experience Production content |
| Form behaviours | Date enquiry form with validation, status, honeypot, Formspree, and thanks route |
...
- Event type selector, venue filter, package calculator
- Event card hero
- Primary-reference resource rhythm filters or archive interactions
- package calculator cards comparison/toggle/calculator behaviour
