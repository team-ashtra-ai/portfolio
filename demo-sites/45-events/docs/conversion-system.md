...
| Field | Decision |
| --- | --- |
| Primary CTA | Enquire Date |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Enquire Date |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to experience-led celebration planning |
| Form type | Date enquiry form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Enquire Date links |
| Trust before form | portfolio and planning proof |
...
| Conversion flow type | Event card hero |
