...
| Signature behaviour | Event type selector, venue filter, package calculator |
...
| Optional variation | package calculator cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Calendar card reveal must collapse cleanly under prefers-reduced-motion |
