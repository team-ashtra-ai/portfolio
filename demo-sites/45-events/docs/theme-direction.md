...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Luma (https://luma.com/) |
| Layout archetype | Clean event calendar system |
| Header | Calendar utility header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | venue and supplier footer |
| Typography | "Arial Narrow" display with Arial body and "Segoe UI" accent labels |
| Colour/surface | #f7f8ff, #6c47ff, #14b8a6, #111827, #ffb703; Events with clean cards, soft gradients, calendar utility, and quick RSVP routes |
| Hero | Event card hero |
| Section rhythm | image-rich density with varied composition and Calendar card reveal |
| Cards | RSVP event cards |
| Forms | Date enquiry form |
| CTA flow | Primary-reference CTA hierarchy using Enquire Date using `Enquire Date` |
| Assets | Event cards, calendars, guest lists, venue details |
| JS interactions | Event type selector, venue filter, package calculator |
| Motion | Calendar card reveal |
