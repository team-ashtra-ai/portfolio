...
| Mobile hero | Event card hero simplified for first-screen clarity |
| Mobile section rhythm | image-rich density with deliberate stack, crop, or scroll decisions |
| Mobile cards | RSVP event cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Date enquiry form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Enquire Date` appears after proof and remains reachable from contact/footer |
| Mobile footer | venue and supplier footer stacks into sitemap, conversion, contact, legal, and trust areas |
