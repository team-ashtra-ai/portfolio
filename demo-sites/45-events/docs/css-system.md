...
| Colour | #f7f8ff, #6c47ff, #14b8a6, #111827, #ffb703 plus semantic success/warning/error/link/CTA tokens |
| Spacing | image-rich density expressed through --space-* and --space-section |
| Grid/layout | Clean event calendar system with container-sm/md/lg/xl/fluid tokens |
| Surface | Events with clean cards, soft gradients, calendar utility, and quick RSVP routes with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | RSVP event cards using radius, border, and shadow tokens |
| Motion | Calendar card reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-events`
- Mode class: `mode-hospitality`
- Layout signature: Clean event calendar system
