...
| --- | --- |
| Image style | Event cards, calendars, guest lists, venue details |
| Photo style | Event cards, calendars, guest lists, venue details |
| Illustration/icon style | local SVG mark and diagrams following Events with clean cards, soft gradients, calendar utility, and quick RSVP routes |
| Texture/background pattern | Events with clean cards, soft gradients, calendar utility, and quick RSVP routes |
| Diagram style | supports portfolio and planning proof and Clean event calendar system |
...
| Border/overlay treatment | RSVP event cards and Events with clean cards, soft gradients, calendar utility, and quick RSVP routes |
