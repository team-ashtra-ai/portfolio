...
| Photo personality | Event cards, calendars, guest lists, venue details |
| Texture/material | Events with clean cards, soft gradients, calendar utility, and quick RSVP routes |
| Icon/illustration | local SVG and diagrams aligned to Events with clean cards, soft gradients, calendar utility, and quick RSVP routes |
| Hero assets | Event card hero needs a first-screen image or visual system that does not copy references |
