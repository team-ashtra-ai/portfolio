...
| Photo personality | Job sites, schedule boards, build dashboards |
| Texture/material | Construction software with orange action, black contrast, and worksite proof |
| Icon/illustration | local SVG and diagrams aligned to Construction software with orange action, black contrast, and worksite proof |
| Hero assets | Worksite software hero needs a first-screen image or visual system that does not copy references |
