...
| Mobile hero | Worksite software hero simplified for first-screen clarity |
| Mobile section rhythm | dense density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Project control cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Estimate form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Estimate` appears after proof and remains reachable from contact/footer |
| Mobile footer | handover footer stacks into sitemap, conversion, contact, legal, and trust areas |
