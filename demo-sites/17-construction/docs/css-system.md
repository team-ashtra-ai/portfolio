...
| Colour | #fff7ed, #ff6a00, #111827, #1f2937, #ffd166 plus semantic success/warning/error/link/CTA tokens |
| Spacing | dense density expressed through --space-* and --space-section |
| Grid/layout | Construction platform grid with container-sm/md/lg/xl/fluid tokens |
| Surface | Construction software with orange action, black contrast, and worksite proof with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Project control cards using radius, border, and shadow tokens |
| Motion | Project progress reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-construction`
- Mode class: `mode-professional`
- Layout signature: Construction platform grid
