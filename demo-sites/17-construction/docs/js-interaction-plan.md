...
| Signature behaviour | Project estimator form, before/after slider, upload photos |
...
| Optional variation | stage cost panels, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Project progress reveal must collapse cleanly under prefers-reduced-motion |
