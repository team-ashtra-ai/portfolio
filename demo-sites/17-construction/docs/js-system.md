...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Construction platform grid and Worksite software hero |
| Interactive components | Project estimator form, before/after slider, upload photos, Worksite software hero, Primary-reference resource rhythm filters or archive interactions, stage cost panels comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Construction, Building & Renovation content |
| Form behaviours | Estimate form with validation, status, honeypot, Formspree, and thanks route |
...
- Project estimator form, before/after slider, upload photos
- Worksite software hero
- Primary-reference resource rhythm filters or archive interactions
- stage cost panels comparison/toggle/calculator behaviour
