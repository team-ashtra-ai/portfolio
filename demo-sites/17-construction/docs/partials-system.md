...
| --- | --- | --- | --- | --- | --- | --- |
| header | Construction product header | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| desktop navigation | Construction product header | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| mobile menu | Primary-reference mobile navigation | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| footer | handover footer | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| hero | Worksite software hero | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| CTA | Primary-reference CTA hierarchy using Request Estimate | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| form | Estimate form | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| cards | Project control cards | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| resources | Primary-reference resource rhythm | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| pricing | stage cost panels | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| FAQ | professional FAQ with section-specific proof notes | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| cookie banner | Primary-reference compact consent | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-back-to-top | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| legal layout | Primary-reference plain legal notes | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| 404 page | brand-consistent recovery page with sitemap and home routes | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Request Estimate follow-up | dense spacing with Project control cards | classes use theme-construction modifiers plus component-specific classes | data-track/data-component | assets follow Job sites, schedule boards, build dashboards | must not resemble partials in sites 24, 34, 50 |
...
| Logo position | matched to Construction product header |
| Nav layout | Construction product header with desktop density chosen for dense |
| CTA position | Request Estimate positioned as the primary route without crowding utility links |
...
- CTA placement: Request Estimate remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Construction software with orange action, black contrast, and worksite proof

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | handover footer |
| Footer density | dense |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Request Estimate |
| Trust/disclaimer area | process and safety proof |
