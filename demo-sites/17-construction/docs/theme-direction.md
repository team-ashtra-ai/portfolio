...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Procore (https://www.procore.com/) |
| Layout archetype | Construction platform grid |
| Header | Construction product header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | handover footer |
| Typography | "Trebuchet MS" display with "Segoe UI" body and Aptos accent labels |
| Colour/surface | #fff7ed, #ff6a00, #111827, #1f2937, #ffd166; Construction software with orange action, black contrast, and worksite proof |
| Hero | Worksite software hero |
| Section rhythm | dense density with varied composition and Project progress reveal |
| Cards | Project control cards |
| Forms | Estimate form |
| CTA flow | Primary-reference CTA hierarchy using Request Estimate using `Request Estimate` |
| Assets | Job sites, schedule boards, build dashboards |
| JS interactions | Project estimator form, before/after slider, upload photos |
| Motion | Project progress reveal |
