...
| --- | --- |
| Image style | Job sites, schedule boards, build dashboards |
| Photo style | Job sites, schedule boards, build dashboards |
| Illustration/icon style | local SVG mark and diagrams following Construction software with orange action, black contrast, and worksite proof |
| Texture/background pattern | Construction software with orange action, black contrast, and worksite proof |
| Diagram style | supports process and safety proof and Construction platform grid |
...
| Border/overlay treatment | Project control cards and Construction software with orange action, black contrast, and worksite proof |
