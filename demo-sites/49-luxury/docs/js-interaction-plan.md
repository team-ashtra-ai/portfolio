...
| Signature behaviour | Private enquiry reveal, membership request, concierge stepper |
...
| Optional variation | concierge invitation cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Slow heritage reveal must collapse cleanly under prefers-reduced-motion |
