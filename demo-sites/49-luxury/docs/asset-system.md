...
| --- | --- |
| Image style | Craft details, watches, private rooms, heritage materials |
| Photo style | Craft details, watches, private rooms, heritage materials |
| Illustration/icon style | local SVG mark and diagrams following Luxury with deep green, gold restraint, heritage pacing, and private product focus |
| Texture/background pattern | Luxury with deep green, gold restraint, heritage pacing, and private product focus |
| Diagram style | supports discretion and craft proof and Heritage luxury maison |
...
| Border/overlay treatment | Gold hairline cards and Luxury with deep green, gold restraint, heritage pacing, and private product focus |
