...
| Mobile hero | Deep-green private hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Gold hairline cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Private access form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Private Access` appears after proof and remains reachable from contact/footer |
| Mobile footer | private concierge footer stacks into sitemap, conversion, contact, legal, and trust areas |
