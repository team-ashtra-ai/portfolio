...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Heritage luxury maison` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Heritage luxury maison with full container range |
...
| Mobile hero style | Deep-green private hero simplified without losing proof or CTA |
| Mobile card stacking | Gold hairline cards stacks or scrolls only when intentional |
| Mobile form behaviour | Private access form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Request Private Access appears after proof and in contact routes |
| Mobile footer structure | private concierge footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Craft details, watches, private rooms, heritage materials |
