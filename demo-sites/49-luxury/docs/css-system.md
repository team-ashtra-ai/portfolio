...
| Colour | #081f18, #0b5f3a, #d4af37, #f4efe2, #111111 plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Heritage luxury maison with container-sm/md/lg/xl/fluid tokens |
| Surface | Luxury with deep green, gold restraint, heritage pacing, and private product focus with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Gold hairline cards using radius, border, and shadow tokens |
| Motion | Slow heritage reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-luxury`
- Mode class: `mode-luxury`
- Layout signature: Heritage luxury maison
