...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Heritage luxury maison and Deep-green private hero |
| Interactive components | Private enquiry reveal, membership request, concierge stepper, Deep-green private hero, Primary-reference resource rhythm filters or archive interactions, concierge invitation cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Luxury, Premium & High-End Services content |
| Form behaviours | Private access form with validation, status, honeypot, Formspree, and thanks route |
...
- Private enquiry reveal, membership request, concierge stepper
- Deep-green private hero
- Primary-reference resource rhythm filters or archive interactions
- concierge invitation cards comparison/toggle/calculator behaviour
