...
| Photo personality | Craft details, watches, private rooms, heritage materials |
| Texture/material | Luxury with deep green, gold restraint, heritage pacing, and private product focus |
| Icon/illustration | local SVG and diagrams aligned to Luxury with deep green, gold restraint, heritage pacing, and private product focus |
| Hero assets | Deep-green private hero needs a first-screen image or visual system that does not copy references |
