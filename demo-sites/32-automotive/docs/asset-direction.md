...
| Photo personality | EV silhouettes, interiors, chargers, specification panels |
| Texture/material | Automotive minimalism with cool greys, product focus, and restrained configurator energy |
| Icon/illustration | local SVG and diagrams aligned to Automotive minimalism with cool greys, product focus, and restrained configurator energy |
| Hero assets | Stark vehicle product hero needs a first-screen image or visual system that does not copy references |
