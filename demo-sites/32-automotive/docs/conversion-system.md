...
| CTA hierarchy | Primary-reference CTA hierarchy using Book Test Drive |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to vehicle purchase confidence |
| Form type | Test-drive form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Test Drive links |
| Trust before form | inventory and service proof |
...
| Conversion flow type | Stark vehicle product hero |
