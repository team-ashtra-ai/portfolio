...
| Mobile hero | Stark vehicle product hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Precise vehicle cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Test-drive form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Test Drive` appears after proof and remains reachable from contact/footer |
| Mobile footer | service bay footer stacks into sitemap, conversion, contact, legal, and trust areas |
