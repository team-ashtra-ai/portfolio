...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Minimal EV showroom and Stark vehicle product hero |
| Interactive components | Inventory filter, finance calculator, test-drive form, Stark vehicle product hero, Primary-reference resource rhythm filters or archive interactions, finance calculator cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Automotive, Vehicles & Mobility Products content |
| Form behaviours | Test-drive form with validation, status, honeypot, Formspree, and thanks route |
...
- Inventory filter, finance calculator, test-drive form
- Stark vehicle product hero
- Primary-reference resource rhythm filters or archive interactions
- finance calculator cards comparison/toggle/calculator behaviour
