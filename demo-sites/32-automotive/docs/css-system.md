...
| Colour | #f8f8f8, #111111, #d8dadd, #111111, #8a8f98 plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Minimal EV showroom with container-sm/md/lg/xl/fluid tokens |
| Surface | Automotive minimalism with cool greys, product focus, and restrained configurator energy with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Precise vehicle cards using radius, border, and shadow tokens |
| Motion | Clean configurator reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-automotive`
- Mode class: `mode-dark`
- Layout signature: Minimal EV showroom
