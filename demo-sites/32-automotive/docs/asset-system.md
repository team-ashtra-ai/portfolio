...
| --- | --- |
| Image style | EV silhouettes, interiors, chargers, specification panels |
| Photo style | EV silhouettes, interiors, chargers, specification panels |
| Illustration/icon style | local SVG mark and diagrams following Automotive minimalism with cool greys, product focus, and restrained configurator energy |
| Texture/background pattern | Automotive minimalism with cool greys, product focus, and restrained configurator energy |
| Diagram style | supports inventory and service proof and Minimal EV showroom |
...
| Border/overlay treatment | Precise vehicle cards and Automotive minimalism with cool greys, product focus, and restrained configurator energy |
