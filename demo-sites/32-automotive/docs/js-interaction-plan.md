...
| Signature behaviour | Inventory filter, finance calculator, test-drive form |
...
| Optional variation | finance calculator cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Clean configurator reveal must collapse cleanly under prefers-reduced-motion |
