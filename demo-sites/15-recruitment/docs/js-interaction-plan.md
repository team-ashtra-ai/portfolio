...
| Signature behaviour | Employer/candidate toggle, role filter, upload CV flow |
...
| Optional variation | placement fee cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Editorial card shuffle must collapse cleanly under prefers-reduced-motion |
