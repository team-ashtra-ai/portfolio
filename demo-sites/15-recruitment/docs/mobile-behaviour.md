...
| Mobile hero | Yellow job magazine hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Job story cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Candidate upload form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Start Hiring` appears after proof and remains reachable from contact/footer |
| Mobile footer | candidate support footer stacks into sitemap, conversion, contact, legal, and trust areas |
