...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Editorial talent marketplace` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Editorial talent marketplace with full container range |
...
| Mobile hero style | Yellow job magazine hero simplified without losing proof or CTA |
| Mobile card stacking | Job story cards stacks or scrolls only when intentional |
| Mobile form behaviour | Candidate upload form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Start Hiring appears after proof and in contact routes |
| Mobile footer structure | candidate support footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Workplace portraits, job cards, culture pages |
