...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Editorial talent marketplace and Yellow job magazine hero |
| Interactive components | Employer/candidate toggle, role filter, upload CV flow, Yellow job magazine hero, Primary-reference resource rhythm filters or archive interactions, placement fee cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Recruitment, HR & Workplace Services content |
| Form behaviours | Candidate upload form with validation, status, honeypot, Formspree, and thanks route |
...
- Employer/candidate toggle, role filter, upload CV flow
- Yellow job magazine hero
- Primary-reference resource rhythm filters or archive interactions
- placement fee cards comparison/toggle/calculator behaviour
