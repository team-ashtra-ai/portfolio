...
| --- | --- |
| Image style | Workplace portraits, job cards, culture pages |
| Photo style | Workplace portraits, job cards, culture pages |
| Illustration/icon style | local SVG mark and diagrams following Hiring editorial with yellow blocks, human stories, and job-board modules |
| Texture/background pattern | Hiring editorial with yellow blocks, human stories, and job-board modules |
| Diagram style | supports placement and retention proof and Editorial talent marketplace |
...
| Border/overlay treatment | Job story cards and Hiring editorial with yellow blocks, human stories, and job-board modules |
