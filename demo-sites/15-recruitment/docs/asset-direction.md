...
| Photo personality | Workplace portraits, job cards, culture pages |
| Texture/material | Hiring editorial with yellow blocks, human stories, and job-board modules |
| Icon/illustration | local SVG and diagrams aligned to Hiring editorial with yellow blocks, human stories, and job-board modules |
| Hero assets | Yellow job magazine hero needs a first-screen image or visual system that does not copy references |
