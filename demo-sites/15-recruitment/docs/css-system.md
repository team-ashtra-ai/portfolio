...
| Colour | #ffe45e, #111111, #ff6a3d, #111111, #1f6feb plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Editorial talent marketplace with container-sm/md/lg/xl/fluid tokens |
| Surface | Hiring editorial with yellow blocks, human stories, and job-board modules with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Job story cards using radius, border, and shadow tokens |
| Motion | Editorial card shuffle with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-recruitment`
- Mode class: `mode-professional`
- Layout signature: Editorial talent marketplace
