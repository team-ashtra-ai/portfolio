...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Welcome to the Jungle (https://www.welcometothejungle.com/) |
| Layout archetype | Editorial talent marketplace |
| Header | Magazine hiring header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | candidate support footer |
| Typography | "Trebuchet MS" display with Inter body and Aptos accent labels |
| Colour/surface | #ffe45e, #111111, #ff6a3d, #111111, #1f6feb; Hiring editorial with yellow blocks, human stories, and job-board modules |
| Hero | Yellow job magazine hero |
| Section rhythm | medium density with varied composition and Editorial card shuffle |
| Cards | Job story cards |
| Forms | Candidate upload form |
| CTA flow | Primary-reference CTA hierarchy using Start Hiring using `Start Hiring` |
| Assets | Workplace portraits, job cards, culture pages |
| JS interactions | Employer/candidate toggle, role filter, upload CV flow |
| Motion | Editorial card shuffle |
