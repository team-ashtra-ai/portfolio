...
| Signature behaviour | Timetable filter, membership toggle, coach selector |
...
| Optional variation | membership cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Kinetic reveal must collapse cleanly under prefers-reduced-motion |
