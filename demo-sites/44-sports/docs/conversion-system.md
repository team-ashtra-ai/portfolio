...
| CTA hierarchy | Primary-reference CTA hierarchy using Join Class |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to motivating movement clarity |
| Form type | Trial class form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Join Class links |
| Trust before form | progress and class proof |
...
| Conversion flow type | Big sport campaign hero |
