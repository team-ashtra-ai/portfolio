...
| Colour | #ffffff, #111111, #ff3d00, #111111, #c8c8c8 plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Athletic product-program system with container-sm/md/lg/xl/fluid tokens |
| Surface | Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Performance program cards using radius, border, and shadow tokens |
| Motion | Kinetic reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-sports`
- Mode class: `mode-professional`
- Layout signature: Athletic product-program system
