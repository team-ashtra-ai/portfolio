...
| Mobile hero | Big sport campaign hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Performance program cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Trial class form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Join Class` appears after proof and remains reachable from contact/footer |
| Mobile footer | community footer stacks into sitemap, conversion, contact, legal, and trust areas |
