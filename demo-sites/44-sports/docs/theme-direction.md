...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Nike (https://www.nike.com/) |
| Layout archetype | Athletic product-program system |
| Header | Sport retail header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | community footer |
| Typography | "Arial Narrow" display with Inter body and "Palatino Linotype" accent labels |
| Colour/surface | #ffffff, #111111, #ff3d00, #111111, #c8c8c8; Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Hero | Big sport campaign hero |
| Section rhythm | spacious density with varied composition and Kinetic reveal |
| Cards | Performance program cards |
| Forms | Trial class form |
| CTA flow | Primary-reference CTA hierarchy using Join Class using `Join Class` |
| Assets | Athletes, training spaces, shoes, performance metrics |
| JS interactions | Timetable filter, membership toggle, coach selector |
