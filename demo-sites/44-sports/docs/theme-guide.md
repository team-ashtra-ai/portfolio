...
PulseClub must feel like a standalone premium website for Sports, Fitness & Recreation, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 01, 11, 27.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | active community |
| Visual mood | Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Industry tone | motivating movement clarity |
| Buyer psychology | progress and belonging |
| Trust style | progress and class proof |
| Conversion style | Primary-reference CTA hierarchy using Join Class |
| Content density | spacious |
| Image personality | Athletes, training spaces, shoes, performance metrics |
| Level of formality | formal |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | A fitness site with athlete-scale hero, program cards, coach proof, schedule filters, and membership CTAs |
| Commercial feeling | Primary-reference CTA hierarchy using Join Class |
...
| Stats/quotes/eyebrows | accented through Performance program cards and Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #ffffff, #111111, #ff3d00, #111111, #c8c8c8 |
| Surface style | Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Performance program cards with unique radius and border strength |
| Texture usage | Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs texture; no generic repeated decorative background |
...
- Premium direction: A fitness site with athlete-scale hero, program cards, coach proof, schedule filters, and membership CTAs
- Brand mood: active community
- Buyer psychology: progress and belonging
- Layout archetype: Athletic product-program system
- Density: spacious
- Shape language: Performance program cards
- Surface/material: Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs
- Image system: Athletes, training spaces, shoes, performance metrics
- Interaction model: Big sport campaign hero
- CTA style: Primary-reference CTA hierarchy using Join Class
- Pricing style: membership cards
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 01, 11, 27.
