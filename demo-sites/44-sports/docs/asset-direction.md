...
| Photo personality | Athletes, training spaces, shoes, performance metrics |
| Texture/material | Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Icon/illustration | local SVG and diagrams aligned to Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Hero assets | Big sport campaign hero needs a first-screen image or visual system that does not copy references |
