...
| --- | --- |
| Image style | Athletes, training spaces, shoes, performance metrics |
| Photo style | Athletes, training spaces, shoes, performance metrics |
| Illustration/icon style | local SVG mark and diagrams following Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Texture/background pattern | Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
| Diagram style | supports progress and class proof and Athletic product-program system |
...
| Border/overlay treatment | Performance program cards and Sport retail with bold hero imagery, black-white contrast, and direct product/program CTAs |
