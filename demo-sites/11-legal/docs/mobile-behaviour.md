...
| Mobile hero | Blue legal software hero simplified for first-screen clarity |
| Mobile section rhythm | measured density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Workflow document cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Consultation intake form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Consultation` appears after proof and remains reachable from contact/footer |
| Mobile footer | jurisdiction footer stacks into sitemap, conversion, contact, legal, and trust areas |
