...
| Photo personality | Legal dashboards, document checklists, calm office detail |
| Texture/material | Legal SaaS with calm blue authority, soft cream pages, and product proof |
| Icon/illustration | local SVG and diagrams aligned to Legal SaaS with calm blue authority, soft cream pages, and product proof |
| Hero assets | Blue legal software hero needs a first-screen image or visual system that does not copy references |
