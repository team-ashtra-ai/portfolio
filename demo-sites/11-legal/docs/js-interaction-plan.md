...
| Signature behaviour | Case type selector, document checklist, consultation route form |
...
| Optional variation | fixed/hourly fee cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Workflow tab reveal must collapse cleanly under prefers-reduced-motion |
