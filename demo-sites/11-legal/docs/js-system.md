...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Legal platform workflow and Blue legal software hero |
| Interactive components | Case type selector, document checklist, consultation route form, Blue legal software hero, Primary-reference resource rhythm filters or archive interactions, fixed/hourly fee cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Legal, Compliance & Immigration Services content |
| Form behaviours | Consultation intake form with validation, status, honeypot, Formspree, and thanks route |
...
- Case type selector, document checklist, consultation route form
- Blue legal software hero
- Primary-reference resource rhythm filters or archive interactions
- fixed/hourly fee cards comparison/toggle/calculator behaviour
