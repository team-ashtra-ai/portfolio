...
| CTA wording | industry-specific and matched to formal legal clarity |
| Form type | Consultation intake form |
...
| Trust before form | jurisdiction and document proof |
...
| Conversion flow type | Blue legal software hero |
