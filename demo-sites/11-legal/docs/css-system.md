...
| Colour | #f7f2e8, #183b72, #5ba8ff, #111827, #f4c95d plus semantic success/warning/error/link/CTA tokens |
| Spacing | measured density expressed through --space-* and --space-section |
| Grid/layout | Legal platform workflow with container-sm/md/lg/xl/fluid tokens |
| Surface | Legal SaaS with calm blue authority, soft cream pages, and product proof with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Workflow document cards using radius, border, and shadow tokens |
| Motion | Workflow tab reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-legal`
- Mode class: `mode-professional`
- Layout signature: Legal platform workflow
- Header type: Practice product header
- Hero type: Blue legal software hero
- Card style: Workflow document cards
- Form style: Consultation intake form
