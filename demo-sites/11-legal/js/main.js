(() => {
  const signature = {"site": "legal", "interaction": "Case type selector, document checklist, consultation route form", "mode": "professional"};
