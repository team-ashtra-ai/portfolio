...
| Signature behaviour | Deadline calendar, document checklist, package comparison |
...
| Optional variation | filing package grid, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Calendar and ledger reveal must collapse cleanly under prefers-reduced-motion |
