...
| --- | --- |
| Image style | Bookkeeping dashboards, invoices, payroll cards |
| Photo style | Bookkeeping dashboards, invoices, payroll cards |
| Illustration/icon style | local SVG mark and diagrams following Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
| Texture/background pattern | Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
| Diagram style | supports deadline and compliance proof and Cloud accounting dashboard |
...
| Border/overlay treatment | Ledger dashboard cards and Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
