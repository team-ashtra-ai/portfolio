...
LedgerFlow must feel like a standalone premium website for Accounting, Tax & Financial Administration, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 19, 29, 45.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | deadline-led |
| Visual mood | Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
| Industry tone | deadline-aware administrative order |
| Buyer psychology | order and compliance |
| Trust style | deadline and compliance proof |
| Conversion style | Primary-reference CTA hierarchy using Request Quote |
| Content density | compact |
| Image personality | Bookkeeping dashboards, invoices, payroll cards |
| Level of formality | formal |
| Level of emotion | controlled |
| Level of technical detail | moderate |
| Premium feeling | An accounting command site with cloud-blue dashboards, deadline cards, plan comparison, and admin reassurance |
...
| Stats/quotes/eyebrows | accented through Ledger dashboard cards and Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #eaf7ff, #13b5ea, #045c8c, #102a43, #8de1ff |
| Surface style | Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Ledger dashboard cards with unique radius and border strength |
| Texture usage | Accounting clarity with sky blue, rounded dashboards, and friendly admin paths texture; no generic repeated decorative background |
...
- Premium direction: An accounting command site with cloud-blue dashboards, deadline cards, plan comparison, and admin reassurance
- Brand mood: deadline-led
- Buyer psychology: order and compliance
- Layout archetype: Cloud accounting dashboard
- Density: compact
- Shape language: Ledger dashboard cards
- Surface/material: Accounting clarity with sky blue, rounded dashboards, and friendly admin paths
- Image system: Bookkeeping dashboards, invoices, payroll cards
- Interaction model: Rounded ledger dashboard hero
- CTA style: Primary-reference CTA hierarchy using Request Quote
- Pricing style: filing package grid
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 19, 29, 45.
