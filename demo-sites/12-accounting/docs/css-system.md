...
| Colour | #eaf7ff, #13b5ea, #045c8c, #102a43, #8de1ff plus semantic success/warning/error/link/CTA tokens |
| Spacing | compact density expressed through --space-* and --space-section |
| Grid/layout | Cloud accounting dashboard with container-sm/md/lg/xl/fluid tokens |
| Surface | Accounting clarity with sky blue, rounded dashboards, and friendly admin paths with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Ledger dashboard cards using radius, border, and shadow tokens |
| Motion | Calendar and ledger reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-accounting`
- Mode class: `mode-professional`
- Layout signature: Cloud accounting dashboard
