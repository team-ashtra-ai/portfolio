...
| Photo personality | Bookkeeping dashboards, invoices, payroll cards |
| Texture/material | Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
| Icon/illustration | local SVG and diagrams aligned to Accounting clarity with sky blue, rounded dashboards, and friendly admin paths |
| Hero assets | Rounded ledger dashboard hero needs a first-screen image or visual system that does not copy references |
