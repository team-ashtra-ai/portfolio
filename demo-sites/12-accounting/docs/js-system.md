...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Cloud accounting dashboard and Rounded ledger dashboard hero |
| Interactive components | Deadline calendar, document checklist, package comparison, Rounded ledger dashboard hero, Primary-reference resource rhythm filters or archive interactions, filing package grid comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Accounting, Tax & Financial Administration content |
| Form behaviours | Filing quote form with validation, status, honeypot, Formspree, and thanks route |
...
- Deadline calendar, document checklist, package comparison
- Rounded ledger dashboard hero
- Primary-reference resource rhythm filters or archive interactions
- filing package grid comparison/toggle/calculator behaviour
