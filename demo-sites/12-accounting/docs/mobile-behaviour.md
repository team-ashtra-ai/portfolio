...
| Mobile hero | Rounded ledger dashboard hero simplified for first-screen clarity |
| Mobile section rhythm | compact density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Ledger dashboard cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Filing quote form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Request Quote` appears after proof and remains reachable from contact/footer |
| Mobile footer | filing support footer stacks into sitemap, conversion, contact, legal, and trust areas |
