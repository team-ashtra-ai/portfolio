...
| Photo personality | Architecture photography, plans, models, site context |
| Texture/material | Architecture portfolio with radical restraint, huge imagery, and project-index logic |
| Icon/illustration | local SVG and diagrams aligned to Architecture portfolio with radical restraint, huge imagery, and project-index logic |
| Hero assets | Minimal full-bleed project hero needs a first-screen image or visual system that does not copy references |
