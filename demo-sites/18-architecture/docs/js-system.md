...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Spatial project index and Minimal full-bleed project hero |
| Interactive components | Project gallery, planning stage stepper, image reveal, Minimal full-bleed project hero, Primary-reference resource rhythm filters or archive interactions, stage fee cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Architecture, Planning & Built Environment content |
| Form behaviours | Project brief form with validation, status, honeypot, Formspree, and thanks route |
...
- Project gallery, planning stage stepper, image reveal
- Minimal full-bleed project hero
- Primary-reference resource rhythm filters or archive interactions
- stage fee cards comparison/toggle/calculator behaviour
