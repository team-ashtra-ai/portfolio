...
AtelierGrid must feel like a standalone premium website for Architecture, Planning & Built Environment, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 01, 25, 35.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | spatial editorial |
| Visual mood | Architecture portfolio with radical restraint, huge imagery, and project-index logic |
| Industry tone | spatial design intelligence |
| Buyer psychology | taste and design authority |
| Trust style | portfolio and planning proof |
| Conversion style | Primary-reference CTA hierarchy using Discuss Project |
| Content density | spacious |
| Image personality | Architecture photography, plans, models, site context |
| Level of formality | editorial |
| Level of emotion | high |
| Level of technical detail | moderate |
| Premium feeling | A spatial portfolio site with minimal chrome, full-bleed project moments, thin metadata, and studio enquiry |
| Commercial feeling | Primary-reference CTA hierarchy using Discuss Project |
...
| Stats/quotes/eyebrows | accented through Architectural index cards and Architecture portfolio with radical restraint, huge imagery, and project-index logic |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #f4f1eb, #111111, #c4c7c5, #111111, #7a807b |
| Surface style | Architecture portfolio with radical restraint, huge imagery, and project-index logic |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Architectural index cards with unique radius and border strength |
| Texture usage | Architecture portfolio with radical restraint, huge imagery, and project-index logic texture; no generic repeated decorative background |
...
- Premium direction: A spatial portfolio site with minimal chrome, full-bleed project moments, thin metadata, and studio enquiry
- Brand mood: spatial editorial
- Buyer psychology: taste and design authority
- Layout archetype: Spatial project index
- Density: spacious
- Shape language: Architectural index cards
- Surface/material: Architecture portfolio with radical restraint, huge imagery, and project-index logic
- Image system: Architecture photography, plans, models, site context
- Interaction model: Minimal full-bleed project hero
- CTA style: Primary-reference CTA hierarchy using Discuss Project
- Pricing style: stage fee cards
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 01, 25, 35.
