...
| Field | Decision |
| --- | --- |
| Primary CTA | Discuss Project |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Discuss Project |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to spatial design intelligence |
| Form type | Project brief form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Discuss Project links |
...
| Conversion flow type | Minimal full-bleed project hero |
