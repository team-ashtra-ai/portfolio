...
| Colour | #f4f1eb, #111111, #c4c7c5, #111111, #7a807b plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Spatial project index with container-sm/md/lg/xl/fluid tokens |
| Surface | Architecture portfolio with radical restraint, huge imagery, and project-index logic with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Architectural index cards using radius, border, and shadow tokens |
| Motion | Slow spatial reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-architecture`
- Mode class: `mode-editorial`
- Layout signature: Spatial project index
