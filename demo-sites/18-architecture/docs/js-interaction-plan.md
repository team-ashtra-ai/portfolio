...
| Signature behaviour | Project gallery, planning stage stepper, image reveal |
...
| Optional variation | stage fee cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Slow spatial reveal must collapse cleanly under prefers-reduced-motion |
