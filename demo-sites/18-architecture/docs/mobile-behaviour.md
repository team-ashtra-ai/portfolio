...
| Mobile hero | Minimal full-bleed project hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Architectural index cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Project brief form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Discuss Project` appears after proof and remains reachable from contact/footer |
| Mobile footer | project index footer stacks into sitemap, conversion, contact, legal, and trust areas |
