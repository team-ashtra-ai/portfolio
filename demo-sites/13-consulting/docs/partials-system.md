...
| --- | --- | --- | --- | --- | --- | --- |
| header | Studio index header | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| desktop navigation | Studio index header | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| mobile menu | Primary-reference mobile navigation | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| footer | insight archive footer | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| hero | Idea-led editorial hero | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| CTA | Primary-reference CTA hierarchy using Send Brief | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| form | Brief workshop form | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| cards | Case thinking cards | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| resources | Primary-reference resource rhythm | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| pricing | workshop/project/retainer cards | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| FAQ | professional FAQ with section-specific proof notes | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| cookie banner | Primary-reference compact consent | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-back-to-top | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| legal layout | Primary-reference plain legal notes | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| 404 page | brand-consistent recovery page with sitemap and home routes | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Send Brief follow-up | medium spacing with Case thinking cards | classes use theme-consulting modifiers plus component-specific classes | data-track/data-component | assets follow Workshops, prototypes, research walls, creative teams | must not resemble partials in sites 20, 30, 46 |
...
| Logo position | matched to Studio index header |
| Nav layout | Studio index header with desktop density chosen for medium |
| CTA position | Send Brief positioned as the primary route without crowding utility links |
...
- CTA placement: Send Brief remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | insight archive footer |
| Footer density | medium |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Send Brief |
| Trust/disclaimer area | diagnostic and roadmap proof |
