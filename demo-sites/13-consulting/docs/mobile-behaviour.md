...
| Mobile hero | Idea-led editorial hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Case thinking cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Brief workshop form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Send Brief` appears after proof and remains reachable from contact/footer |
| Mobile footer | insight archive footer stacks into sitemap, conversion, contact, legal, and trust areas |
