...
| --- | --- |
| Image style | Workshops, prototypes, research walls, creative teams |
| Photo style | Workshops, prototypes, research walls, creative teams |
| Illustration/icon style | local SVG mark and diagrams following Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm |
| Texture/background pattern | Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm |
| Diagram style | supports diagnostic and roadmap proof and Editorial innovation studio |
...
| Border/overlay treatment | Case thinking cards and Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm |
