...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Editorial innovation studio and Idea-led editorial hero |
| Interactive components | Diagnostic quiz, framework tabs, case filter, Idea-led editorial hero, Primary-reference resource rhythm filters or archive interactions, workshop/project/retainer cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Consulting, Strategy & Business Advisory content |
| Form behaviours | Brief workshop form with validation, status, honeypot, Formspree, and thanks route |
...
- Diagnostic quiz, framework tabs, case filter
- Idea-led editorial hero
- Primary-reference resource rhythm filters or archive interactions
- workshop/project/retainer cards comparison/toggle/calculator behaviour
