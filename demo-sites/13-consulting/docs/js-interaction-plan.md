...
| Signature behaviour | Diagnostic quiz, framework tabs, case filter |
...
| Optional variation | workshop/project/retainer cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Project tile reveal must collapse cleanly under prefers-reduced-motion |
