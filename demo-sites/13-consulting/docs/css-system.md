...
| Colour | #ffffff, #111111, #ff5a1f, #111111, #0066ff plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Editorial innovation studio with container-sm/md/lg/xl/fluid tokens |
| Surface | Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Case thinking cards using radius, border, and shadow tokens |
| Motion | Project tile reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-consulting`
- Mode class: `mode-professional`
- Layout signature: Editorial innovation studio
