...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Editorial innovation studio` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Editorial innovation studio with full container range |
...
| Mobile hero style | Idea-led editorial hero simplified without losing proof or CTA |
| Mobile card stacking | Case thinking cards stacks or scrolls only when intentional |
| Mobile form behaviour | Brief workshop form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Send Brief appears after proof and in contact routes |
| Mobile footer structure | insight archive footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Workshops, prototypes, research walls, creative teams |
