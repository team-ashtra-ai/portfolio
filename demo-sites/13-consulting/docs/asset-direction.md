...
| Photo personality | Workshops, prototypes, research walls, creative teams |
| Texture/material | Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm |
| Icon/illustration | local SVG and diagrams aligned to Creative consulting with editorial whitespace, bold project thinking, and case-study rhythm |
| Hero assets | Idea-led editorial hero needs a first-screen image or visual system that does not copy references |
