...
| Field | Decision |
| --- | --- |
| Primary CTA | Send Brief |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Send Brief |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to strategic boardroom focus |
| Form type | Brief workshop form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Send Brief links |
| Trust before form | diagnostic and roadmap proof |
...
| Conversion flow type | Idea-led editorial hero |
