...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Minimal property journal and Architectural listing hero |
| Interactive components | Property filter, gallery modal, map-style area cards, Architectural listing hero, Primary-reference resource rhythm filters or archive interactions, commission and management cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Real Estate, Property & Land Services content |
| Form behaviours | Valuation enquiry form with validation, status, honeypot, Formspree, and thanks route |
...
- Property filter, gallery modal, map-style area cards
- Architectural listing hero
- Primary-reference resource rhythm filters or archive interactions
- commission and management cards comparison/toggle/calculator behaviour
