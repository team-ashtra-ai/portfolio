...
| --- | --- |
| Image style | Modern homes, interiors, floor plans, neighbourhood details |
| Photo style | Modern homes, interiors, floor plans, neighbourhood details |
| Illustration/icon style | local SVG mark and diagrams following Property editorial with quiet type, generous imagery, and thin-rule listings |
| Texture/background pattern | Property editorial with quiet type, generous imagery, and thin-rule listings |
| Diagram style | supports market and area proof and Minimal property journal |
...
| Border/overlay treatment | Thin-rule listing cards and Property editorial with quiet type, generous imagery, and thin-rule listings |
