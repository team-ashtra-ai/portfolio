...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | The Modern House (https://www.themodernhouse.com/) |
| Layout archetype | Minimal property journal |
| Header | Quiet property header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | area guide footer |
| Typography | "Trebuchet MS" display with Arial body and Aptos accent labels |
| Colour/surface | #fbfaf7, #111111, #8a8f83, #111111, #c7b299; Property editorial with quiet type, generous imagery, and thin-rule listings |
| Hero | Architectural listing hero |
| Section rhythm | spacious density with varied composition and Slow image reveal |
| Cards | Thin-rule listing cards |
| Forms | Valuation enquiry form |
| CTA flow | Primary-reference CTA hierarchy using Get Valuation using `Get Valuation` |
| Assets | Modern homes, interiors, floor plans, neighbourhood details |
| JS interactions | Property filter, gallery modal, map-style area cards |
| Motion | Slow image reveal |
