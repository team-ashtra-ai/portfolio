...
| Colour | #fbfaf7, #111111, #8a8f83, #111111, #c7b299 plus semantic success/warning/error/link/CTA tokens |
| Spacing | spacious density expressed through --space-* and --space-section |
| Grid/layout | Minimal property journal with container-sm/md/lg/xl/fluid tokens |
| Surface | Property editorial with quiet type, generous imagery, and thin-rule listings with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Thin-rule listing cards using radius, border, and shadow tokens |
| Motion | Slow image reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-real-estate`
- Mode class: `mode-professional`
- Layout signature: Minimal property journal
