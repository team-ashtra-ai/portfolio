...
| Field | Decision |
| --- | --- |
| Primary CTA | Get Valuation |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Get Valuation |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to local market confidence |
| Form type | Valuation enquiry form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Get Valuation links |
| Trust before form | market and area proof |
...
| Conversion flow type | Architectural listing hero |
