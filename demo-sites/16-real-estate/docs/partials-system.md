...
| --- | --- | --- | --- | --- | --- | --- |
| header | Quiet property header | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| desktop navigation | Quiet property header | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| mobile menu | Primary-reference mobile navigation | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-menu-toggle/data-header | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| footer | area guide footer | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| hero | Architectural listing hero | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| CTA | Primary-reference CTA hierarchy using Get Valuation | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| form | Valuation enquiry form | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-contact-form/data-form-status | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| cards | Thin-rule listing cards | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| resources | Primary-reference resource rhythm | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| pricing | commission and management cards | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| FAQ | professional FAQ with section-specific proof notes | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| cookie banner | Primary-reference compact consent | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-cookie-banner/data-cookie-accept | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| WhatsApp widget | fixed quick enquiry route with per-site brand styling and neutral tracking | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-whatsapp-widget/data-track | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| back-to-top | fixed scroll recovery control with visible focus and reduced-motion fallback | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-back-to-top | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| legal layout | Primary-reference plain legal notes | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| 404 page | brand-consistent recovery page with sitemap and home routes | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
| thanks page | confirmation page that reinforces Primary-reference CTA hierarchy using Get Valuation follow-up | spacious spacing with Thin-rule listing cards | classes use theme-real-estate modifiers plus component-specific classes | data-track/data-component | assets follow Modern homes, interiors, floor plans, neighbourhood details | must not resemble partials in sites 23, 33, 49 |
...
| Logo position | matched to Quiet property header |
| Nav layout | Quiet property header with desktop density chosen for spacious |
| CTA position | Get Valuation positioned as the primary route without crowding utility links |
...
- CTA placement: Get Valuation remains visible in desktop header and discoverable in mobile menu
...
- Background treatment: Property editorial with quiet type, generous imagery, and thin-rule listings

## Footer Plan

| Footer Field | Decision |
| --- | --- |
| Footer layout | area guide footer |
| Footer density | spacious |
| Column structure | sitemap-first with site-specific brand/contact/resource emphasis |
| CTA block | Primary-reference CTA hierarchy using Get Valuation |
| Trust/disclaimer area | market and area proof |
