...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Minimal property journal` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Minimal property journal with full container range |
...
| Mobile hero style | Architectural listing hero simplified without losing proof or CTA |
| Mobile card stacking | Thin-rule listing cards stacks or scrolls only when intentional |
| Mobile form behaviour | Valuation enquiry form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Get Valuation appears after proof and in contact routes |
| Mobile footer structure | area guide footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Modern homes, interiors, floor plans, neighbourhood details |
