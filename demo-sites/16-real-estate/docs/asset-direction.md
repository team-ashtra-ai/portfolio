...
| Photo personality | Modern homes, interiors, floor plans, neighbourhood details |
| Texture/material | Property editorial with quiet type, generous imagery, and thin-rule listings |
| Icon/illustration | local SVG and diagrams aligned to Property editorial with quiet type, generous imagery, and thin-rule listings |
| Hero assets | Architectural listing hero needs a first-screen image or visual system that does not copy references |
