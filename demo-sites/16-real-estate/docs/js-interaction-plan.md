...
| Signature behaviour | Property filter, gallery modal, map-style area cards |
...
| Optional variation | commission and management cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Slow image reveal must collapse cleanly under prefers-reduced-motion |
