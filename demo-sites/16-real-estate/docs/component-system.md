...
| --- | --- | --- | --- | --- | --- | --- | --- |
| hero component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | Modern homes, interiors, floor plans, neighbourhood details | hover/focus-visible/active/disabled states from css/styles.css | Property filter, gallery modal, map-style area cards | single-column or horizontal scroll only when explicitly designed |
| section intro component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| service card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| feature card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| profile card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| proof card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| metric card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| pricing card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | Property filter, gallery modal, map-style area cards | single-column or horizontal scroll only when explicitly designed |
| resource card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| article card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| download card | Thin-rule listing cards | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| FAQ component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| form component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| CTA component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| gallery component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | Modern homes, interiors, floor plans, neighbourhood details | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| testimonial/review component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| process/timeline component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| comparison component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| table component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| badge/tag component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| breadcrumb component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |
| legal content component | Minimal property journal | spacious | Property editorial with quiet type, generous imagery, and thin-rule listings | icon/texture optional | hover/focus-visible/active/disabled states from css/styles.css | CTA/download tracking with no JS-only content dependency | single-column or horizontal scroll only when explicitly designed |

## Explicit Reuse Prevention

- No same cards everywhere: Thin-rule listing cards controls card construction for this site only.
- No same FAQ everywhere: FAQ styling follows professional mode and Primary-reference plain legal notes proof tone.
- No same pricing table everywhere: pricing follows commission and management cards.
- No same form everywhere: forms follow Valuation enquiry form with industry-specific fields.
- No same testimonial/resource block everywhere: proof follows market and area proof and resources follow Primary-reference resource rhythm.
