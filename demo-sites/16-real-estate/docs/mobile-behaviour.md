...
| Mobile hero | Architectural listing hero simplified for first-screen clarity |
| Mobile section rhythm | spacious density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Thin-rule listing cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Valuation enquiry form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Get Valuation` appears after proof and remains reachable from contact/footer |
| Mobile footer | area guide footer stacks into sitemap, conversion, contact, legal, and trust areas |
