...
| Colour | #ebff53, #163300, #00b67a, #102014, #f0f5e8 plus semantic success/warning/error/link/CTA tokens |
| Spacing | measured density expressed through --space-* and --space-section |
| Grid/layout | Green calculator flow with container-sm/md/lg/xl/fluid tokens |
| Surface | Financial utility with acid green, bold calculator blocks, and low-friction forms with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Fee transparency cards using radius, border, and shadow tokens |
| Motion | Counter and calculator reveal with fast/base/slow/ease and reduced-motion rules |
...
- Layout signature: Green calculator flow
- Header type: Utility finance header
- Hero type: Money movement calculator hero
- Card style: Fee transparency cards
- Form style: Advisor calculator form
