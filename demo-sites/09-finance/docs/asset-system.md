...
| --- | --- |
| Image style | Payment flows, rate cards, account panels |
| Photo style | Payment flows, rate cards, account panels |
| Illustration/icon style | local SVG mark and diagrams following Financial utility with acid green, bold calculator blocks, and low-friction forms |
| Texture/background pattern | Financial utility with acid green, bold calculator blocks, and low-friction forms |
| Diagram style | supports risk and suitability proof and Green calculator flow |
...
| Border/overlay treatment | Fee transparency cards and Financial utility with acid green, bold calculator blocks, and low-friction forms |
