...
| Mobile hero | Money movement calculator hero simplified for first-screen clarity |
| Mobile section rhythm | measured density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Fee transparency cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Advisor calculator form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Advisor Call` appears after proof and remains reachable from contact/footer |
| Mobile footer | trust/legal footer stacks into sitemap, conversion, contact, legal, and trust areas |
