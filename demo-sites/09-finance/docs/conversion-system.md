...
| Field | Decision |
| --- | --- |
| Primary CTA | Book Advisor Call |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Book Advisor Call |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to measured financial stewardship |
| Form type | Advisor calculator form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Advisor Call links |
| Trust before form | risk and suitability proof |
...
| Conversion flow type | Money movement calculator hero |
