...
| Signature behaviour | Advisory route selector, calculator-style estimate, risk toggles |
...
| Optional variation | fee and advisory model, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Counter and calculator reveal must collapse cleanly under prefers-reduced-motion |
