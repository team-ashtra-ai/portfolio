...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Wise (https://wise.com/) |
| Layout archetype | Green calculator flow |
| Header | Utility finance header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | trust/legal footer |
| Typography | Georgia display with Arial body and "Trebuchet MS" accent labels |
| Colour/surface | #ebff53, #163300, #00b67a, #102014, #f0f5e8; Financial utility with acid green, bold calculator blocks, and low-friction forms |
| Hero | Money movement calculator hero |
| Section rhythm | measured density with varied composition and Counter and calculator reveal |
| Cards | Fee transparency cards |
| Forms | Advisor calculator form |
| CTA flow | Primary-reference CTA hierarchy using Book Advisor Call using `Book Advisor Call` |
| Assets | Payment flows, rate cards, account panels |
| JS interactions | Advisory route selector, calculator-style estimate, risk toggles |
| Motion | Counter and calculator reveal |
