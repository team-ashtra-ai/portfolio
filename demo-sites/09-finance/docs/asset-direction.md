...
| Photo personality | Payment flows, rate cards, account panels |
| Texture/material | Financial utility with acid green, bold calculator blocks, and low-friction forms |
| Icon/illustration | local SVG and diagrams aligned to Financial utility with acid green, bold calculator blocks, and low-friction forms |
| Hero assets | Money movement calculator hero needs a first-screen image or visual system that does not copy references |
