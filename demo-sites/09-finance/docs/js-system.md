...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Green calculator flow and Money movement calculator hero |
| Interactive components | Advisory route selector, calculator-style estimate, risk toggles, Money movement calculator hero, Primary-reference resource rhythm filters or archive interactions, fee and advisory model comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Finance, Banking & Financial Services content |
| Form behaviours | Advisor calculator form with validation, status, honeypot, Formspree, and thanks route |
...
- Advisory route selector, calculator-style estimate, risk toggles
- Money movement calculator hero
- Primary-reference resource rhythm filters or archive interactions
- fee and advisory model comparison/toggle/calculator behaviour
