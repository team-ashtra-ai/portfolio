...
| Photo personality | Satellite fields, night skies, coverage maps, hardware silhouettes |
| Texture/material | Black space utility with full-bleed contrast, uppercase navigation, and availability CTAs |
| Icon/illustration | local SVG and diagrams aligned to Black space utility with full-bleed contrast, uppercase navigation, and availability CTAs |
| Hero assets | Black full-bleed coverage hero needs a first-screen image or visual system that does not copy references |
