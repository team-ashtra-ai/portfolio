...
| Colour | #050505, #ffffff, #8b949e, #f5f5f5, #b8c7d9 plus semantic success/warning/error/link/CTA tokens |
| Spacing | practical density expressed through --space-* and --space-section |
| Grid/layout | Space coverage landing with container-sm/md/lg/xl/fluid tokens |
| Surface | Black space utility with full-bleed contrast, uppercase navigation, and availability CTAs with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Satellite coverage cards using radius, border, and shadow tokens |
| Motion | Slow parallax and signal reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-telecommunications`
- Mode class: `mode-professional`
- Layout signature: Space coverage landing
