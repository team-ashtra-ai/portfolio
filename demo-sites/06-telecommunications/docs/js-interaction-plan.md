...
| Signature behaviour | Coverage checker mockup, plan filter, outage alert panel |
...
| Optional variation | plan speed cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Slow parallax and signal reveal must collapse cleanly under prefers-reduced-motion |
