...
| Mobile hero | Black full-bleed coverage hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Satellite coverage cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Availability checker form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Check Coverage` appears after proof and remains reachable from contact/footer |
| Mobile footer | coverage support footer stacks into sitemap, conversion, contact, legal, and trust areas |
