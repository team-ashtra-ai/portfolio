...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Space coverage landing and Black full-bleed coverage hero |
| Interactive components | Coverage checker mockup, plan filter, outage alert panel, Black full-bleed coverage hero, Primary-reference resource rhythm filters or archive interactions, plan speed cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Telecommunications, Internet & Connectivity content |
| Form behaviours | Availability checker form with validation, status, honeypot, Formspree, and thanks route |
...
- Coverage checker mockup, plan filter, outage alert panel
- Black full-bleed coverage hero
- Primary-reference resource rhythm filters or archive interactions
- plan speed cards comparison/toggle/calculator behaviour
