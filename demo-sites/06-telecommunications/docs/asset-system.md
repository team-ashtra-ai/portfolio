...
| --- | --- |
| Image style | Satellite fields, night skies, coverage maps, hardware silhouettes |
| Photo style | Satellite fields, night skies, coverage maps, hardware silhouettes |
| Illustration/icon style | local SVG mark and diagrams following Black space utility with full-bleed contrast, uppercase navigation, and availability CTAs |
| Texture/background pattern | Black space utility with full-bleed contrast, uppercase navigation, and availability CTAs |
| Diagram style | supports reliability and area proof and Space coverage landing |
...
| Border/overlay treatment | Satellite coverage cards and Black space utility with full-bleed contrast, uppercase navigation, and availability CTAs |
