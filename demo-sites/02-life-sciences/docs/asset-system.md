...
| --- | --- |
| Image style | Cell imagery, robotic lab systems, data maps |
| Photo style | Cell imagery, robotic lab systems, data maps |
| Illustration/icon style | local SVG mark and diagrams following TechBio with dark scientific grids, microscopy panels, and pipeline evidence |
| Texture/background pattern | TechBio with dark scientific grids, microscopy panels, and pipeline evidence |
| Diagram style | supports papers, pipeline, and ethics evidence and Scientific operating system dossier |
...
| Border/overlay treatment | Pipeline evidence cards and TechBio with dark scientific grids, microscopy panels, and pipeline evidence |
