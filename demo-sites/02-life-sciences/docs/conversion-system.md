...
| Field | Decision |
| --- | --- |
| Primary CTA | Discuss Research |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Discuss Research |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to research-grade scientific authority |
| Form type | Partner research form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Discuss Research links |
| Trust before form | papers, pipeline, and ethics evidence |
...
| Conversion flow type | AI biology lab hero |
