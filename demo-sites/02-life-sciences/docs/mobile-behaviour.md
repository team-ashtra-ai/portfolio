...
| Mobile hero | AI biology lab hero simplified for first-screen clarity |
| Mobile section rhythm | compact density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Pipeline evidence cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Partner research form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Discuss Research` appears after proof and remains reachable from contact/footer |
| Mobile footer | publication archive footer stacks into sitemap, conversion, contact, legal, and trust areas |
