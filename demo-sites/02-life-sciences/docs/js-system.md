...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Scientific operating system dossier and AI biology lab hero |
| Interactive components | Pipeline tabs, publication filters, trial eligibility toggle, AI biology lab hero, Primary-reference resource rhythm filters or archive interactions, trial eligibility tiers comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Life Sciences, Pharmaceuticals & Biotechnology content |
| Form behaviours | Partner research form with validation, status, honeypot, Formspree, and thanks route |
...
- Pipeline tabs, publication filters, trial eligibility toggle
- AI biology lab hero
- Primary-reference resource rhythm filters or archive interactions
- trial eligibility tiers comparison/toggle/calculator behaviour
