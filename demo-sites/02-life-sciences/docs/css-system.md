...
| Colour | #050709, #5cffb1, #2f6dff, #f3f7ff, #9cffd3 plus semantic success/warning/error/link/CTA tokens |
| Spacing | compact density expressed through --space-* and --space-section |
| Grid/layout | Scientific operating system dossier with container-sm/md/lg/xl/fluid tokens |
| Surface | TechBio with dark scientific grids, microscopy panels, and pipeline evidence with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Pipeline evidence cards using radius, border, and shadow tokens |
| Motion | Cell-grid reveal and pipeline motion with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-life-sciences`
- Mode class: `mode-technical`
- Layout signature: Scientific operating system dossier
- Header type: Research mega-nav header
- Hero type: AI biology lab hero
- Card style: Pipeline evidence cards
- Form style: Partner research form
