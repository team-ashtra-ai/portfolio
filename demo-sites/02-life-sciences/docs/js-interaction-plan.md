...
| Signature behaviour | Pipeline tabs, publication filters, trial eligibility toggle |
...
| Optional variation | trial eligibility tiers, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Cell-grid reveal and pipeline motion must collapse cleanly under prefers-reduced-motion |
