...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Scientific operating system dossier` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Scientific operating system dossier with full container range |
...
| Mobile hero style | AI biology lab hero simplified without losing proof or CTA |
| Mobile card stacking | Pipeline evidence cards stacks or scrolls only when intentional |
| Mobile form behaviour | Partner research form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Discuss Research appears after proof and in contact routes |
| Mobile footer structure | publication archive footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Cell imagery, robotic lab systems, data maps |
