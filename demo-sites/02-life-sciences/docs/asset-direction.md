...
| Photo personality | Cell imagery, robotic lab systems, data maps |
| Texture/material | TechBio with dark scientific grids, microscopy panels, and pipeline evidence |
| Icon/illustration | local SVG and diagrams aligned to TechBio with dark scientific grids, microscopy panels, and pipeline evidence |
| Hero assets | AI biology lab hero needs a first-screen image or visual system that does not copy references |
