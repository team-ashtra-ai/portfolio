...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Vertical farm growth system` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Vertical farm growth system with full container range |
...
| Mobile hero style | Deep-green grow room hero simplified without losing proof or CTA |
| Mobile card stacking | Growth metric cards stacks or scrolls only when intentional |
| Mobile form behaviour | Season visit form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Plan Visit appears after proof and in contact routes |
| Mobile footer structure | seasonal footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Indoor farms, leafy crops, grow lights, yield data |
