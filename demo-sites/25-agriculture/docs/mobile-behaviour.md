...
| Mobile hero | Deep-green grow room hero simplified for first-screen clarity |
| Mobile section rhythm | practical density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Growth metric cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Season visit form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Plan Visit` appears after proof and remains reachable from contact/footer |
| Mobile footer | seasonal footer stacks into sitemap, conversion, contact, legal, and trust areas |
