...
| Photo personality | Indoor farms, leafy crops, grow lights, yield data |
| Texture/material | Agriculture with deep green, vertical-farm rhythm, and controlled-growth proof |
| Icon/illustration | local SVG and diagrams aligned to Agriculture with deep green, vertical-farm rhythm, and controlled-growth proof |
| Hero assets | Deep-green grow room hero needs a first-screen image or visual system that does not copy references |
