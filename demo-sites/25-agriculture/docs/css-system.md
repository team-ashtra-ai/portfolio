...
| Colour | #061b12, #20c36b, #a6e22e, #f2f7e8, #6bbf59 plus semantic success/warning/error/link/CTA tokens |
| Spacing | practical density expressed through --space-* and --space-section |
| Grid/layout | Vertical farm growth system with container-sm/md/lg/xl/fluid tokens |
| Surface | Agriculture with deep green, vertical-farm rhythm, and controlled-growth proof with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Growth metric cards using radius, border, and shadow tokens |
| Motion | Vertical row reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-agriculture`
- Mode class: `mode-professional`
- Layout signature: Vertical farm growth system
