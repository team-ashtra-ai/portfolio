...
| --- | --- |
| Image style | Indoor farms, leafy crops, grow lights, yield data |
| Photo style | Indoor farms, leafy crops, grow lights, yield data |
| Illustration/icon style | local SVG mark and diagrams following Agriculture with deep green, vertical-farm rhythm, and controlled-growth proof |
| Texture/background pattern | Agriculture with deep green, vertical-farm rhythm, and controlled-growth proof |
| Diagram style | supports product and advice proof and Vertical farm growth system |
...
| Border/overlay treatment | Growth metric cards and Agriculture with deep green, vertical-farm rhythm, and controlled-growth proof |
