...
| Signature behaviour | Seasonal calendar, product filter, advice route selector |
...
| Optional variation | season package cards, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Vertical row reveal must collapse cleanly under prefers-reduced-motion |
