...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Vertical farm growth system and Deep-green grow room hero |
| Interactive components | Seasonal calendar, product filter, advice route selector, Deep-green grow room hero, Primary-reference resource rhythm filters or archive interactions, season package cards comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Agriculture, Farming & Rural Business content |
| Form behaviours | Season visit form with validation, status, honeypot, Formspree, and thanks route |
...
- Seasonal calendar, product filter, advice route selector
- Deep-green grow room hero
- Primary-reference resource rhythm filters or archive interactions
- season package cards comparison/toggle/calculator behaviour
