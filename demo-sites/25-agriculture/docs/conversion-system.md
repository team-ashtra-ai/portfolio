...
| Field | Decision |
| --- | --- |
| Primary CTA | Plan Visit |
| Secondary CTA | read proof, compare scope, open resources, or contact through a softer route |
| CTA hierarchy | Primary-reference CTA hierarchy using Plan Visit |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to seasonal rural practicality |
| Form type | Season visit form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Plan Visit links |
| Trust before form | product and advice proof |
...
| Conversion flow type | Deep-green grow room hero |
