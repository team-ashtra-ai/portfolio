...
| Colour | #fff6dc, #19355f, #ffcf2e, #11264b, #f6a900 plus semantic success/warning/error/link/CTA tokens |
| Spacing | relaxed density expressed through --space-* and --space-section |
| Grid/layout | Routine commerce shelf with container-sm/md/lg/xl/fluid tokens |
| Surface | Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Supplement capsule cards using radius, border, and shadow tokens |
| Motion | Gentle shelf reveal with fast/base/slow/ease and reduced-motion rules |
...
- Theme class: `theme-wellness`
- Mode class: `mode-care`
- Layout signature: Routine commerce shelf
