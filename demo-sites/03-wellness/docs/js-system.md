...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Routine commerce shelf and Product routine hero |
| Interactive components | Routine builder, service fit quiz, package toggle, Product routine hero, Primary-reference resource rhythm filters or archive interactions, session packages comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Wellness, Personal Care & Lifestyle Services content |
| Form behaviours | Routine quiz form with validation, status, honeypot, Formspree, and thanks route |
...
- Routine builder, service fit quiz, package toggle
- Product routine hero
- Primary-reference resource rhythm filters or archive interactions
- session packages comparison/toggle/calculator behaviour
