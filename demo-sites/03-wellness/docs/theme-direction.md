...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | Ritual (https://ritual.com/) |
| Layout archetype | Routine commerce shelf |
| Header | Promo shop header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | self-care journal footer |
| Typography | Inter display with Verdana body and "Palatino Linotype" accent labels |
| Colour/surface | #fff6dc, #19355f, #ffcf2e, #11264b, #f6a900; Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Hero | Product routine hero |
| Section rhythm | relaxed density with varied composition and Gentle shelf reveal |
| Cards | Supplement capsule cards |
| Forms | Routine quiz form |
| CTA flow | Primary-reference CTA hierarchy using Book Consultation using `Book Consultation` |
| Assets | Bright product jars, daily rituals, ingredient callouts |
| JS interactions | Routine builder, service fit quiz, package toggle |
| Motion | Gentle shelf reveal |
