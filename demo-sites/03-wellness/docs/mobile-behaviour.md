...
| Mobile hero | Product routine hero simplified for first-screen clarity |
| Mobile section rhythm | relaxed density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Supplement capsule cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Routine quiz form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Consultation` appears after proof and remains reachable from contact/footer |
| Mobile footer | self-care journal footer stacks into sitemap, conversion, contact, legal, and trust areas |
