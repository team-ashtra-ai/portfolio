...
| --- | --- |
| Image style | Bright product jars, daily rituals, ingredient callouts |
| Photo style | Bright product jars, daily rituals, ingredient callouts |
| Illustration/icon style | local SVG mark and diagrams following Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Texture/background pattern | Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Diagram style | supports results and suitability proof and Routine commerce shelf |
...
| Border/overlay treatment | Supplement capsule cards and Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
