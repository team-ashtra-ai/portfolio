...
| Photo personality | Bright product jars, daily rituals, ingredient callouts |
| Texture/material | Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Icon/illustration | local SVG and diagrams aligned to Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Hero assets | Product routine hero needs a first-screen image or visual system that does not copy references |
