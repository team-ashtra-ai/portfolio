...
LumaStudio must feel like a standalone premium website for Wellness, Personal Care & Lifestyle Services, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 10, 20, 36.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | warm lifestyle |
| Visual mood | Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Industry tone | soft lifestyle clarity |
| Buyer psychology | personal improvement and reassurance |
| Trust style | results and suitability proof |
| Conversion style | Primary-reference CTA hierarchy using Book Consultation |
| Content density | relaxed |
| Image personality | Bright product jars, daily rituals, ingredient callouts |
| Level of formality | care |
| Level of emotion | high |
| Level of technical detail | moderate |
| Premium feeling | A routine-first wellness shop with offer strip, product education, rounded capsules, and evidence-led reassurance |
...
| Stats/quotes/eyebrows | accented through Supplement capsule cards and Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #fff6dc, #19355f, #ffcf2e, #11264b, #f6a900 |
| Surface style | Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves |
| Shadow style | generated per site through --shadow-soft, --shadow-medium, --shadow-strong, and --shadow-glow |
| Border style | matched to Supplement capsule cards with unique radius and border strength |
| Texture usage | Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves texture; no generic repeated decorative background |
...
- Premium direction: A routine-first wellness shop with offer strip, product education, rounded capsules, and evidence-led reassurance
- Brand mood: warm lifestyle
- Buyer psychology: personal improvement and reassurance
- Layout archetype: Routine commerce shelf
- Density: relaxed
- Shape language: Supplement capsule cards
- Surface/material: Supplement commerce with warm yellow, navy copy, pill buttons, and routine shelves
- Image system: Bright product jars, daily rituals, ingredient callouts
- Interaction model: Product routine hero
- CTA style: Primary-reference CTA hierarchy using Book Consultation
- Pricing style: session packages
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 10, 20, 36.
