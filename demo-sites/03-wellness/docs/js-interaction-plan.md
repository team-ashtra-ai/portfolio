...
| Signature behaviour | Routine builder, service fit quiz, package toggle |
...
| Optional variation | session packages, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Gentle shelf reveal must collapse cleanly under prefers-reduced-motion |
