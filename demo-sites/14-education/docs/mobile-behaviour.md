...
| Mobile hero | Black cinematic course hero simplified for first-screen clarity |
| Mobile section rhythm | medium density with deliberate stack, crop, or scroll decisions |
| Mobile cards | Lesson trailer cards remains visually distinct in one-column or scroll treatment |
| Mobile forms | Trial lesson form keeps labels, consent, validation, and status visible |
| Mobile CTA | `Book Trial` appears after proof and remains reachable from contact/footer |
| Mobile footer | learning resource footer stacks into sitemap, conversion, contact, legal, and trust areas |
