...
BrightPath must feel like a standalone premium website for Education, Training & Learning Services, not a recolour of another demo. Do not reuse the hero, card, footer, pricing, gallery, FAQ, mobile menu, or asset treatment from sites 21, 31, 47.

## Brand Difference Plan

| Dimension | Decision |
| --- | --- |
| Brand personality | supportive |
| Visual mood | Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
| Industry tone | supportive learning momentum |
| Buyer psychology | confidence and progress |
| Trust style | outcomes and learning proof |
| Conversion style | Primary-reference CTA hierarchy using Book Trial |
| Content density | medium |
| Image personality | Course stills, teacher portraits, dark learning shelves |
| Level of formality | care |
| Level of emotion | high |
| Level of technical detail | moderate |
| Premium feeling | A course-led education site with cinematic hero, lesson shelves, premium teacher proof, and trial routes |
| Commercial feeling | Primary-reference CTA hierarchy using Book Trial |
...
| Stats/quotes/eyebrows | accented through Lesson trailer cards and Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
...
| Layer | Decision |
| --- | --- |
| Primary palette | #050505, #ffffff, #d71920, #ffffff, #b28b55 |
...
| Border style | matched to Lesson trailer cards with unique radius and border strength |
| Texture usage | Cinematic education with black stage surfaces, instructor tiles, and red CTAs texture; no generic repeated decorative background |
...
- Premium direction: A course-led education site with cinematic hero, lesson shelves, premium teacher proof, and trial routes
- Brand mood: supportive
- Buyer psychology: confidence and progress
- Layout archetype: Cinematic course catalogue
- Density: medium
- Shape language: Lesson trailer cards
- Surface/material: Cinematic education with black stage surfaces, instructor tiles, and red CTAs
- Image system: Course stills, teacher portraits, dark learning shelves
- Interaction model: Black cinematic course hero
- CTA style: Primary-reference CTA hierarchy using Book Trial
...
This site must not reuse the hero, card, footer, pricing, gallery, or FAQ structure from sites 21, 31, 47.
