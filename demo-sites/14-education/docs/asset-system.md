...
| --- | --- |
| Image style | Course stills, teacher portraits, dark learning shelves |
| Photo style | Course stills, teacher portraits, dark learning shelves |
| Illustration/icon style | local SVG mark and diagrams following Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
| Texture/background pattern | Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
| Diagram style | supports outcomes and learning proof and Cinematic course catalogue |
...
| Border/overlay treatment | Lesson trailer cards and Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
