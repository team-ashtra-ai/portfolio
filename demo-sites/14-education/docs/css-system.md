...
| Colour | #050505, #ffffff, #d71920, #ffffff, #b28b55 plus semantic success/warning/error/link/CTA tokens |
| Spacing | medium density expressed through --space-* and --space-section |
| Grid/layout | Cinematic course catalogue with container-sm/md/lg/xl/fluid tokens |
| Surface | Cinematic education with black stage surfaces, instructor tiles, and red CTAs with raised/surface/gradient/overlay tokens |
| Radius/border/shadow | Lesson trailer cards using radius, border, and shadow tokens |
| Motion | Trailer fade reveal with fast/base/slow/ease and reduced-motion rules |
...
- Layout signature: Cinematic course catalogue
