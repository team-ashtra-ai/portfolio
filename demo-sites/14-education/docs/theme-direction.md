...
| Dimension | Direction |
| --- | --- |
| Primary inspiration | MasterClass (https://www.masterclass.com/) |
| Layout archetype | Cinematic course catalogue |
| Header | Streaming course header |
| Mobile menu | Primary-reference mobile navigation |
| Footer | learning resource footer |
| Typography | Georgia display with "Lucida Sans" body and Constantia accent labels |
| Colour/surface | #050505, #ffffff, #d71920, #ffffff, #b28b55; Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
| Hero | Black cinematic course hero |
| Section rhythm | medium density with varied composition and Trailer fade reveal |
| Cards | Lesson trailer cards |
| Forms | Trial lesson form |
| CTA flow | Primary-reference CTA hierarchy using Book Trial using `Book Trial` |
| Assets | Course stills, teacher portraits, dark learning shelves |
| JS interactions | Level selector, course filter, timetable interaction |
| Motion | Trailer fade reveal |
