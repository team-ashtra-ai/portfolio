...
| Photo personality | Course stills, teacher portraits, dark learning shelves |
| Texture/material | Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
| Icon/illustration | local SVG and diagrams aligned to Cinematic education with black stage surfaces, instructor tiles, and red CTAs |
| Hero assets | Black cinematic course hero needs a first-screen image or visual system that does not copy references |
