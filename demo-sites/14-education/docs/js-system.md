...
| Area | Decision |
| --- | --- |
| JS purpose | progressively enhance Cinematic course catalogue and Black cinematic course hero |
| Interactive components | Level selector, course filter, timetable interaction, Black cinematic course hero, Primary-reference resource rhythm filters or archive interactions, lesson packages comparison/toggle/calculator behaviour |
| Page-specific behaviours | only attach where matching sections exist; never hide core Education, Training & Learning Services content |
| Form behaviours | Trial lesson form with validation, status, honeypot, Formspree, and thanks route |
...
- Level selector, course filter, timetable interaction
- Black cinematic course hero
- Primary-reference resource rhythm filters or archive interactions
- lesson packages comparison/toggle/calculator behaviour
