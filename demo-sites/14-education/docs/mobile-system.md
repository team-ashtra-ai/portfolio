...
The mobile experience must not be the same default stack everywhere. This site uses `Primary-reference mobile navigation` and `Cinematic course catalogue` to control mobile rhythm.

| Breakpoint/Area | Decision |
| --- | --- |
| Desktop layout | Cinematic course catalogue with full container range |
...
| Mobile hero style | Black cinematic course hero simplified without losing proof or CTA |
| Mobile card stacking | Lesson trailer cards stacks or scrolls only when intentional |
| Mobile form behaviour | Trial lesson form keeps labels visible and submits to Formspree |
| Mobile CTA placement | Book Trial appears after proof and in contact routes |
| Mobile footer structure | learning resource footer stacks as sitemap, contact, legal, and trust |
| Mobile image cropping | Course stills, teacher portraits, dark learning shelves |
