...
| CTA hierarchy | Primary-reference CTA hierarchy using Book Trial |
| CTA placement | hero, proof, pricing/resources, contact, footer, and thanks recovery route |
| CTA wording | industry-specific and matched to supportive learning momentum |
| Form type | Trial lesson form |
...
| Contact route | Formspree endpoint, WhatsApp quick enquiry widget, ASH-TRA contact fallback, and Book Trial links |
| Trust before form | outcomes and learning proof |
...
| Conversion flow type | Black cinematic course hero |
