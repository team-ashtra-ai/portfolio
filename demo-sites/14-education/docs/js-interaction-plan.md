...
| Signature behaviour | Level selector, course filter, timetable interaction |
...
| Optional variation | lesson packages, Primary-reference resource rhythm, and page-specific filters/toggles/calculators |
...
| Reduced motion | Trailer fade reveal must collapse cleanly under prefers-reduced-motion |
